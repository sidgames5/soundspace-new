...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("SoundSpace",97,a5,5c,e1),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("66",40,2f,00,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("Keystone Games",07,27,7d,06));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("SoundSpace",97,a5,5c,e1));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("SoundSpace",97,a5,5c,e1));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("io.github.keystone_games.soundspace",1a,11,3f,15));
HXLINE(  40)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("",00,00,00,00));
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(hx::Anon_obj::Create(16)
            			...
            			->setFixed(2,HX_("width",06,b6,62,ca),3840)
            			...
            			->setFixed(7,HX_("height",e7,07,4c,02),2160)
            			->setFixed(8,HX_("element",bc,ae,54,06),null())
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("SoundSpace",97,a5,5c,e1))
