...
HXLINE(  59)				{
HXLINE(  59)					 ::lime::utils::ArrayBufferView this2 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___alpha16;
HXDLIN(  59)					int val = ::Math_obj::ceil((( (Float)(i) ) * ((Float)257.003921568627447)));
HXDLIN(  59)					 ::__hxcpp_memory_set_ui32(this2->buffer->b,(this2->byteOffset + (i * 4)),val);
            				}
            			}
            		}
...
HXDLIN(  62)		 ::lime::utils::ArrayBufferView this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,511,4);
HXDLIN(  62)		::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp = this3;
HXLINE(  64)		{
HXLINE(  64)			int _g1 = 0;
...
HXLINE(  66)				{
HXLINE(  66)					 ::lime::utils::ArrayBufferView this4 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN(  66)					 ::__hxcpp_memory_set_byte(this4->buffer->b,(this4->byteOffset + i1),i1);
            				}
            			}
            		}
HXLINE(  69)		{
...
HXLINE(  71)				{
HXLINE(  71)					 ::lime::utils::ArrayBufferView this5 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN(  71)					 ::__hxcpp_memory_set_byte(this5->buffer->b,(this5->byteOffset + i2),255);
            				}
            			}
            		}
            	}
