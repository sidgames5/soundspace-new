...
HXDLIN( 684)					 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 684)					_this->buffer = this3;
...
HXDLIN( 684)						_this1->buffer = this4;
HXDLIN( 684)						_this1->copyFromArray(array1,null());
HXDLIN( 684)						this2 = _this1;
            					}
            					else {
...
HXDLIN( 684)								 ::haxe::io::Bytes this5 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 684)								_this2->buffer = this5;
...
HXDLIN( 685)			 ::lime::utils::ArrayBufferView this6;
HXDLIN( 685)			if (hx::IsNotNull( elements1 )) {
HXLINE( 685)				this6 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements1,6);
            			}
            			else {
...
HXDLIN( 685)					 ::haxe::io::Bytes this7 = ::haxe::io::Bytes_obj::alloc(_this4->byteLength);
HXDLIN( 685)					_this4->buffer = this7;
HXDLIN( 685)					_this4->copyFromArray(array2,null());
HXDLIN( 685)					this6 = _this4;
            				}
            				else {
...
HXDLIN( 685)						 ::haxe::io::Bytes this8 = ::haxe::io::Bytes_obj::alloc(_this5->byteLength);
HXDLIN( 685)						_this5->buffer = this8;
HXDLIN( 685)						_this5->copyFromArray(array3,null());
HXDLIN( 685)						this6 = _this5;
            					}
            					else {
...
HXDLIN( 685)								 ::haxe::io::Bytes this9 = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN( 685)								_this6->buffer = this9;
...
HXDLIN( 685)			 ::lime::utils::ArrayBufferView uint16array = this6;
