...
HXDLIN( 467)			 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(f,window1));
...
HXLINE( 565)			f(gamepad1,axis,value);
            		}
...
HXLINE( 567)			f2(gamepad3,button1);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXDLIN( 565)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(gamepad1,f));
...
HXDLIN( 566)		 ::Dynamic _hx_tmp1 =  ::Dynamic(new _hx_Closure_1(gamepad2,f1));
...
HXDLIN( 567)		 ::Dynamic _hx_tmp2 =  ::Dynamic(new _hx_Closure_2(f2,gamepad3));
...
HXDLIN( 568)		 ::Dynamic _hx_tmp3 =  ::Dynamic(new _hx_Closure_3(f3,gamepad4));
...
void Application_obj::_hx___onJoystickConnect( ::lime::ui::Joystick joystick){
            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0, ::Dynamic,f, ::lime::ui::Joystick,joystick1) HXARGC(2)
            		void _hx_run(int axis,Float value){
            			HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_575___onJoystickConnect)
HXLINE( 575)			f(joystick1,axis,value);
            		}
            		HX_END_LOCAL_FUNC2((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_1, ::lime::ui::Joystick,joystick2, ::Dynamic,f1) HXARGC(1)
            		void _hx_run(int button){
            			HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_576___onJoystickConnect)
HXLINE( 576)			f1(joystick2,button);
            		}
            		HX_END_LOCAL_FUNC1((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_2, ::Dynamic,f2, ::lime::ui::Joystick,joystick3) HXARGC(1)
            		void _hx_run(int button1){
            			HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_577___onJoystickConnect)
HXLINE( 577)			f2(joystick3,button1);
            		}
            		HX_END_LOCAL_FUNC1((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_3, ::Dynamic,f3, ::lime::ui::Joystick,joystick4) HXARGC(0)
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_578___onJoystickConnect)
HXLINE( 578)			f3(joystick4);
            		}
            		HX_END_LOCAL_FUNC0((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_4, ::lime::ui::Joystick,joystick5, ::Dynamic,f4) HXARGC(2)
            		void _hx_run(int hat,int position){
            			HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_579___onJoystickConnect)
HXLINE( 579)			f4(joystick5,hat,position);
            		}
            		HX_END_LOCAL_FUNC2((void))

            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_5, ::Dynamic,f5, ::lime::ui::Joystick,joystick6) HXARGC(3)
            		void _hx_run(int trackball,Float x,Float y){
            			HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_580___onJoystickConnect)
HXLINE( 580)			f5(joystick6,trackball,x,y);
            		}
...
HXDLIN( 575)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(f,joystick1));
...
HXDLIN( 576)		 ::Dynamic _hx_tmp1 =  ::Dynamic(new _hx_Closure_1(joystick2,f1));
...
HXDLIN( 577)		 ::Dynamic _hx_tmp2 =  ::Dynamic(new _hx_Closure_2(f2,joystick3));
...
HXDLIN( 578)		 ::Dynamic _hx_tmp3 =  ::Dynamic(new _hx_Closure_3(f3,joystick4));
...
HXDLIN( 579)		 ::Dynamic _hx_tmp4 =  ::Dynamic(new _hx_Closure_4(joystick5,f4));
...
HXDLIN( 580)		 ::Dynamic _hx_tmp5 =  ::Dynamic(new _hx_Closure_5(f5,joystick6));
