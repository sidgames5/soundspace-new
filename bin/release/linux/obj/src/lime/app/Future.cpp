...
HXLINE( 280)					 ::lime::app::Future future1 = ( ( ::lime::app::Future)(next(val)) );
HXLINE( 281)					future1->onError(promise->error_dyn());
HXLINE( 282)					future1->onComplete(promise->complete_dyn());
            				}
