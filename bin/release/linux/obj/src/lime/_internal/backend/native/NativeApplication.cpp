...
HXLINE( 274)							_hx_tmp2 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(modifier));
            						}
            						else {
...
HXLINE( 596)				::Array< ::Dynamic> _g2 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 596)				{
HXLINE( 596)					int _g11 = 0;
HXDLIN( 596)					::Array< ::Dynamic> _g21 = ::haxe::Timer_obj::sRunningTimers;
HXDLIN( 596)					while((_g11 < _g21->length)){
HXLINE( 596)						 ::haxe::Timer v = _g21->__get(_g11).StaticCast<  ::haxe::Timer >();
HXDLIN( 596)						_g11 = (_g11 + 1);
HXDLIN( 596)						if (hx::IsNotNull( v )) {
HXLINE( 596)							_g2->push(v);
            						}
            					}
            				}
HXDLIN( 596)				::haxe::Timer_obj::sRunningTimers = _g2;
            			}
            		}
            	}
