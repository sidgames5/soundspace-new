...
HXDLIN( 352)						_this1->buffer = this3;
...
HXDLIN( 352)								 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 352)								_this2->buffer = this4;
...
HXDLIN( 382)			 ::lime::utils::ArrayBufferView this5;
HXDLIN( 382)			if (hx::IsNotNull( elements1 )) {
HXLINE( 382)				this5 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements1,4);
            			}
            			else {
...
HXDLIN( 382)					 ::haxe::io::Bytes this6 = ::haxe::io::Bytes_obj::alloc(_this4->byteLength);
HXDLIN( 382)					_this4->buffer = this6;
HXDLIN( 382)					_this4->copyFromArray(array2,null());
HXDLIN( 382)					this5 = _this4;
            				}
            				else {
...
HXDLIN( 382)						 ::haxe::io::Bytes this7 = ::haxe::io::Bytes_obj::alloc(_this5->byteLength);
HXDLIN( 382)						_this5->buffer = this7;
HXDLIN( 382)						_this5->copyFromArray(array3,null());
HXDLIN( 382)						this5 = _this5;
            					}
            					else {
...
HXDLIN( 382)								 ::haxe::io::Bytes this8 = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN( 382)								_this6->buffer = this8;
...
HXDLIN( 382)			imageBuffer = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_window_read_pixels(hx::DynamicPtr(imageBuffer1),hx::DynamicPtr(rect),hx::DynamicPtr( ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this5,null(),null(),null(),null())))) );
