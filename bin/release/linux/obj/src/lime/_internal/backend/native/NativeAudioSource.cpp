...
HXLINE( 105)					::cpp::VirtualArray _hx_tmp2 = this->buffers;
HXDLIN( 105)					_hx_tmp2->push(::lime::media::openal::AL_obj::createBuffer());
            				}
            			}
...
HXLINE( 210)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 210)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),hx::paccDynamic)) );
HXDLIN( 210)					_this1->byteOffset = 0;
HXDLIN( 210)					_this1->length = array1->get_length();
HXDLIN( 210)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 210)					 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 210)					_this1->buffer = this3;
HXDLIN( 210)					_this1->copyFromArray(array1,null());
HXDLIN( 210)					this1 = _this1;
            				}
            				else {
HXLINE( 210)					if (hx::IsNotNull( view )) {
HXLINE( 210)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 210)						int elementSize = _this2->bytesPerElement;
HXDLIN( 210)						if ((view->type == _this2->type)) {
HXLINE( 210)							int srcLength1 = srcData->length;
HXDLIN( 210)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 210)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 210)							_this2->buffer = this4;
HXDLIN( 210)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE( 210)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN( 210)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 210)						_this2->byteOffset = 0;
HXDLIN( 210)						_this2->length = srcLength;
HXDLIN( 210)						this1 = _this2;
            					}
            					else {
HXLINE( 210)						if (hx::IsNotNull( buffer )) {
HXLINE( 210)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN( 210)							if ((hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 210)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN( 210)							int bufferByteLength = buffer->length;
HXDLIN( 210)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 210)								if ((hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 210)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE( 210)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 210)								int newRange = (in_byteOffset + newByteLength);
HXDLIN( 210)								if ((newRange > bufferByteLength)) {
HXLINE( 210)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN( 210)							_this3->buffer = buffer;
HXDLIN( 210)							_this3->byteOffset = in_byteOffset;
HXDLIN( 210)							_this3->byteLength = newByteLength;
HXDLIN( 210)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 210)							this1 = _this3;
            						}
            						else {
...
HXDLIN( 267)				if ((position2 != (_hx_int64_low(x1) >> 31))) {
...
HXLINE( 362)					int time3 = ::Std_obj::_hx_int(((totalSeconds * ratio) * ( (Float)(1000) )));
HXDLIN( 362)					int time4 = (time3 - this->parent->offset);
HXLINE( 365)					if ((time4 < 0)) {
HXLINE( 365)						return 0;
            					}
