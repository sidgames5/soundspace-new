...
HXLINE( 518)					 ::lime::net::curl::CURL curl1 = message->curl;
HXLINE( 519)					 ::Dynamic status = curl1->getInfo(2097154);
HXLINE( 521)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->removeHandle(curl1);
HXLINE( 522)					curl1->cleanup();
...
HXLINE( 584)				 ::lime::app::Promise_haxe_io_Bytes instance2 = instance->promise;
HXDLIN( 584)				instance2->error(::lime::net::curl::CURL_obj::strerror(( (int)(state->__Field(HX_("result",dd,68,84,08),hx::paccDynamic)) )));
            			}
