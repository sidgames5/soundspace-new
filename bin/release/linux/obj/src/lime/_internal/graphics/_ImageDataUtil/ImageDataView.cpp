...
HXLINE(1718)			 ::lime::math::Rectangle _hx_tmp1 = this->rect;
HXDLIN(1718)			_hx_tmp1->x = (_hx_tmp1->x + x);
HXLINE(1719)			 ::lime::math::Rectangle _hx_tmp2 = this->rect;
HXDLIN(1719)			_hx_tmp2->width = (_hx_tmp2->width - ( (Float)(x) ));
            		}
HXLINE(1722)		if ((y < 0)) {
HXLINE(1724)			 ::lime::math::Rectangle _hx_tmp3 = this->rect;
HXDLIN(1724)			_hx_tmp3->y = (_hx_tmp3->y + y);
HXLINE(1725)			if ((this->rect->y < 0)) {
HXLINE(1725)				this->rect->y = ( (Float)(0) );
            			}
            		}
            		else {
HXLINE(1729)			 ::lime::math::Rectangle _hx_tmp4 = this->rect;
HXDLIN(1729)			_hx_tmp4->y = (_hx_tmp4->y + y);
HXLINE(1730)			 ::lime::math::Rectangle _hx_tmp5 = this->rect;
HXDLIN(1730)			_hx_tmp5->height = (_hx_tmp5->height - ( (Float)(y) ));
            		}
