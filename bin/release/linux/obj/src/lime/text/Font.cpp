...
HXDLIN( 242)						_this1->buffer = this3;
...
HXDLIN( 242)								 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 242)								_this2->buffer = this4;
...
HXLINE( 383)					{
HXLINE( 383)						int _g11 = 0;
HXDLIN( 383)						int _g21 = height;
HXDLIN( 383)						while((_g11 < _g21)){
HXLINE( 383)							_g11 = (_g11 + 1);
HXDLIN( 383)							int i2 = (_g11 - 1);
...
HXDLIN( 407)						_this1->buffer = this3;
...
HXDLIN( 407)								 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 407)								_this2->buffer = this4;
