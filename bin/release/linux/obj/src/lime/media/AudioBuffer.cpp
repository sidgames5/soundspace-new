...
HXDLIN(  90)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(  90)							_this2->buffer = this4;
...
HXDLIN( 127)					_this1->buffer = this3;
...
HXDLIN( 127)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 127)							_this2->buffer = this4;
...
HXDLIN( 176)					_this1->buffer = this3;
...
HXDLIN( 176)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 176)							_this2->buffer = this4;
...
HXDLIN( 351)			goto _hx_goto_14;
            		...
            		/* default */{
HXLINE( 355)			int _g2 = ( (int)(bytes->b->__get(2)) );
HXDLIN( 355)			int _g11 = ( (int)(bytes->b->__get(1)) );
HXDLIN( 355)			switch((int)(( (int)(bytes->b->__get(0)) ))){
            				case (int)73: {
HXLINE( 355)					if ((_g11 == 68)) {
HXLINE( 355)						if ((_g2 == 51)) {
HXLINE( 357)							return HX_("audio/mp3",77,ba,40,54);
            						}
            					}
            				}
