...
HXDLIN( 788)						goto _hx_goto_11;
            					...
            					if (  (_hx_switch_0==2) ){
HXLINE( 790)						int this2 = 0;
HXDLIN( 790)						int bgra = this2;
...
HXLINE( 789)						goto _hx_goto_11;
            					...
            					/* default */{
HXLINE( 793)						int this3 = 0;
HXDLIN( 793)						int rgba2 = this3;
...
HXDLIN( 830)						goto _hx_goto_13;
            					...
            					if (  (_hx_switch_0==2) ){
HXLINE( 832)						int this2 = 0;
HXDLIN( 832)						int bgra = this2;
...
HXLINE( 831)						goto _hx_goto_13;
            					...
            					/* default */{
HXLINE( 835)						int this3 = 0;
HXDLIN( 835)						int rgba2 = this3;
...
HXDLIN(1199)						int this2 = 0;
HXDLIN(1199)						int argb2 = this2;
...
HXDLIN(1200)						int this3 = 0;
HXDLIN(1200)						int argb3 = this3;
...
HXDLIN(1236)						int this2 = 0;
HXDLIN(1236)						int argb2 = this2;
...
HXDLIN(1237)						int this3 = 0;
HXDLIN(1237)						int argb3 = this3;
...
HXDLIN(1378)						int this2 = 0;
HXDLIN(1378)						int argb1 = this2;
...
HXDLIN(1379)						int this3 = 0;
HXDLIN(1379)						int argb2 = this3;
...
HXDLIN(1386)					int this4 = 0;
HXDLIN(1386)					int argb3 = this4;
...
HXDLIN(1385)						int this5 = 0;
HXDLIN(1385)						int argb4 = this5;
...
HXDLIN(1386)						int this6 = 0;
HXDLIN(1386)						int argb5 = this6;
...
HXDLIN(1502)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),hx::paccDynamic)) );
HXDLIN(1502)					_this1->byteOffset = 0;
HXDLIN(1502)					_this1->length = array1->get_length();
HXDLIN(1502)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN(1502)					 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN(1502)					_this1->buffer = this3;
HXDLIN(1502)					_this1->copyFromArray(array1,null());
...
HXDLIN(1502)						int elementSize = _this2->bytesPerElement;
HXDLIN(1502)						if ((view->type == _this2->type)) {
HXLINE(1502)							int srcLength1 = srcData->length;
HXDLIN(1502)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(1502)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1502)							_this2->buffer = this4;
HXDLIN(1502)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE(1502)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN(1502)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN(1502)						_this2->byteOffset = 0;
HXDLIN(1502)						_this2->length = srcLength;
HXDLIN(1502)						this1 = _this2;
            					}
            					else {
HXLINE(1502)						if (hx::IsNotNull( buffer )) {
HXLINE(1502)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN(1502)							if ((hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE(1502)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN(1502)							int bufferByteLength = buffer->length;
HXDLIN(1502)							int elementSize1 = _this3->bytesPerElement;
...
HXDLIN(1502)								if ((hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE(1502)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
...
HXLINE(1502)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN(1502)								int newRange = (in_byteOffset + newByteLength);
HXDLIN(1502)								if ((newRange > bufferByteLength)) {
HXLINE(1502)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN(1502)							_this3->buffer = buffer;
HXDLIN(1502)							_this3->byteOffset = in_byteOffset;
HXDLIN(1502)							_this3->byteLength = newByteLength;
HXDLIN(1502)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN(1502)							this1 = _this3;
            						}
            						else {
...
HXDLIN(1628)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),hx::paccDynamic)) );
HXDLIN(1628)						_this1->byteOffset = 0;
HXDLIN(1628)						_this1->length = array1->get_length();
HXDLIN(1628)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN(1628)						 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN(1628)						_this1->buffer = this3;
HXDLIN(1628)						_this1->copyFromArray(array1,null());
...
HXDLIN(1628)							int elementSize = _this2->bytesPerElement;
HXDLIN(1628)							if ((view->type == _this2->type)) {
HXLINE(1628)								int srcLength1 = srcData->length;
HXDLIN(1628)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(1628)								 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1628)								_this2->buffer = this4;
HXDLIN(1628)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE(1628)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN(1628)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN(1628)							_this2->byteOffset = 0;
HXDLIN(1628)							_this2->length = srcLength;
HXDLIN(1628)							this1 = _this2;
            						}
            						else {
HXLINE(1628)							if (hx::IsNotNull( buffer1 )) {
HXLINE(1628)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
...
HXDLIN(1628)								if ((hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE(1628)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN(1628)								int bufferByteLength = buffer1->length;
HXDLIN(1628)								int elementSize1 = _this3->bytesPerElement;
...
HXDLIN(1628)									if ((hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE(1628)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
...
HXLINE(1628)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN(1628)									int newRange = (in_byteOffset + newByteLength);
HXDLIN(1628)									if ((newRange > bufferByteLength)) {
HXLINE(1628)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN(1628)								_this3->buffer = buffer1;
HXDLIN(1628)								_this3->byteOffset = in_byteOffset;
HXDLIN(1628)								_this3->byteLength = newByteLength;
HXDLIN(1628)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN(1628)								this1 = _this3;
            							}
            							else {
...
HXLINE(1864)				_hx_tmp1 = this->buffer->premultiplied;
            			}
            			else {
