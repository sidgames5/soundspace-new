...
HXDLIN( 378)			goto _hx_goto_13;
            		...
            		if (  (_hx_switch_0==HX_("TEMPLATE",3a,78,cd,05)) ){
HXLINE( 381)			HX_STACK_DO_THROW((HX_("Not sure how to load template: ",43,70,39,d8) + id));
...
HXDLIN( 379)			goto _hx_goto_13;
            		...
            		/* default */{
HXLINE( 382)			HX_STACK_DO_THROW((HX_("Unknown asset type: ",86,5e,db,f9) + type));
            		}
            		_hx_goto_13:;
...
HXLINE( 413)									f(id2,bytesLoaded,bytesTotal);
            								}
...
HXLINE( 415)									f2(id4,bytes);
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 410)								this->assetsTotal++;
HXLINE( 412)								 ::lime::app::Future future = this->loadBytes(id1);
HXLINE( 413)								 ::Dynamic f = this->load_onProgress_dyn();
HXDLIN( 413)								::String id2 = id1;
HXDLIN( 413)								future->onProgress( ::Dynamic(new _hx_Closure_0(f,id2)));
HXLINE( 414)								 ::Dynamic f1 = this->load_onError_dyn();
HXDLIN( 414)								::String id3 = id1;
HXDLIN( 414)								future->onError( ::Dynamic(new _hx_Closure_1(id3,f1)));
HXLINE( 415)								 ::Dynamic f2 = this->loadBytes_onComplete_dyn();
HXDLIN( 415)								::String id4 = id1;
HXDLIN( 415)								future->onComplete( ::Dynamic(new _hx_Closure_2(id4,f2)));
...
HXLINE( 421)									f3(id5,bytesLoaded1,bytesTotal1);
            								}
            								HX_END_LOCAL_FUNC2((void))
...
HXLINE( 423)									f5(id7,font);
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 418)								this->assetsTotal++;
HXLINE( 420)								 ::lime::app::Future future1 = this->loadFont(id1);
HXLINE( 421)								 ::Dynamic f3 = this->load_onProgress_dyn();
HXDLIN( 421)								::String id5 = id1;
HXDLIN( 421)								future1->onProgress( ::Dynamic(new _hx_Closure_3(f3,id5)));
HXLINE( 422)								 ::Dynamic f4 = this->load_onError_dyn();
HXDLIN( 422)								::String id6 = id1;
HXDLIN( 422)								future1->onError( ::Dynamic(new _hx_Closure_4(id6,f4)));
HXLINE( 423)								 ::Dynamic f5 = this->loadFont_onComplete_dyn();
HXDLIN( 423)								::String id7 = id1;
HXDLIN( 423)								future1->onComplete( ::Dynamic(new _hx_Closure_5(f5,id7)));
...
HXLINE( 429)									f6(id8,bytesLoaded2,bytesTotal2);
            								}
            								HX_END_LOCAL_FUNC2((void))
...
HXLINE( 431)									f8(id10,image);
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 426)								this->assetsTotal++;
HXLINE( 428)								 ::lime::app::Future future2 = this->loadImage(id1);
HXLINE( 429)								 ::Dynamic f6 = this->load_onProgress_dyn();
HXDLIN( 429)								::String id8 = id1;
HXDLIN( 429)								future2->onProgress( ::Dynamic(new _hx_Closure_6(f6,id8)));
HXLINE( 430)								 ::Dynamic f7 = this->load_onError_dyn();
HXDLIN( 430)								::String id9 = id1;
HXDLIN( 430)								future2->onError( ::Dynamic(new _hx_Closure_7(f7,id9)));
HXLINE( 431)								 ::Dynamic f8 = this->loadImage_onComplete_dyn();
HXDLIN( 431)								::String id10 = id1;
HXDLIN( 431)								future2->onComplete( ::Dynamic(new _hx_Closure_8(id10,f8)));
...
HXLINE( 437)									f9(id11,bytesLoaded3,bytesTotal3);
            								}
            								HX_END_LOCAL_FUNC2((void))
...
HXLINE( 439)									f11(id13,audioBuffer);
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 434)								this->assetsTotal++;
HXLINE( 436)								 ::lime::app::Future future3 = this->loadAudioBuffer(id1);
HXLINE( 437)								 ::Dynamic f9 = this->load_onProgress_dyn();
HXDLIN( 437)								::String id11 = id1;
HXDLIN( 437)								future3->onProgress( ::Dynamic(new _hx_Closure_9(id11,f9)));
HXLINE( 438)								 ::Dynamic f10 = this->loadAudioBuffer_onError_dyn();
HXDLIN( 438)								::String id12 = id1;
HXDLIN( 438)								future3->onError( ::Dynamic(new _hx_Closure_10(f10,id12)));
HXLINE( 439)								 ::Dynamic f11 = this->loadAudioBuffer_onComplete_dyn();
HXDLIN( 439)								::String id13 = id1;
HXDLIN( 439)								future3->onComplete( ::Dynamic(new _hx_Closure_11(id13,f11)));
...
HXLINE( 445)									f12(id14,bytesLoaded4,bytesTotal4);
            								}
            								HX_END_LOCAL_FUNC2((void))
...
HXLINE( 447)									f14(id16,text);
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 442)								this->assetsTotal++;
HXLINE( 444)								 ::lime::app::Future future4 = this->loadText(id1);
HXLINE( 445)								 ::Dynamic f12 = this->load_onProgress_dyn();
HXDLIN( 445)								::String id14 = id1;
HXDLIN( 445)								future4->onProgress( ::Dynamic(new _hx_Closure_12(id14,f12)));
HXLINE( 446)								 ::Dynamic f13 = this->load_onError_dyn();
HXDLIN( 446)								::String id15 = id1;
HXDLIN( 446)								future4->onError( ::Dynamic(new _hx_Closure_13(id15,f13)));
HXLINE( 447)								 ::Dynamic f14 = this->loadText_onComplete_dyn();
HXDLIN( 447)								::String id16 = id1;
HXDLIN( 447)								future4->onComplete( ::Dynamic(new _hx_Closure_14(id16,f14)));
...
HXLINE( 628)				 ::lime::utils::AssetLibrary _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 628)				_hx_tmp1->bytesLoaded = (_hx_tmp1->bytesLoaded + size);
            			}
            			else {
HXLINE( 632)				 ::Dynamic cache = this->bytesLoadedCache->get(id);
HXLINE( 634)				if (hx::IsLess( cache,size )) {
HXLINE( 636)					 ::lime::utils::AssetLibrary _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 636)					_hx_tmp2->bytesLoaded = (_hx_tmp2->bytesLoaded + (( (int)(size) ) - ( (int)(cache) )));
            				}
            			}
...
HXDLIN( 681)							goto _hx_goto_43;
            						...
            						if (  (_hx_switch_0==HX_("IMAGE",3b,57,57,3b)) ){
HXLINE( 677)							::Dynamic this2 = this->cachedImages;
HXDLIN( 677)							( ( ::haxe::ds::StringMap)(this2) )->set(id,::lime::graphics::Image_obj::fromBytes(data));
HXDLIN( 677)							goto _hx_goto_43;
            						}
            						if (  (_hx_switch_0==HX_("MUSIC",85,08,49,8e)) ||  (_hx_switch_0==HX_("SOUND",af,c4,ba,fe)) ){
HXLINE( 679)							::Dynamic this3 = this->cachedAudioBuffers;
HXDLIN( 679)							( ( ::haxe::ds::StringMap)(this3) )->set(id,::lime::media::AudioBuffer_obj::fromBytes(data));
HXDLIN( 679)							goto _hx_goto_43;
            						}
            						if (  (_hx_switch_0==HX_("TEXT",ad,94,ba,37)) ){
HXLINE( 684)							::Dynamic this4 = this->cachedText;
...
HXDLIN( 684)							( ( ::haxe::ds::StringMap)(this4) )->set(id,value);
...
HXDLIN( 699)			::Array< ::String > _g11 = bundle->paths;
HXDLIN( 699)			while((_g2 < _g11->length)){
HXLINE( 699)				::String path = _g11->__get(_g2);
HXDLIN( 699)				_g2 = (_g2 + 1);
HXLINE( 701)				{
HXLINE( 701)					::Dynamic this5 = this->cachedBytes;
HXDLIN( 701)					( ( ::haxe::ds::StringMap)(this5) )->set(path,( ( ::haxe::io::Bytes)(bundle->data->get(path)) ));
            				}
...
HXLINE( 730)					{
HXLINE( 730)						int _g2 = 0;
HXDLIN( 730)						int _g11 = pathGroup->length;
HXDLIN( 730)						while((_g2 < _g11)){
HXLINE( 730)							_g2 = (_g2 + 1);
HXDLIN( 730)							int i = (_g2 - 1);
...
HXLINE( 743)					::Dynamic this2 = this->preload;
HXDLIN( 743)					( ( ::haxe::ds::StringMap)(this2) )->set(id,( (bool)(::Reflect_obj::field(asset,HX_("preload",c9,47,43,35))) ));
            				}
...
HXLINE( 763)		{
HXLINE( 763)			int _g21 = 0;
HXDLIN( 763)			::cpp::VirtualArray _g3 = manifest->assets;
HXDLIN( 763)			while((_g21 < _g3->get_length())){
HXLINE( 763)				 ::Dynamic asset1 = _g3->__get(_g21);
HXDLIN( 763)				_g21 = (_g21 + 1);
HXLINE( 765)				if (::Reflect_obj::hasField(asset1,HX_("id",db,5b,00,00))) {
HXLINE( 765)					id = ( (::String)(asset1->__Field(HX_("id",db,5b,00,00),hx::paccDynamic)) );
            				}
            				else {
HXLINE( 765)					id = ( (::String)(asset1->__Field(HX_("path",a5,e5,51,4a),hx::paccDynamic)) );
            				}
...
HXLINE( 769)					 ::lime::utils::AssetLibrary _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 769)					int _hx_tmp3 = _hx_tmp2->bytesTotal;
HXDLIN( 769)					_hx_tmp2->bytesTotal = (_hx_tmp3 + this->sizes->get(id));
            				}
            			}
            		}
            	}
...
HXDLIN( 806)						if ((i != 0)) {
HXLINE( 806)							_hx_tmp1 = (newPath->__get((i - 1)) == HX_("..",40,28,00,00));
            						}
            						else {
...
HXLINE( 906)			 ::lime::app::Promise_lime_utils_AssetLibrary _hx_tmp1 = this->promise;
HXDLIN( 906)			_hx_tmp1->error((((HX_("Error loading asset \"",d6,ff,4d,83) + id) + HX_("\": ",48,ff,19,00)) + ::Std_obj::string(message)));
            		}
            		else {
...
HXLINE( 945)				 ::lime::utils::AssetLibrary _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 945)				_hx_tmp1->bytesLoaded = (_hx_tmp1->bytesLoaded + bytesLoaded);
            			}
