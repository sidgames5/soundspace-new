...
HXLINE( 420)				 ::lime::utils::AssetLibrary library1 = ::lime::utils::AssetLibrary_obj::fromBundle(bundle);
HXLINE( 422)				if (hx::IsNull( library1 )) {
HXLINE( 424)					promise->error(((HX_("Cannot open library \"",44,cc,55,e7) + id) + HX_("\"",22,00,00,00)));
            				}
            				else {
HXLINE( 428)					::lime::utils::Assets_obj::libraries->set(id,library1);
HXLINE( 429)					library1->onChange->add(::lime::utils::Assets_obj::onChange->dispatch_dyn(),null(),null());
HXLINE( 430)					 ::lime::app::Future _hx_tmp = library1->load();
HXDLIN( 430)					promise->completeWith(_hx_tmp);
            				}
            			}
            			HX_END_LOCAL_FUNC1((void))
...
HXLINE( 466)				 ::lime::utils::AssetLibrary library2 = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE( 468)				if (hx::IsNull( library2 )) {
HXLINE( 470)					promise->error(((HX_("Cannot open library \"",44,cc,55,e7) + id) + HX_("\"",22,00,00,00)));
            				}
            				else {
HXLINE( 474)					::lime::utils::Assets_obj::libraries->set(id,library2);
HXLINE( 475)					library2->onChange->add(::lime::utils::Assets_obj::onChange->dispatch_dyn(),null(),null());
HXLINE( 476)					 ::lime::app::Future _hx_tmp1 = library2->load();
HXDLIN( 476)					promise->completeWith(_hx_tmp1);
            				}
            			}
            			HX_END_LOCAL_FUNC1((void))
