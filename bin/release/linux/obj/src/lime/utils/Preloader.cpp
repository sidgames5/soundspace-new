...
HXDLIN( 143)						_gthis2->bytesLoaded = (_gthis3 + (loaded - _gthis->bytesLoadedCache->get_int(library1)));
            					}
...
HXDLIN( 161)						_gthis5->bytesLoaded = (_gthis6 + (library2 - _gthis->bytesLoadedCache->get_int(library1)));
            					}
...
HXLINE( 130)				 ::lime::utils::AssetLibrary library1 = _g3->__get(_g2).StaticCast<  ::lime::utils::AssetLibrary >();
...
HXDLIN( 176)				_hx_tmp1->bytesTotal = (_hx_tmp1->bytesTotal + 200);
            			}
            		}
...
HXDLIN( 257)								_gthis3->bytesLoaded = (_gthis4 + (loaded - _gthis->bytesLoadedCache2->get_int(name)));
            							}
...
HXLINE( 270)						int total1 = 200;
HXLINE( 272)						if (_gthis->bytesTotalCache->exists(name)) {
HXLINE( 274)							total1 = _gthis->bytesTotalCache->get_int(name);
            						}
...
HXDLIN( 283)							_gthis6->bytesLoaded = (_gthis7 + (total1 - _gthis->bytesLoadedCache2->get_int(name)));
            						}
