...
HXDLIN( 471)						int _g11 = bdH;
HXDLIN( 471)						while((_g2 < _g11)){
HXLINE( 471)							_g2 = (_g2 + 1);
HXDLIN( 471)							int j = (_g2 - 1);
HXLINE( 473)							pCol = bd->getPixel(i,j);
HXLINE( 475)							{
HXLINE( 475)								int _g3 = 0;
HXDLIN( 475)								int _g12 = Scale;
HXDLIN( 475)								while((_g3 < _g12)){
HXLINE( 475)									_g3 = (_g3 + 1);
HXDLIN( 475)									int k = (_g3 - 1);
HXLINE( 477)									{
HXLINE( 477)										int _g4 = 0;
HXDLIN( 477)										int _g13 = Scale;
HXDLIN( 477)										while((_g4 < _g13)){
HXLINE( 477)											_g4 = (_g4 + 1);
HXDLIN( 477)											int m = (_g4 - 1);
...
HXLINE( 493)			int _g5 = 0;
HXDLIN( 493)			int _g14 = ColorMap->length;
HXDLIN( 493)			while((_g5 < _g14)){
HXLINE( 493)				_g5 = (_g5 + 1);
HXDLIN( 493)				int i1 = (_g5 - 1);
