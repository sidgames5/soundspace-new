...
HXLINE( 147)					_hx_tmp3 = (alphaB >= AlphaTolerance);
            				}
            				else {
...
HXDLIN( 157)			int _g3 = (overlapPixels >> 1);
HXDLIN( 157)			while((_g2 < _g3)){
HXLINE( 157)				_g2 = (_g2 + 1);
HXDLIN( 157)				int i1 = (_g2 - 1);
HXLINE( 159)				alphaIdx = ((i1 << 3) + 4);
...
HXLINE( 164)					_hx_tmp4 = (alphaB >= AlphaTolerance);
            				}
            				else {
...
HXLINE( 255)				 ::flixel::math::FlxRect _this1 = ::flixel::FlxG_obj::worldBounds;
HXDLIN( 255)				_this1->x = Camera->x;
HXDLIN( 255)				_this1->y = Camera->y;
HXDLIN( 255)				_this1->width = ( (Float)(Camera->width) );
HXDLIN( 255)				_this1->height = ( (Float)(Camera->height) );
            			}
            		}
