...
HXDLIN( 111)			if (Right) {
HXLINE( 111)				_hx_tmp1 = (sprite->x >= ::flixel::FlxG_obj::width);
            			}
            			else {
...
HXDLIN( 116)		if (Top) {
HXLINE( 116)			_hx_tmp2 = ((sprite->y + (( (Float)(sprite->frameHeight) ) / ( (Float)(2) ))) <= 0);
            		}
            		else {
...
HXLINE( 120)				_hx_tmp3 = (sprite->y >= ::flixel::FlxG_obj::height);
            			}
            			else {
...
HXLINE( 181)				_hx_tmp1 = (spriteBounds->x > (viewBounds->x + viewBounds->width));
            			}
            			else {
...
HXLINE( 184)			_hx_tmp2 = ((spriteBounds->y + spriteBounds->height) < viewBounds->y);
            		}
            		else {
...
HXLINE( 186)				_hx_tmp3 = (spriteBounds->y > (viewBounds->y + viewBounds->height));
            			}
            			else {
...
HXDLIN( 219)			int dir1 = 16;
HXDLIN( 219)			if (((edges & dir1) == dir1)) {
HXLINE( 219)				_hx_tmp1 = ((spriteBounds->x + spriteBounds->width) > (viewBounds->x + viewBounds->width));
            			}
            			else {
...
HXDLIN( 222)		int dir2 = 256;
HXDLIN( 222)		if (((edges & dir2) == dir2)) {
HXLINE( 222)			_hx_tmp2 = (spriteBounds->y < viewBounds->y);
            		}
            		else {
...
HXDLIN( 224)			int dir3 = 4096;
HXDLIN( 224)			if (((edges & dir3) == dir3)) {
HXLINE( 224)				_hx_tmp3 = ((spriteBounds->y + spriteBounds->height) > (viewBounds->y + viewBounds->height));
            			}
            			else {
...
HXLINE( 561)				 ::flixel::math::FlxPoint p1 = Vertices->__get(_g).StaticCast<  ::flixel::math::FlxPoint >();
HXDLIN( 561)				_g = (_g + 1);
HXLINE( 563)				::flixel::util::FlxSpriteUtil_obj::flashGfx->lineTo(p1->x,p1->y);
            			}
            		}
HXLINE( 565)		{
