...
HXLINE(1243)			HX_STACK_DO_THROW(HX_("Cannot cancel tween variables of an object that is null.",1a,65,0e,44));
            		}
...
HXLINE(1275)			int i1 = this->_tweens->length;
HXLINE(1276)			while(true){
HXLINE(1276)				i1 = (i1 - 1);
HXDLIN(1276)				if (!(((i1 + 1) > 0))) {
HXLINE(1276)					goto _hx_goto_38;
            				}
HXLINE(1278)				 ::flixel::tweens::FlxTween tween1 = this->_tweens->__get(i1).StaticCast<  ::flixel::tweens::FlxTween >();
HXLINE(1279)				{
HXLINE(1279)					int _g11 = 0;
HXDLIN(1279)					while((_g11 < propertyInfos->length)){
HXLINE(1279)						 ::Dynamic info = propertyInfos->__get(_g11);
HXDLIN(1279)						_g11 = (_g11 + 1);
HXLINE(1281)						if (tween1->isTweenOf( ::Dynamic(info->__Field(HX_("object",bf,7e,3f,15),hx::paccDynamic)),( (::String)(info->__Field(HX_("field",ba,94,93,00),hx::paccDynamic)) ))) {
HXLINE(1283)							Function(tween1);
