...
HXLINE( 493)			Float _hx_tmp2;
HXDLIN( 493)			if (this->backward) {
HXLINE( 493)				_hx_tmp2 = ( (Float)(0) );
            			}
            			else {
HXLINE( 493)				_hx_tmp2 = ( (Float)(1) );
            			}
HXDLIN( 493)			this->scale = _hx_tmp2;
...
HXLINE( 573)				_hx_tmp1 = hx::IsNotNull( this->manager );
            			}
            			else {
...
HXLINE( 579)			_hx_tmp2 = (type == 4);
            		}
            		else {
HXLINE( 579)			_hx_tmp2 = true;
            		}
...
HXLINE( 584)				_hx_tmp4 = (this->scale > 0);
            			}
            			else {
HXLINE( 584)				_hx_tmp4 = false;
            			}
HXDLIN( 584)			if (_hx_tmp4) {
HXLINE( 584)				_hx_tmp3 = (this->scale < 1);
            			}
            			else {
