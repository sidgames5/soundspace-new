...
bool FlxPreloader_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x1b123bf8) {
		...
		if (inClassId<=(int)0x6eebd534) {
			if (inClassId<=(int)0x3f30b5cf) {
				return inClassId==(int)0x3f2b00af || inClassId==(int)0x3f30b5cf;
			} else {
...
HXLINE(  60)			logoLight1->set_width(logoLight1->set_height(( (Float)(_gthis->_height) )));
HXLINE(  61)			int _gthis1 = _gthis->_width;
HXDLIN(  61)			logoLight1->set_x(((( (Float)(_gthis1) ) - logoLight1->get_width()) / ( (Float)(2) )));
            		}
...
HXLINE(  95)			corners1->set_width(( (Float)(_gthis->_width) ));
HXLINE(  96)			corners1->set_height(_gthis->get_height());
            		}
            		HX_END_LOCAL_FUNC1((void))
