...
HXLINE( 160)			if (::Std_obj::is(object,hx::ClassOf< ::flixel::_hx_system::debug::FlxDebugger >())) {
...
HXLINE( 330)					Float _hx_tmp2 = (member1->x - ::flixel::FlxG_obj::camera->scroll->x);
HXDLIN( 330)					Float _hx_tmp3 = (member1->y - ::flixel::FlxG_obj::camera->scroll->y);
HXDLIN( 330)					Float _hx_tmp4 = member1->get_width();
HXDLIN( 330)					gfx->drawRect(_hx_tmp2,_hx_tmp3,_hx_tmp4,member1->get_height());
            				}
            			}
            		}
...
HXDLIN( 349)				_g = (_g + 1);
HXLINE( 350)				if (::Std_obj::is(tool,className)) {
...
HXDLIN( 567)				if (::Std_obj::is(member,hx::ClassOf< ::flixel::FlxSprite >())) {
