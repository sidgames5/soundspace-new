...
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_298_update,"flixel.system.debug.Window","update",0xcd50591f,"flixel.system.debug.Window.update","flixel/system/debug/Window.hx",298,0xb8dfd4e5)
...
HXLINE( 161)			_hx_tmp3 = (this->_height != 0);
            		}
            		else {
...
HXLINE( 273)			_hx_tmp1 = this->_alwaysOnTop;
            		}
            		else {
...
void Window_obj::update(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_298_update)
            	}
...
HXLINE( 345)					_hx_tmp5 = (mouseX <= this->_width);
            				}
            				else {
HXLINE( 345)					_hx_tmp5 = false;
            				}
HXDLIN( 345)				if (_hx_tmp5) {
HXLINE( 345)					_hx_tmp4 = (mouseY >= 0);
            				}
            				else {
HXLINE( 345)					_hx_tmp4 = false;
            				}
HXDLIN( 345)				if (_hx_tmp4) {
HXLINE( 345)					_hx_tmp3 = (mouseY <= this->_height);
            				}
            				else {
HXLINE( 345)					_hx_tmp3 = false;
            				}
HXDLIN( 345)				if (_hx_tmp3) {
HXLINE( 347)					bool _hx_tmp6;
HXDLIN( 347)					if ((mouseX <= this->_header->get_width())) {
HXLINE( 347)						_hx_tmp6 = (mouseY <= this->_header->get_height());
            					}
            					else {
HXLINE( 347)						_hx_tmp6 = false;
            					}
HXDLIN( 347)					this->_overHeader = _hx_tmp6;
HXLINE( 348)					if (this->_resizable) {
HXLINE( 350)						bool _hx_tmp7;
HXDLIN( 350)						int _hx_tmp8 = this->_width;
HXDLIN( 350)						if ((mouseX >= (( (Float)(_hx_tmp8) ) - this->_handle->get_width()))) {
HXLINE( 350)							int _hx_tmp9 = this->_height;
HXDLIN( 350)							_hx_tmp7 = (mouseY >= (( (Float)(_hx_tmp9) ) - this->_handle->get_height()));
            						}
            						else {
HXLINE( 350)							_hx_tmp7 = false;
            						}
HXDLIN( 350)						this->_overHandle = _hx_tmp7;
            					}
            				}
            				else {
...
HXLINE( 419)			 ::openfl::display::Bitmap _hx_tmp6 = this->_handle;
HXDLIN( 419)			int _hx_tmp7 = this->_width;
HXDLIN( 419)			_hx_tmp6->set_x((( (Float)(_hx_tmp7) ) - this->_handle->get_width()));
HXLINE( 420)			 ::openfl::display::Bitmap _hx_tmp8 = this->_handle;
HXDLIN( 420)			int _hx_tmp9 = this->_height;
HXDLIN( 420)			_hx_tmp8->set_y((( (Float)(_hx_tmp9) ) - this->_handle->get_height()));
            		}
HXLINE( 422)		if (hx::IsNotNull( this->_closeButton )) {
HXLINE( 424)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp10 = this->_closeButton;
HXDLIN( 424)			int _hx_tmp11 = this->_width;
HXDLIN( 424)			_hx_tmp10->set_x(((( (Float)(_hx_tmp11) ) - this->_closeButton->get_width()) - ( (Float)(3) )));
