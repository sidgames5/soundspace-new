...
HXLINE( 142)				_hx_tmp1 = hx::IsNotNull( sound->_sound );
            			}
            			else {
...
HXLINE( 223)		if (::Std_obj::is(EmbeddedSound,hx::ClassOf< ::String >())) {
...
HXLINE( 263)					_hx_tmp3 = sound->exists;
            				}
            				else {
HXLINE( 263)					_hx_tmp3 = false;
            				}
HXDLIN( 263)				if (_hx_tmp3) {
HXLINE( 263)					_hx_tmp2 = sound->active;
            				}
            				else {
...
HXLINE( 282)					_hx_tmp1 = sound->exists;
            				}
            				else {
...
HXLINE( 304)						_hx_tmp1 = !(sound->persist);
            					}
            					else {
