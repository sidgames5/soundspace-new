...
HXLINE( 350)		if (::Std_obj::is(EmbeddedSound,hx::ClassOf< ::openfl::media::Sound >())) {
HXLINE( 352)			this->_sound = ( ( ::openfl::media::Sound)(EmbeddedSound) );
            		}
            		else {
HXLINE( 354)			if (::Std_obj::is(EmbeddedSound,hx::ClassOf< ::hx::Class >())) {
HXLINE( 356)				this->_sound = ( ( ::openfl::media::Sound)(::Type_obj::createInstance(EmbeddedSound,::cpp::VirtualArray_obj::__new(0))) );
            			}
            			else {
HXLINE( 358)				if (::Std_obj::is(EmbeddedSound,hx::ClassOf< ::String >())) {
