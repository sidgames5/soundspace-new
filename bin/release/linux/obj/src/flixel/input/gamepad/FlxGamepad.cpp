...
HXDLIN( 772)		 ::flixel::input::gamepad::FlxGamepadAnalogStick stick5 = stick;
HXLINE( 773)		bool _hx_tmp;
HXDLIN( 773)		if (hx::IsNotEq( stick5->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::ONLY_DIGITAL_dyn() )) {
HXLINE( 773)			_hx_tmp = hx::IsEq( stick5->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::BOTH_dyn() );
            		}
            		else {
HXLINE( 773)			_hx_tmp = true;
            		}
HXDLIN( 773)		if (_hx_tmp) {
HXLINE( 775)			this->handleAxisMoveSub(stick5,axis,newValue,oldValue,((Float)1.0));
HXLINE( 776)			this->handleAxisMoveSub(stick5,axis,newValue,oldValue,((Float)-1.0));
HXLINE( 778)			bool _hx_tmp1 = hx::IsEq( stick5->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::ONLY_DIGITAL_dyn() );
            		}
            	}
