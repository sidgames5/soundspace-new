...
HX_LOCAL_STACK_FRAME(_hx_pos_1a66c6297c27823a_54_onDown,"flixel.input.mouse.FlxMouseButton","onDown",0x8ad419ab,"flixel.input.mouse.FlxMouseButton.onDown","flixel/input/mouse/FlxMouseButton.hx",54,0x7fcdf6f7)
...
void FlxMouseButton_obj::onDown( ::openfl::events::MouseEvent _){
            	HX_STACKFRAME(&_hx_pos_1a66c6297c27823a_54_onDown)
HXLINE(  57)		bool _hx_tmp;
HXDLIN(  57)		if (::flixel::FlxG_obj::game->replaying) {
HXLINE(  57)			_hx_tmp = hx::IsNotNull( ::flixel::FlxG_obj::vcr->cancelKeys );
            		}
            		else {
...
HXLINE(  59)			int _g = 0;
HXDLIN(  59)			::Array< int > _g1 = ::flixel::FlxG_obj::vcr->cancelKeys;
HXDLIN(  59)			while((_g < _g1->length)){
HXLINE(  59)				int key = _g1->__get(_g);
HXDLIN(  59)				_g = (_g + 1);
HXLINE(  61)				bool _hx_tmp1;
HXDLIN(  61)				if ((::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::toStringMap->get_string(key) != HX_("MOUSE",05,4e,53,8a))) {
HXLINE(  61)					_hx_tmp1 = (::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::toStringMap->get_string(key) == HX_("ANY",cc,96,31,00));
            				}
            				else {
HXLINE(  61)					_hx_tmp1 = true;
            				}
HXDLIN(  61)				if (_hx_tmp1) {
HXLINE(  63)					::flixel::FlxG_obj::vcr->cancelReplay();
