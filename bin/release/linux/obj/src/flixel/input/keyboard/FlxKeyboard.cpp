...
HXLINE( 112)		this->super::onKeyDown(event);
HXLINE( 116)		bool _hx_tmp;
HXDLIN( 116)		bool _hx_tmp1;
HXDLIN( 116)		if (::flixel::FlxG_obj::game->replaying) {
HXLINE( 116)			_hx_tmp1 = !(this->inKeyArray(::flixel::FlxG_obj::debugger->toggleKeys,event));
            		}
            		else {
HXLINE( 116)			_hx_tmp1 = false;
            		}
HXDLIN( 116)		if (_hx_tmp1) {
HXLINE( 116)			_hx_tmp = this->inKeyArray(::flixel::FlxG_obj::vcr->cancelKeys,event);
            		}
            		else {
HXLINE( 116)			_hx_tmp = false;
            		}
HXDLIN( 116)		if (_hx_tmp) {
HXLINE( 118)			::flixel::FlxG_obj::vcr->cancelReplay();
            		}
            	}
