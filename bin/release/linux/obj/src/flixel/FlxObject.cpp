...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1181_getBoundingBox,"flixel.FlxObject","getBoundingBox",0x58364780,"flixel.FlxObject.getBoundingBox","flixel/FlxObject.hx",1181,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1205_getRotatedBounds,"flixel.FlxObject","getRotatedBounds",0x6b926bb7,"flixel.FlxObject.getRotatedBounds","flixel/FlxObject.hx",1205,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1283_get_solid,"flixel.FlxObject","get_solid",0x5018e773,"flixel.FlxObject.get_solid","flixel/FlxObject.hx",1283,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1314_set_pixelPerfectRender,"flixel.FlxObject","set_pixelPerfectRender",0x84233609,"flixel.FlxObject.set_pixelPerfectRender","flixel/FlxObject.hx",1314,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1345_set_path,"flixel.FlxObject","set_path",0xde100cd1,"flixel.FlxObject.set_path","flixel/FlxObject.hx",1345,0xf0fe0d80)
...
HXLINE( 812)				Float object2 = object->x;
HXDLIN( 812)				Float _hx_tmp3 = this->x;
HXDLIN( 812)				_hx_tmp1 = (object2 < (_hx_tmp3 + this->get_width()));
            			}
            			else {
...
HXDLIN( 812)				Float _hx_tmp4 = (object3 + object->get_height());
HXDLIN( 812)				_hx_tmp = (_hx_tmp4 > this->y);
            			}
            			else {
...
HXDLIN( 812)				Float _hx_tmp5 = this->y;
HXDLIN( 812)				return (object4 < (_hx_tmp5 + this->get_height()));
            			}
            			else {
...
HXLINE( 821)		bool _hx_tmp6;
HXDLIN( 821)		bool _hx_tmp7;
HXDLIN( 821)		Float objectScreenPos1 = objectScreenPos->x;
HXDLIN( 821)		Float _hx_tmp8 = (objectScreenPos1 + object->get_width());
HXDLIN( 821)		if ((_hx_tmp8 > this->_point->x)) {
HXLINE( 822)			Float objectScreenPos2 = objectScreenPos->x;
HXDLIN( 822)			Float _hx_tmp9 = this->_point->x;
HXLINE( 821)			_hx_tmp7 = (objectScreenPos2 < (_hx_tmp9 + this->get_width()));
            		}
            		else {
HXLINE( 821)			_hx_tmp7 = false;
            		}
HXDLIN( 821)		if (_hx_tmp7) {
HXLINE( 823)			Float objectScreenPos3 = objectScreenPos->y;
HXDLIN( 823)			Float _hx_tmp10 = (objectScreenPos3 + object->get_height());
HXLINE( 821)			_hx_tmp6 = (_hx_tmp10 > this->_point->y);
            		}
            		else {
HXLINE( 821)			_hx_tmp6 = false;
            		}
HXDLIN( 821)		if (_hx_tmp6) {
HXLINE( 824)			Float objectScreenPos4 = objectScreenPos->y;
HXDLIN( 824)			Float _hx_tmp11 = this->_point->y;
HXDLIN( 824)			return (objectScreenPos4 < (_hx_tmp11 + this->get_height()));
            		}
            		else {
...
HXLINE( 873)				Float object2 = object->x;
HXDLIN( 873)				_hx_tmp1 = (object2 < (X + this->get_width()));
            			}
            			else {
HXLINE( 873)				_hx_tmp1 = false;
            			}
HXDLIN( 873)			if (_hx_tmp1) {
HXLINE( 873)				Float object3 = object->y;
HXDLIN( 873)				_hx_tmp = ((object3 + object->get_height()) > Y);
            			}
            			else {
HXLINE( 873)				_hx_tmp = false;
            			}
HXDLIN( 873)			if (_hx_tmp) {
HXLINE( 873)				Float object4 = object->y;
HXDLIN( 873)				return (object4 < (Y + this->get_height()));
            			}
            			else {
...
HXDLIN( 882)		Float _hx_tmp4 = (objectScreenPos1 + object->get_width());
HXDLIN( 882)		if ((_hx_tmp4 > this->_point->x)) {
HXLINE( 883)			Float objectScreenPos2 = objectScreenPos->x;
HXDLIN( 883)			Float _hx_tmp5 = this->_point->x;
HXLINE( 882)			_hx_tmp3 = (objectScreenPos2 < (_hx_tmp5 + this->get_width()));
            		}
            		else {
HXLINE( 882)			_hx_tmp3 = false;
            		}
HXDLIN( 882)		if (_hx_tmp3) {
HXLINE( 884)			Float objectScreenPos3 = objectScreenPos->y;
HXDLIN( 884)			Float _hx_tmp6 = (objectScreenPos3 + object->get_height());
HXLINE( 882)			_hx_tmp2 = (_hx_tmp6 > this->_point->y);
            		}
            		else {
HXLINE( 882)			_hx_tmp2 = false;
            		}
HXDLIN( 882)		if (_hx_tmp2) {
HXLINE( 885)			Float objectScreenPos4 = objectScreenPos->y;
HXDLIN( 885)			Float _hx_tmp7 = this->_point->y;
HXDLIN( 885)			return (objectScreenPos4 < (_hx_tmp7 + this->get_height()));
            		}
            		else {
...
HXDLIN( 907)				Float _hx_tmp2 = this->x;
HXDLIN( 907)				_hx_tmp1 = (point1 < (_hx_tmp2 + this->get_width()));
            			}
            			else {
...
HXLINE( 907)				Float point2 = point->y;
HXDLIN( 907)				Float _hx_tmp3 = this->y;
HXDLIN( 907)				return (point2 < (_hx_tmp3 + this->get_height()));
            			}
            			else {
...
HXLINE( 918)			Float _hx_tmp6 = this->_point->x;
HXDLIN( 918)			_hx_tmp5 = (xPos < (_hx_tmp6 + this->get_width()));
            		}
            		else {
HXLINE( 918)			_hx_tmp5 = false;
            		}
HXDLIN( 918)		if (_hx_tmp5) {
HXLINE( 918)			_hx_tmp4 = (yPos >= this->_point->y);
            		}
            		else {
HXLINE( 918)			_hx_tmp4 = false;
            		}
HXDLIN( 918)		if (_hx_tmp4) {
HXLINE( 918)			Float _hx_tmp7 = this->_point->y;
HXDLIN( 918)			return (yPos < (_hx_tmp7 + this->get_height()));
            		}
            		else {
...
HXDLIN( 929)			Float _hx_tmp4 = this->y;
HXDLIN( 929)			Float _hx_tmp5 = (_hx_tmp4 + this->get_height());
HXDLIN( 929)			_hx_tmp = (_hx_tmp5 > ::flixel::FlxG_obj::worldBounds->y);
            		}
            		else {
HXDLIN( 929)			_hx_tmp = false;
            		}
HXDLIN( 929)		if (_hx_tmp) {
HXDLIN( 929)			 ::flixel::math::FlxRect _this1 = ::flixel::FlxG_obj::worldBounds;
HXDLIN( 929)			return (this->y < (_this1->y + _this1->height));
            		}
            		else {
...
HXDLIN(1072)		switch((int)(axes->_hx_getIndex())){
...
HXLINE(1073)			int _hx_tmp1 = ::flixel::FlxG_obj::width;
HXDLIN(1073)			this->set_x(((( (Float)(_hx_tmp1) ) - this->get_width()) / ( (Float)(2) )));
            		}
HXLINE(1075)		bool _hx_tmp2;
HXDLIN(1075)		switch((int)(axes->_hx_getIndex())){
            			case (int)1: case (int)2: {
HXLINE(1075)				_hx_tmp2 = true;
            			}
            			break;
            			default:{
HXLINE(1075)				_hx_tmp2 = false;
            			}
            		}
HXDLIN(1075)		if (_hx_tmp2) {
HXLINE(1076)			int _hx_tmp3 = ::flixel::FlxG_obj::height;
HXDLIN(1076)			this->set_y(((( (Float)(_hx_tmp3) ) - this->get_height()) / ( (Float)(2) )));
            		}
HXLINE(1078)		return hx::ObjectPtr<OBJ_>(this);
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FlxObject_obj,setSize,(void))
 ...
 ::flixel::math::FlxRect FlxObject_obj::getBoundingBox( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1181_getBoundingBox)
HXLINE(1182)		this->getScreenPosition(this->_point,camera);
HXLINE(1184)		{
HXLINE(1184)			 ::flixel::math::FlxRect _this = this->_rect;
HXDLIN(1184)			Float X = this->_point->x;
HXDLIN(1184)			Float Y = this->_point->y;
HXDLIN(1184)			Float Width = this->get_width();
HXDLIN(1184)			Float Height = this->get_height();
HXDLIN(1184)			_this->x = X;
HXDLIN(1184)			_this->y = Y;
HXDLIN(1184)			_this->width = Width;
HXDLIN(1184)			_this->height = Height;
            		}
HXLINE(1185)		this->_rect = camera->transformRect(this->_rect);
HXLINE(1187)		if (this->isPixelPerfectRender(camera)) {
HXLINE(1189)			 ::flixel::math::FlxRect _this1 = this->_rect;
HXDLIN(1189)			_this1->x = ( (Float)(::Math_obj::floor(_this1->x)) );
HXDLIN(1189)			_this1->y = ( (Float)(::Math_obj::floor(_this1->y)) );
HXDLIN(1189)			_this1->width = ( (Float)(::Math_obj::floor(_this1->width)) );
HXDLIN(1189)			_this1->height = ( (Float)(::Math_obj::floor(_this1->height)) );
            		}
HXLINE(1192)		return this->_rect;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxObject_obj,getBoundingBox,return )
 ...
 ::flixel::math::FlxRect FlxObject_obj::getRotatedBounds( ::flixel::math::FlxRect newRect){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1205_getRotatedBounds)
HXLINE(1206)		if (hx::IsNull( newRect )) {
HXLINE(1207)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN(1207)			_this->x = ( (Float)(0) );
HXDLIN(1207)			_this->y = ( (Float)(0) );
HXDLIN(1207)			_this->width = ( (Float)(0) );
HXDLIN(1207)			_this->height = ( (Float)(0) );
HXDLIN(1207)			 ::flixel::math::FlxRect rect = _this;
HXDLIN(1207)			rect->_inPool = false;
HXDLIN(1207)			newRect = rect;
            		}
HXLINE(1209)		{
HXLINE(1209)			Float X = this->x;
HXDLIN(1209)			Float Y = this->y;
HXDLIN(1209)			Float Width = this->get_width();
HXDLIN(1209)			Float Height = this->get_height();
HXDLIN(1209)			newRect->x = X;
HXDLIN(1209)			newRect->y = Y;
HXDLIN(1209)			newRect->width = Width;
HXDLIN(1209)			newRect->height = Height;
            		}
HXLINE(1210)		return newRect->getRotatedBounds(this->angle,null(),newRect);
            	}
...
bool FlxObject_obj::get_solid(){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1283_get_solid)
HXDLIN(1283)		return ((this->allowCollisions & 4369) > 0);
            	}
...
bool FlxObject_obj::set_pixelPerfectRender(bool Value){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1314_set_pixelPerfectRender)
HXDLIN(1314)		return ( (bool)((this->pixelPerfectRender = Value)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxObject_obj,set_allowCollisions,return )
 ...
 ::flixel::util::FlxPath FlxObject_obj::set_path( ::flixel::util::FlxPath path){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1345_set_path)
HXLINE(1346)		if (hx::IsEq( this->path,path )) {
HXLINE(1347)			return path;
            		}
HXLINE(1349)		if (hx::IsNotNull( this->path )) {
HXLINE(1350)			this->path->object = null();
            		}
HXLINE(1352)		if (hx::IsNotNull( path )) {
HXLINE(1353)			path->object = hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE(1354)		return (this->path = path);
            	}
...
HXLINE( 159)						_hx_tmp5 = (overlap > maxOverlap);
            					}
            					else {
HXLINE( 159)						_hx_tmp5 = false;
            					}
HXDLIN( 159)					if (!(_hx_tmp5)) {
HXLINE( 159)						_hx_tmp4 = ((Object1->allowCollisions & 16) == 0);
            					}
            					else {
HXLINE( 159)						_hx_tmp4 = true;
            					}
HXDLIN( 159)					if (!(_hx_tmp4)) {
HXLINE( 159)						_hx_tmp3 = ((Object2->allowCollisions & 1) == 0);
            					}
            					else {
...
HXLINE( 173)						Float Object12 = Object1->x;
HXDLIN( 173)						Float overlap2 = (Object12 - Object2->get_width());
HXDLIN( 173)						overlap = (overlap2 - Object2->x);
HXLINE( 174)						bool _hx_tmp6;
HXDLIN( 174)						bool _hx_tmp7;
HXDLIN( 174)						bool _hx_tmp8;
HXDLIN( 174)						if (checkMaxOverlap) {
HXLINE( 174)							_hx_tmp8 = (-(overlap) > maxOverlap);
            						}
            						else {
HXLINE( 174)							_hx_tmp8 = false;
            						}
HXDLIN( 174)						if (!(_hx_tmp8)) {
HXLINE( 174)							_hx_tmp7 = ((Object1->allowCollisions & 1) == 0);
            						}
            						else {
HXLINE( 174)							_hx_tmp7 = true;
            						}
HXDLIN( 174)						if (!(_hx_tmp7)) {
HXLINE( 174)							_hx_tmp6 = ((Object2->allowCollisions & 16) == 0);
            						}
            						else {
...
HXLINE( 216)			 ::flixel::tile::FlxBaseTilemap tilemap1 = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );
HXLINE( 217)			return tilemap1->overlapsWithCallback(Object1,::flixel::FlxObject_obj::separateX_dyn(),true,null());
            		}
...
HXLINE( 227)				_hx_tmp1 = !(obj2immovable);
            			}
            			else {
...
HXLINE( 248)						{
HXLINE( 248)							 ::flixel::FlxObject _g1 = Object2;
HXDLIN( 248)							_g1->set_x((_g1->x + overlap));
            						}
...
HXLINE( 274)			 ::flixel::tile::FlxBaseTilemap tilemap1 = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );
HXLINE( 275)			return tilemap1->overlapsWithCallback(Object1,::flixel::FlxObject_obj::updateTouchingFlagsX_dyn(),true,null());
            		}
...
HXLINE( 316)						_hx_tmp5 = (overlap > maxOverlap);
            					}
            					else {
HXLINE( 316)						_hx_tmp5 = false;
            					}
HXDLIN( 316)					if (!(_hx_tmp5)) {
HXLINE( 316)						_hx_tmp4 = ((Object1->allowCollisions & 4096) == 0);
            					}
            					else {
HXLINE( 316)						_hx_tmp4 = true;
            					}
HXDLIN( 316)					if (!(_hx_tmp4)) {
HXLINE( 316)						_hx_tmp3 = ((Object2->allowCollisions & 256) == 0);
            					}
            					else {
...
HXLINE( 330)						Float Object12 = Object1->y;
HXDLIN( 330)						Float overlap2 = (Object12 - Object2->get_height());
HXDLIN( 330)						overlap = (overlap2 - Object2->y);
HXLINE( 331)						bool _hx_tmp6;
HXDLIN( 331)						bool _hx_tmp7;
HXDLIN( 331)						bool _hx_tmp8;
HXDLIN( 331)						if (checkMaxOverlap) {
HXLINE( 331)							_hx_tmp8 = (-(overlap) > maxOverlap);
            						}
            						else {
HXLINE( 331)							_hx_tmp8 = false;
            						}
HXDLIN( 331)						if (!(_hx_tmp8)) {
HXLINE( 331)							_hx_tmp7 = ((Object1->allowCollisions & 256) == 0);
            						}
            						else {
HXLINE( 331)							_hx_tmp7 = true;
            						}
HXDLIN( 331)						if (!(_hx_tmp7)) {
HXLINE( 331)							_hx_tmp6 = ((Object2->allowCollisions & 4096) == 0);
            						}
            						else {
HXLINE( 331)							_hx_tmp6 = true;
            						}
...
HXLINE( 373)			 ::flixel::tile::FlxBaseTilemap tilemap1 = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );
HXLINE( 374)			return tilemap1->overlapsWithCallback(Object1,::flixel::FlxObject_obj::separateY_dyn(),true,null());
            		}
...
HXLINE( 386)				_hx_tmp1 = !(obj2immovable);
            			}
            			else {
...
HXLINE( 405)						_hx_tmp4 = Object2->active;
            					}
            					else {
HXLINE( 405)						_hx_tmp4 = false;
            					}
HXDLIN( 405)					if (_hx_tmp4) {
HXLINE( 405)						_hx_tmp3 = Object2->moves;
            					}
            					else {
HXLINE( 405)						_hx_tmp3 = false;
            					}
HXDLIN( 405)					if (_hx_tmp3) {
HXLINE( 405)						_hx_tmp2 = (obj1delta > obj2delta);
            					}
            					else {
HXLINE( 405)						_hx_tmp2 = false;
            					}
HXDLIN( 405)					if (_hx_tmp2) {
HXLINE( 407)						 ::flixel::FlxObject _g1 = Object1;
HXDLIN( 407)						_g1->set_x((_g1->x + (Object2->x - Object2->last->x)));
            					}
            				}
            				else {
HXLINE( 410)					if (!(obj2immovable)) {
HXLINE( 412)						{
HXLINE( 412)							 ::flixel::FlxObject _g2 = Object2;
HXDLIN( 412)							_g2->set_y((_g2->y + overlap));
            						}
...
HXLINE( 415)							_hx_tmp7 = Object1->active;
            						}
            						else {
HXLINE( 415)							_hx_tmp7 = false;
            						}
HXDLIN( 415)						if (_hx_tmp7) {
HXLINE( 415)							_hx_tmp6 = Object1->moves;
            						}
            						else {
HXLINE( 415)							_hx_tmp6 = false;
            						}
HXDLIN( 415)						if (_hx_tmp6) {
HXLINE( 415)							_hx_tmp5 = (obj1delta < obj2delta);
            						}
            						else {
HXLINE( 415)							_hx_tmp5 = false;
            						}
HXDLIN( 415)						if (_hx_tmp5) {
HXLINE( 417)							 ::flixel::FlxObject _g3 = Object2;
HXDLIN( 417)							_g3->set_x((_g3->x + (Object1->x - Object1->last->x)));
            						}
            					}
            				}
            			}
...
HXLINE( 443)			 ::flixel::tile::FlxBaseTilemap tilemap1 = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );
HXLINE( 444)			return tilemap1->overlapsWithCallback(Object1,::flixel::FlxObject_obj::updateTouchingFlagsY_dyn(),true,null());
            		}
