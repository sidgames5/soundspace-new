...
HXLINE( 372)			 ::Dynamic object1 = null();
HXDLIN( 372)			if (hx::IsNotNull( ObjectFactory )) {
HXLINE( 372)				object1 = ObjectFactory();
HXDLIN( 372)				this->add(object1);
            			}
            			else {
HXLINE( 372)				if (hx::IsNotNull( ObjectClass )) {
HXLINE( 372)					object1 = ::Type_obj::createInstance(ObjectClass,::cpp::VirtualArray_obj::__new(0));
HXDLIN( 372)					this->add(object1);
            				}
            			}
HXDLIN( 372)			return object1;
            		}
...
HXDLIN( 457)			return ( (int)(f(a1,a2,a3)) );
            		}
            		HX_END_LOCAL_FUNC2(return)

            		int Order = __o_Order.Default(-1);
            	HX_STACKFRAME(&_hx_pos_bfa1de30d9ec9fbd_457_sort)
HXDLIN( 457)		 ::Dynamic f = Function;
HXDLIN( 457)		int a1 = Order;
HXDLIN( 457)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(f,a1));
...
HXLINE( 478)					_hx_tmp = ::Std_obj::is(basic,ObjectClass);
            				}
            				else {
...
HXDLIN( 480)				if (Force) {
HXLINE( 480)					::String _hx_tmp3 = ::Type_obj::getClassName(::Type_obj::getClass(basic));
HXDLIN( 480)					_hx_tmp2 = (_hx_tmp3 != ::Type_obj::getClassName(ObjectClass));
            				}
            				else {
...
HXLINE( 857)				if (::Std_obj::is(basic,ObjectClass)) {
