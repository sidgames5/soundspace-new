...
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_616_transformChildren_openfl_display_BlendMode,"flixel.group.FlxTypedSpriteGroup","transformChildren_openfl_display_BlendMode",0x546b9da9,"flixel.group.FlxTypedSpriteGroup.transformChildren_openfl_display_BlendMode","flixel/group/FlxSpriteGroup.hx",616,0xeb1fa7f3)
...
void FlxTypedSpriteGroup_obj::transformChildren_openfl_display_BlendMode( ::Dynamic Function, ::Dynamic Value){
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_616_transformChildren_openfl_display_BlendMode)
HXLINE( 617)		bool _hx_tmp;
HXDLIN( 617)		if (!(this->_skipTransformChildren)) {
HXLINE( 617)			_hx_tmp = hx::IsNull( this->group );
            		}
...
HXLINE( 646)					_hx_tmp1 = sprite->exists;
            				}
            				else {
...
HXDLIN( 648)					int _g11 = numProps;
HXDLIN( 648)					while((_g2 < _g11)){
HXLINE( 648)						_g2 = (_g2 + 1);
HXDLIN( 648)						int i = (_g2 - 1);
...
HXLINE( 729)				_hx_tmp1 = (this->alpha != 0);
            			}
            			else {
...
HXLINE( 789)			this->transformChildren_openfl_display_BlendMode(this->blendTransform_dyn(),Value);
            		}
