...
HXDLIN( 113)		HX_STACK_DO_THROW(HX_("updateTile must be implemented",53,76,b0,30));
            	}
...
HXDLIN( 118)		HX_STACK_DO_THROW(HX_("cacheGraphics must be implemented",a9,10,20,38));
            	}
...
HXDLIN( 123)		HX_STACK_DO_THROW(HX_("initTileObjects must be implemented",12,b8,a6,2f));
            	}
...
HXDLIN( 128)		HX_STACK_DO_THROW(HX_("updateMap must be implemented",8f,ae,0f,b7));
            	}
...
HXDLIN( 133)		HX_STACK_DO_THROW(HX_("computeDimensions must be implemented",a0,79,f6,10));
            	}
...
HXDLIN( 138)		HX_STACK_DO_THROW(HX_("getTileIndexByCoords must be implemented",7f,57,93,9c));
HXDLIN( 138)		return 0;
            	}
...
HXDLIN( 144)		HX_STACK_DO_THROW(HX_("getTileCoordsByIndex must be implemented",35,21,39,05));
...
HXDLIN( 150)		HX_STACK_DO_THROW(HX_("ray must be implemented",e6,31,5e,58));
...
HXDLIN( 156)		HX_STACK_DO_THROW(HX_("overlapsWithCallback must be implemented",93,a3,ff,38));
...
HXDLIN( 162)		HX_STACK_DO_THROW(HX_("setDirty must be implemented",0c,cc,e0,5f));
            	}
...
HXLINE( 244)					HX_STACK_DO_THROW(((((((HX_("String in row ",b2,a4,63,43) + row) + HX_(", column ",96,fc,25,5b)) + column) + HX_(" is not a valid integer: \"",44,67,cc,45)) + columnString) + HX_("\"",22,00,00,00)));
            				}
...
HXLINE( 473)			::Array< int > _hx_tmp1 = this->_data;
HXDLIN( 473)			int Index1 = Index;
HXDLIN( 473)			_hx_tmp1[Index1] = (_hx_tmp1->__get(Index1) + 1);
            		}
HXLINE( 476)		bool _hx_tmp2;
HXDLIN( 476)		if ((hx::Mod(Index,this->widthInTiles) < (this->widthInTiles - 1))) {
HXLINE( 476)			_hx_tmp2 = (this->_data->__get((Index + 1)) > 0);
            		}
            		else {
HXLINE( 476)			_hx_tmp2 = true;
            		}
HXDLIN( 476)		if (_hx_tmp2) {
HXLINE( 478)			::Array< int > _hx_tmp3 = this->_data;
HXDLIN( 478)			int Index2 = Index;
HXDLIN( 478)			_hx_tmp3[Index2] = (_hx_tmp3->__get(Index2) + 2);
            		}
HXLINE( 481)		bool _hx_tmp4;
HXDLIN( 481)		int _hx_tmp5 = ::Std_obj::_hx_int(( (Float)((Index + this->widthInTiles)) ));
HXDLIN( 481)		if ((_hx_tmp5 < this->totalTiles)) {
HXLINE( 481)			_hx_tmp4 = (this->_data->__get((Index + this->widthInTiles)) > 0);
            		}
            		else {
HXLINE( 481)			_hx_tmp4 = true;
            		}
HXDLIN( 481)		if (_hx_tmp4) {
HXLINE( 483)			::Array< int > _hx_tmp6 = this->_data;
HXDLIN( 483)			int Index3 = Index;
HXDLIN( 483)			_hx_tmp6[Index3] = (_hx_tmp6->__get(Index3) + 4);
            		}
HXLINE( 486)		bool _hx_tmp7;
HXDLIN( 486)		if ((hx::Mod(Index,this->widthInTiles) > 0)) {
HXLINE( 486)			_hx_tmp7 = (this->_data->__get((Index - 1)) > 0);
            		}
            		else {
HXLINE( 486)			_hx_tmp7 = true;
            		}
HXDLIN( 486)		if (_hx_tmp7) {
HXLINE( 488)			::Array< int > _hx_tmp8 = this->_data;
HXDLIN( 488)			int Index4 = Index;
HXDLIN( 488)			_hx_tmp8[Index4] = (_hx_tmp8->__get(Index4) + 8);
            		}
HXLINE( 492)		bool _hx_tmp9;
HXDLIN( 492)		if (hx::IsEq( this->_hx_auto,::flixel::tile::FlxTilemapAutoTiling_obj::ALT_dyn() )) {
HXLINE( 492)			_hx_tmp9 = (this->_data->__get(Index) == 15);
            		}
            		else {
...
HXDLIN( 495)			bool _hx_tmp11;
HXDLIN( 495)			if ((hx::Mod(Index,this->widthInTiles) > 0)) {
HXLINE( 495)				int _hx_tmp12 = ::Std_obj::_hx_int(( (Float)((Index + this->widthInTiles)) ));
HXDLIN( 495)				_hx_tmp11 = (_hx_tmp12 < this->totalTiles);
            			}
            			else {
HXLINE( 495)				_hx_tmp11 = false;
            			}
HXDLIN( 495)			if (_hx_tmp11) {
HXLINE( 495)				_hx_tmp10 = (this->_data->__get(((Index + this->widthInTiles) - 1)) <= 0);
            			}
            			else {
...
HXLINE( 500)			bool _hx_tmp13;
HXDLIN( 500)			bool _hx_tmp14;
HXDLIN( 500)			if ((hx::Mod(Index,this->widthInTiles) > 0)) {
HXLINE( 500)				_hx_tmp14 = ((Index - this->widthInTiles) >= 0);
            			}
            			else {
HXLINE( 500)				_hx_tmp14 = false;
            			}
HXDLIN( 500)			if (_hx_tmp14) {
HXLINE( 500)				_hx_tmp13 = (this->_data->__get(((Index - this->widthInTiles) - 1)) <= 0);
            			}
            			else {
...
HXLINE( 505)			bool _hx_tmp15;
HXDLIN( 505)			bool _hx_tmp16;
HXDLIN( 505)			if ((hx::Mod(Index,this->widthInTiles) < (this->widthInTiles - 1))) {
HXLINE( 505)				_hx_tmp16 = ((Index - this->widthInTiles) >= 0);
            			}
            			else {
HXLINE( 505)				_hx_tmp16 = false;
            			}
HXDLIN( 505)			if (_hx_tmp16) {
HXLINE( 505)				_hx_tmp15 = (this->_data->__get(((Index - this->widthInTiles) + 1)) <= 0);
            			}
            			else {
HXLINE( 505)				_hx_tmp15 = false;
            			}
HXDLIN( 505)			if (_hx_tmp15) {
HXLINE( 507)				this->_data[Index] = 4;
            			}
HXLINE( 510)			bool _hx_tmp17;
HXDLIN( 510)			bool _hx_tmp18;
HXDLIN( 510)			if ((hx::Mod(Index,this->widthInTiles) < (this->widthInTiles - 1))) {
HXLINE( 511)				int _hx_tmp19 = ::Std_obj::_hx_int(( (Float)((Index + this->widthInTiles)) ));
HXLINE( 510)				_hx_tmp18 = (_hx_tmp19 < this->totalTiles);
            			}
            			else {
HXLINE( 510)				_hx_tmp18 = false;
            			}
HXDLIN( 510)			if (_hx_tmp18) {
HXLINE( 510)				_hx_tmp17 = (this->_data->__get(((Index + this->widthInTiles) + 1)) <= 0);
            			}
            			else {
HXLINE( 510)				_hx_tmp17 = false;
            			}
HXDLIN( 510)			if (_hx_tmp17) {
HXLINE( 514)				this->_data[Index] = 8;
            			}
            		}
HXLINE( 518)		::Array< int > _hx_tmp20 = this->_data;
HXDLIN( 518)		int Index5 = Index;
HXDLIN( 518)		_hx_tmp20[Index5] = (_hx_tmp20->__get(Index5) + 1);
            	}
...
HXLINE( 546)			_hx_tmp2 = up;
            		}
            		else {
HXLINE( 546)			_hx_tmp2 = false;
            		}
HXDLIN( 546)		if (_hx_tmp2) {
HXLINE( 546)			_hx_tmp1 = right;
            		}
            		else {
HXLINE( 546)			_hx_tmp1 = false;
            		}
HXDLIN( 546)		if (_hx_tmp1) {
HXLINE( 547)			::Array< int > _hx_tmp3 = this->_data;
HXDLIN( 547)			int Index2 = Index;
HXDLIN( 547)			_hx_tmp3[Index2] = (_hx_tmp3->__get(Index2) + 2);
            		}
HXLINE( 548)		if (right) {
HXLINE( 549)			::Array< int > _hx_tmp4 = this->_data;
HXDLIN( 549)			int Index3 = Index;
HXDLIN( 549)			_hx_tmp4[Index3] = (_hx_tmp4->__get(Index3) + 4);
            		}
HXLINE( 550)		bool _hx_tmp5;
HXDLIN( 550)		bool _hx_tmp6;
HXDLIN( 550)		if (rightDown) {
HXLINE( 550)			_hx_tmp6 = right;
            		}
            		else {
HXLINE( 550)			_hx_tmp6 = false;
            		}
HXDLIN( 550)		if (_hx_tmp6) {
HXLINE( 550)			_hx_tmp5 = down;
            		}
            		else {
HXLINE( 550)			_hx_tmp5 = false;
            		}
HXDLIN( 550)		if (_hx_tmp5) {
HXLINE( 551)			::Array< int > _hx_tmp7 = this->_data;
HXDLIN( 551)			int Index4 = Index;
HXDLIN( 551)			_hx_tmp7[Index4] = (_hx_tmp7->__get(Index4) + 8);
            		}
HXLINE( 552)		if (down) {
HXLINE( 553)			::Array< int > _hx_tmp8 = this->_data;
HXDLIN( 553)			int Index5 = Index;
HXDLIN( 553)			_hx_tmp8[Index5] = (_hx_tmp8->__get(Index5) + 16);
            		}
HXLINE( 554)		bool _hx_tmp9;
HXDLIN( 554)		bool _hx_tmp10;
HXDLIN( 554)		if (downLeft) {
HXLINE( 554)			_hx_tmp10 = down;
            		}
            		else {
HXLINE( 554)			_hx_tmp10 = false;
            		}
HXDLIN( 554)		if (_hx_tmp10) {
HXLINE( 554)			_hx_tmp9 = left;
            		}
            		else {
HXLINE( 554)			_hx_tmp9 = false;
            		}
HXDLIN( 554)		if (_hx_tmp9) {
HXLINE( 555)			::Array< int > _hx_tmp11 = this->_data;
HXDLIN( 555)			int Index6 = Index;
HXDLIN( 555)			_hx_tmp11[Index6] = (_hx_tmp11->__get(Index6) + 32);
            		}
HXLINE( 556)		if (left) {
HXLINE( 557)			::Array< int > _hx_tmp12 = this->_data;
HXDLIN( 557)			int Index7 = Index;
HXDLIN( 557)			_hx_tmp12[Index7] = (_hx_tmp12->__get(Index7) + 64);
            		}
HXLINE( 558)		bool _hx_tmp13;
HXDLIN( 558)		bool _hx_tmp14;
HXDLIN( 558)		if (leftUp) {
HXLINE( 558)			_hx_tmp14 = left;
            		}
            		else {
HXLINE( 558)			_hx_tmp14 = false;
            		}
HXDLIN( 558)		if (_hx_tmp14) {
HXLINE( 558)			_hx_tmp13 = up;
            		}
            		else {
HXLINE( 558)			_hx_tmp13 = false;
            		}
HXDLIN( 558)		if (_hx_tmp13) {
HXLINE( 559)			::Array< int > _hx_tmp15 = this->_data;
HXDLIN( 559)			int Index8 = Index;
HXDLIN( 559)			_hx_tmp15[Index8] = (_hx_tmp15->__get(Index8) + 128);
            		}
HXLINE( 561)		::Array< int > _hx_tmp16 = this->_data;
HXDLIN( 561)		int Index9 = Index;
HXDLIN( 561)		_hx_tmp16[Index9] = (_hx_tmp16->__get(Index9) - (::flixel::tile::FlxBaseTilemap_obj::offsetAutoTile->__get(this->_data->__get(Index)) - 1));
            	}
...
HXLINE( 583)			HX_STACK_DO_THROW(HX_("You must provide valid 'randomChoices' if you wish to randomize tilemap indices, please read documentation of 'setCustomTileMappings' function.",b3,ce,50,22));
            		}
            	}
...
HXLINE( 751)			HX_STACK_DO_THROW(((((((((HX_("Index ",ee,88,87,c8) + l) + HX_(" exceeds the maximum tile index of ",d9,51,06,f4)) + maxIndex) + HX_(". Please verify the Tile (",88,d4,6b,e3)) + Tile) + HX_(") and Range (",25,ce,96,19)) + Range) + HX_(") parameters.",cd,e3,29,61)));
            		}
...
HXDLIN( 986)						bool _hx_tmp3;
HXDLIN( 986)						if (wideDiagonal) {
HXLINE( 986)							_hx_tmp3 = (distances->__get(index) == -1);
            						}
            						else {
HXLINE( 986)							_hx_tmp3 = false;
            						}
HXDLIN( 986)						if (_hx_tmp3) {
HXLINE( 986)							_hx_tmp2 = (distances->__get((currentIndex - this->widthInTiles)) >= -1);
            						}
            						else {
HXLINE( 986)							_hx_tmp2 = false;
            						}
HXDLIN( 986)						if (_hx_tmp2) {
HXLINE( 986)							_hx_tmp1 = (distances->__get((currentIndex + 1)) >= -1);
            						}
            						else {
...
HXLINE( 994)							bool _hx_tmp4;
HXDLIN( 994)							if (!(wideDiagonal)) {
HXLINE( 994)								_hx_tmp4 = (distances->__get(index) == -1);
            							}
            							else {
...
HXLINE(1000)					bool _hx_tmp5;
HXDLIN(1000)					if (right) {
HXLINE(1000)						_hx_tmp5 = down;
            					}
            					else {
HXLINE(1000)						_hx_tmp5 = false;
            					}
HXDLIN(1000)					if (_hx_tmp5) {
HXLINE(1002)						index = ((currentIndex + this->widthInTiles) + 1);
HXLINE(1004)						bool _hx_tmp6;
HXDLIN(1004)						bool _hx_tmp7;
HXDLIN(1004)						bool _hx_tmp8;
HXDLIN(1004)						if (wideDiagonal) {
HXLINE(1004)							_hx_tmp8 = (distances->__get(index) == -1);
            						}
            						else {
HXLINE(1004)							_hx_tmp8 = false;
            						}
HXDLIN(1004)						if (_hx_tmp8) {
HXLINE(1004)							_hx_tmp7 = (distances->__get((currentIndex + this->widthInTiles)) >= -1);
            						}
            						else {
HXLINE(1004)							_hx_tmp7 = false;
            						}
HXDLIN(1004)						if (_hx_tmp7) {
HXLINE(1004)							_hx_tmp6 = (distances->__get((currentIndex + 1)) >= -1);
            						}
            						else {
HXLINE(1004)							_hx_tmp6 = false;
            						}
HXDLIN(1004)						if (_hx_tmp6) {
HXLINE(1009)							distances[index] = distance;
HXLINE(1010)							neighbors->push(index);
            						}
            						else {
HXLINE(1012)							bool _hx_tmp9;
HXDLIN(1012)							if (!(wideDiagonal)) {
HXLINE(1012)								_hx_tmp9 = (distances->__get(index) == -1);
            							}
            							else {
HXLINE(1012)								_hx_tmp9 = false;
            							}
...
HXLINE(1018)					bool _hx_tmp10;
HXDLIN(1018)					if (left) {
HXLINE(1018)						_hx_tmp10 = down;
            					}
            					else {
HXLINE(1018)						_hx_tmp10 = false;
            					}
HXDLIN(1018)					if (_hx_tmp10) {
HXLINE(1020)						index = ((currentIndex + this->widthInTiles) - 1);
HXLINE(1022)						bool _hx_tmp11;
HXDLIN(1022)						bool _hx_tmp12;
HXDLIN(1022)						bool _hx_tmp13;
HXDLIN(1022)						if (wideDiagonal) {
HXLINE(1022)							_hx_tmp13 = (distances->__get(index) == -1);
            						}
            						else {
HXLINE(1022)							_hx_tmp13 = false;
            						}
HXDLIN(1022)						if (_hx_tmp13) {
HXLINE(1022)							_hx_tmp12 = (distances->__get((currentIndex + this->widthInTiles)) >= -1);
            						}
            						else {
HXLINE(1022)							_hx_tmp12 = false;
            						}
HXDLIN(1022)						if (_hx_tmp12) {
HXLINE(1022)							_hx_tmp11 = (distances->__get((currentIndex - 1)) >= -1);
            						}
            						else {
HXLINE(1022)							_hx_tmp11 = false;
            						}
HXDLIN(1022)						if (_hx_tmp11) {
HXLINE(1027)							distances[index] = distance;
HXLINE(1028)							neighbors->push(index);
            						}
            						else {
HXLINE(1030)							bool _hx_tmp14;
HXDLIN(1030)							if (!(wideDiagonal)) {
HXLINE(1030)								_hx_tmp14 = (distances->__get(index) == -1);
            							}
            							else {
HXLINE(1030)								_hx_tmp14 = false;
            							}
HXDLIN(1030)							if (_hx_tmp14) {
HXLINE(1032)								distances[index] = distance;
HXLINE(1033)								neighbors->push(index);
            							}
            						}
            					}
HXLINE(1036)					bool _hx_tmp15;
HXDLIN(1036)					if (up) {
HXLINE(1036)						_hx_tmp15 = left;
            					}
            					else {
HXLINE(1036)						_hx_tmp15 = false;
            					}
HXDLIN(1036)					if (_hx_tmp15) {
HXLINE(1038)						index = ((currentIndex - this->widthInTiles) - 1);
HXLINE(1040)						bool _hx_tmp16;
HXDLIN(1040)						bool _hx_tmp17;
HXDLIN(1040)						bool _hx_tmp18;
HXDLIN(1040)						if (wideDiagonal) {
HXLINE(1040)							_hx_tmp18 = (distances->__get(index) == -1);
            						}
            						else {
HXLINE(1040)							_hx_tmp18 = false;
            						}
HXDLIN(1040)						if (_hx_tmp18) {
HXLINE(1040)							_hx_tmp17 = (distances->__get((currentIndex - this->widthInTiles)) >= -1);
            						}
            						else {
HXLINE(1040)							_hx_tmp17 = false;
            						}
HXDLIN(1040)						if (_hx_tmp17) {
HXLINE(1040)							_hx_tmp16 = (distances->__get((currentIndex - 1)) >= -1);
            						}
            						else {
HXLINE(1040)							_hx_tmp16 = false;
            						}
HXDLIN(1040)						if (_hx_tmp16) {
HXLINE(1045)							distances[index] = distance;
HXLINE(1046)							neighbors->push(index);
            						}
            						else {
HXLINE(1048)							bool _hx_tmp19;
HXDLIN(1048)							if (!(wideDiagonal)) {
HXLINE(1048)								_hx_tmp19 = (distances->__get(index) == -1);
            							}
            							else {
HXLINE(1048)								_hx_tmp19 = false;
            							}
HXDLIN(1048)							if (_hx_tmp19) {
...
HXDLIN(1105)			bool _hx_tmp3;
HXDLIN(1105)			if ((i >= 0)) {
HXLINE(1105)				_hx_tmp3 = (Data->__get(i) >= 0);
            			}
            			else {
HXLINE(1105)				_hx_tmp3 = false;
            			}
HXDLIN(1105)			if (_hx_tmp3) {
HXLINE(1105)				_hx_tmp2 = (Data->__get(i) < current);
            			}
            			else {
HXLINE(1105)				_hx_tmp2 = false;
            			}
...
HXLINE(1114)			bool _hx_tmp4;
HXDLIN(1114)			bool _hx_tmp5;
HXDLIN(1114)			if ((i >= 0)) {
HXLINE(1114)				_hx_tmp5 = (Data->__get(i) >= 0);
            			}
            			else {
HXLINE(1114)				_hx_tmp5 = false;
            			}
HXDLIN(1114)			if (_hx_tmp5) {
HXLINE(1114)				_hx_tmp4 = (Data->__get(i) < current);
            			}
            			else {
HXLINE(1114)				_hx_tmp4 = false;
            			}
HXDLIN(1114)			if (_hx_tmp4) {
...
HXLINE(1123)			bool _hx_tmp6;
HXDLIN(1123)			bool _hx_tmp7;
HXDLIN(1123)			if ((i >= 0)) {
HXLINE(1123)				_hx_tmp7 = (Data->__get(i) >= 0);
            			}
            			else {
HXLINE(1123)				_hx_tmp7 = false;
            			}
HXDLIN(1123)			if (_hx_tmp7) {
HXLINE(1123)				_hx_tmp6 = (Data->__get(i) < current);
            			}
            			else {
HXLINE(1123)				_hx_tmp6 = false;
            			}
...
HXLINE(1128)		bool _hx_tmp8;
HXDLIN(1128)		if (up) {
HXLINE(1128)			_hx_tmp8 = right;
            		}
            		else {
HXLINE(1128)			_hx_tmp8 = false;
            		}
HXDLIN(1128)		if (_hx_tmp8) {
HXLINE(1130)			i = ((Start - this->widthInTiles) + 1);
HXLINE(1132)			bool _hx_tmp9;
HXDLIN(1132)			bool _hx_tmp10;
HXDLIN(1132)			if ((i >= 0)) {
HXLINE(1132)				_hx_tmp10 = (Data->__get(i) >= 0);
            			}
            			else {
HXLINE(1132)				_hx_tmp10 = false;
            			}
HXDLIN(1132)			if (_hx_tmp10) {
HXLINE(1132)				_hx_tmp9 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1137)		bool _hx_tmp11;
HXDLIN(1137)		if (right) {
HXLINE(1137)			_hx_tmp11 = down;
            		}
            		else {
HXLINE(1137)			_hx_tmp11 = false;
            		}
HXDLIN(1137)		if (_hx_tmp11) {
HXLINE(1139)			i = ((Start + this->widthInTiles) + 1);
HXLINE(1141)			bool _hx_tmp12;
HXDLIN(1141)			bool _hx_tmp13;
HXDLIN(1141)			if ((i >= 0)) {
HXLINE(1141)				_hx_tmp13 = (Data->__get(i) >= 0);
            			}
            			else {
HXLINE(1141)				_hx_tmp13 = false;
            			}
HXDLIN(1141)			if (_hx_tmp13) {
HXLINE(1141)				_hx_tmp12 = (Data->__get(i) < current);
            			}
            			else {
HXLINE(1141)				_hx_tmp12 = false;
            			}
HXDLIN(1141)			if (_hx_tmp12) {
HXLINE(1143)				this->walkPath(Data,i,Points);
HXDLIN(1143)				return;
            			}
            		}
HXLINE(1146)		bool _hx_tmp14;
HXDLIN(1146)		if (left) {
HXLINE(1146)			_hx_tmp14 = down;
            		}
            		else {
HXLINE(1146)			_hx_tmp14 = false;
            		}
HXDLIN(1146)		if (_hx_tmp14) {
HXLINE(1148)			i = ((Start + this->widthInTiles) - 1);
HXLINE(1150)			bool _hx_tmp15;
HXDLIN(1150)			bool _hx_tmp16;
HXDLIN(1150)			if ((i >= 0)) {
HXLINE(1150)				_hx_tmp16 = (Data->__get(i) >= 0);
            			}
            			else {
HXLINE(1150)				_hx_tmp16 = false;
            			}
HXDLIN(1150)			if (_hx_tmp16) {
HXLINE(1150)				_hx_tmp15 = (Data->__get(i) < current);
            			}
            			else {
HXLINE(1150)				_hx_tmp15 = false;
            			}
HXDLIN(1150)			if (_hx_tmp15) {
HXLINE(1152)				this->walkPath(Data,i,Points);
HXDLIN(1152)				return;
            			}
            		}
HXLINE(1155)		bool _hx_tmp17;
HXDLIN(1155)		if (up) {
HXLINE(1155)			_hx_tmp17 = left;
            		}
            		else {
HXLINE(1155)			_hx_tmp17 = false;
            		}
HXDLIN(1155)		if (_hx_tmp17) {
HXLINE(1157)			i = ((Start - this->widthInTiles) - 1);
HXLINE(1159)			bool _hx_tmp18;
HXDLIN(1159)			bool _hx_tmp19;
HXDLIN(1159)			if ((i >= 0)) {
HXLINE(1159)				_hx_tmp19 = (Data->__get(i) >= 0);
            			}
            			else {
HXLINE(1159)				_hx_tmp19 = false;
            			}
HXDLIN(1159)			if (_hx_tmp19) {
HXLINE(1159)				_hx_tmp18 = (Data->__get(i) < current);
            			}
            			else {
HXLINE(1159)				_hx_tmp18 = false;
            			}
HXDLIN(1159)			if (_hx_tmp18) {
...
HXLINE(1257)			 ::flixel::FlxCamera Camera1 = null();
...
HXLINE(1257)				_hx_tmp = this->overlaps(ObjectOrGroup,false,Camera1);
            			}
