...
HX_LOCAL_STACK_FRAME(_hx_pos_cfd221447aa7194b_1048_getRotatedBounds,"flixel.FlxSprite","getRotatedBounds",0x9196bfb1,"flixel.FlxSprite.getRotatedBounds","flixel/FlxSprite.hx",1048,0x0384bffa)
...
HX_LOCAL_STACK_FRAME(_hx_pos_cfd221447aa7194b_1096_setFacingFlip,"flixel.FlxSprite","setFacingFlip",0x6816c060,"flixel.FlxSprite.setFacingFlip","flixel/FlxSprite.hx",1096,0x0384bffa)
HX_LOCAL_STACK_FRAME(_hx_pos_cfd221447aa7194b_1108_setFrames,"flixel.FlxSprite","setFrames",0xd774ec9f,"flixel.FlxSprite.setFrames","flixel/FlxSprite.hx",1108,0x0384bffa)
...
HX_LOCAL_STACK_FRAME(_hx_pos_cfd221447aa7194b_1205_set_facing,"flixel.FlxSprite","set_facing",0xeb9145c0,"flixel.FlxSprite.set_facing","flixel/FlxSprite.hx",1205,0x0384bffa)
...
HX_LOCAL_STACK_FRAME(_hx_pos_cfd221447aa7194b_1256_updateTrig,"flixel.FlxSprite","updateTrig",0x193f7fee,"flixel.FlxSprite.updateTrig","flixel/FlxSprite.hx",1256,0x0384bffa)
...
HX_LOCAL_STACK_FRAME(_hx_pos_cfd221447aa7194b_1398_checkFlipX,"flixel.FlxSprite","checkFlipX",0x26093f8c,"flixel.FlxSprite.checkFlipX","flixel/FlxSprite.hx",1398,0x0384bffa)
HX_LOCAL_STACK_FRAME(_hx_pos_cfd221447aa7194b_1409_checkFlipY,"flixel.FlxSprite","checkFlipY",0x26093f8d,"flixel.FlxSprite.checkFlipY","flixel/FlxSprite.hx",1409,0x0384bffa)
namespace flixel{
...
HXDLIN( 674)				_g = (_g + 1);
HXLINE( 676)				bool _hx_tmp1;
HXDLIN( 676)				bool _hx_tmp2;
HXDLIN( 676)				if (!(!(camera->visible))) {
HXLINE( 676)					_hx_tmp2 = !(camera->exists);
            				}
            				else {
HXLINE( 676)					_hx_tmp2 = true;
            				}
HXDLIN( 676)				if (!(_hx_tmp2)) {
HXLINE( 676)					_hx_tmp1 = !(this->isOnScreen(camera));
            				}
            				else {
...
HXLINE( 703)		{
HXLINE( 703)			 ::flixel::math::FlxPoint _this1 = this->_point;
...
HXDLIN( 703)			FlashPoint->x = _this1->x;
HXDLIN( 703)			FlashPoint->y = _this1->y;
            		}
...
HXLINE( 722)		{
HXLINE( 722)			 ::flixel::math::FlxPoint _this1 = this->_point;
HXDLIN( 722)			Float Y = this->origin->y;
HXDLIN( 722)			{
HXLINE( 722)				 ::flixel::math::FlxPoint _g = _this1;
HXDLIN( 722)				_g->set_x((_g->x + this->origin->x));
            			}
HXDLIN( 722)			{
HXLINE( 722)				 ::flixel::math::FlxPoint _g1 = _this1;
...
HXLINE( 747)			HX_STACK_DO_THROW(HX_("Cannot stamp to or from a FlxSprite with no graphics.",72,0b,d4,aa));
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxSprite_obj,isSimpleRenderBlit,return )
 ...
 ::flixel::math::FlxRect FlxSprite_obj::getRotatedBounds( ::flixel::math::FlxRect newRect){
            	HX_STACKFRAME(&_hx_pos_cfd221447aa7194b_1048_getRotatedBounds)
HXLINE(1049)		if (hx::IsNull( newRect )) {
HXLINE(1050)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN(1050)			_this->x = ( (Float)(0) );
HXDLIN(1050)			_this->y = ( (Float)(0) );
HXDLIN(1050)			_this->width = ( (Float)(0) );
HXDLIN(1050)			_this->height = ( (Float)(0) );
HXDLIN(1050)			 ::flixel::math::FlxRect rect = _this;
HXDLIN(1050)			rect->_inPool = false;
HXDLIN(1050)			newRect = rect;
            		}
HXLINE(1052)		{
HXLINE(1052)			Float X = this->x;
HXDLIN(1052)			Float Y = this->y;
HXDLIN(1052)			Float Width = this->get_width();
HXDLIN(1052)			Float Height = this->get_height();
HXDLIN(1052)			newRect->x = X;
HXDLIN(1052)			newRect->y = Y;
HXDLIN(1052)			newRect->width = Width;
HXDLIN(1052)			newRect->height = Height;
            		}
HXLINE(1053)		return newRect->getRotatedBounds(this->angle,this->origin,newRect);
            	}
...
void FlxSprite_obj::setFacingFlip(int Direction,bool FlipX,bool FlipY){
            	HX_STACKFRAME(&_hx_pos_cfd221447aa7194b_1096_setFacingFlip)
HXDLIN(1096)		this->_facingFlip->set(Direction, ::Dynamic(hx::Anon_obj::Create(2)
...
HX_DEFINE_DYNAMIC_FUNC3(FlxSprite_obj,setFacingFlip,(void))
 ...
 ::flixel::FlxSprite FlxSprite_obj::setFrames( ::flixel::graphics::frames::FlxFramesCollection Frames,hx::Null< bool >  __o_saveAnimations){
            	...
            	HX_STACKFRAME(&_hx_pos_cfd221447aa7194b_1108_setFrames)
HXLINE(1109)		if (saveAnimations) {
HXLINE(1111)			 ::haxe::ds::StringMap animations = this->animation->_animations;
HXLINE(1112)			bool reverse = false;
HXLINE(1113)			int index = 0;
HXLINE(1114)			int frameIndex = this->animation->frameIndex;
HXLINE(1115)			::String currName = null();
HXLINE(1117)			if (hx::IsNotNull( this->animation->_curAnim )) {
HXLINE(1119)				reverse = this->animation->_curAnim->reversed;
HXLINE(1120)				index = this->animation->_curAnim->curFrame;
HXLINE(1121)				currName = this->animation->_curAnim->name;
            			}
HXLINE(1124)			this->animation->_animations = null();
HXLINE(1125)			this->set_frames(Frames);
HXLINE(1126)			this->set_frame(this->frames->frames->__get(frameIndex).StaticCast<  ::flixel::graphics::frames::FlxFrame >());
HXLINE(1127)			this->animation->_animations = animations;
HXLINE(1129)			if (hx::IsNotNull( currName )) {
HXLINE(1131)				this->animation->play(currName,false,reverse,index);
            			}
            		}
            		else {
HXLINE(1136)			this->set_frames(Frames);
            		}
HXLINE(1139)		return hx::ObjectPtr<OBJ_>(this);
            	}
...
int FlxSprite_obj::set_facing(int Direction){
            	HX_STACKFRAME(&_hx_pos_cfd221447aa7194b_1205_set_facing)
HXLINE(1206)		 ::Dynamic flip = this->_facingFlip->get(Direction);
HXLINE(1207)		if (hx::IsNotNull( flip )) {
HXLINE(1209)			this->set_flipX(( (bool)(flip->__Field(HX_("x",78,00,00,00),hx::paccDynamic)) ));
HXLINE(1210)			this->set_flipY(( (bool)(flip->__Field(HX_("y",79,00,00,00),hx::paccDynamic)) ));
            		}
HXLINE(1213)		return (this->facing = Direction);
            	}
...
void FlxSprite_obj::updateTrig(){
            	HX_STACKFRAME(&_hx_pos_cfd221447aa7194b_1256_updateTrig)
HXDLIN(1256)		if (this->_angleChanged) {
HXLINE(1258)			Float radians = (this->angle * (::Math_obj::PI / ( (Float)(180) )));
HXLINE(1259)			this->_sinAngle = ::Math_obj::sin(radians);
HXLINE(1260)			this->_cosAngle = ::Math_obj::cos(radians);
HXLINE(1261)			this->_angleChanged = false;
            		}
            	}
...
HXLINE(1287)			 ::flixel::graphics::FlxGraphic _g1 = oldGraphic;
HXDLIN(1287)			_g1->set_useCount((_g1->get_useCount() - 1));
            		}
...
HXLINE(1350)			_hx_tmp1 = this->dirty;
            		}
            		else {
HXLINE(1350)			_hx_tmp1 = true;
            		}
HXDLIN(1350)		this->dirty = _hx_tmp1;
...
HXLINE(1361)		bool _hx_tmp1;
HXDLIN(1361)		if ((this->flipY == Value)) {
HXLINE(1361)			_hx_tmp1 = this->dirty;
            		}
            		else {
HXLINE(1361)			_hx_tmp1 = true;
            		}
HXDLIN(1361)		this->dirty = _hx_tmp1;
...
bool FlxSprite_obj::checkFlipX(){
            	HX_STACKFRAME(&_hx_pos_cfd221447aa7194b_1398_checkFlipX)
HXLINE(1399)		bool doFlipX = (this->flipX != this->_frame->flipX);
HXLINE(1400)		if (hx::IsNotNull( this->animation->_curAnim )) {
HXLINE(1402)			return (doFlipX != this->animation->_curAnim->flipX);
            		}
HXLINE(1404)		return doFlipX;
            	}
...
bool FlxSprite_obj::checkFlipY(){
            	HX_STACKFRAME(&_hx_pos_cfd221447aa7194b_1409_checkFlipY)
HXLINE(1410)		bool doFlipY = (this->flipY != this->_frame->flipY);
HXLINE(1411)		if (hx::IsNotNull( this->animation->_curAnim )) {
HXLINE(1413)			return (doFlipY != this->animation->_curAnim->flipY);
            		}
HXLINE(1415)		return doFlipY;
            	}
