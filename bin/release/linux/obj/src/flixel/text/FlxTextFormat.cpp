...
HX_LOCAL_STACK_FRAME(_hx_pos_a69907c6a733237a_1102_set_leading,"flixel.text.FlxTextFormat","set_leading",0x68682d02,"flixel.text.FlxTextFormat.set_leading","flixel/text/FlxText.hx",1102,0xdf165a6e)
namespace flixel{
namespace text{
...
int FlxTextFormat_obj::set_leading(int value){
            	HX_STACKFRAME(&_hx_pos_a69907c6a733237a_1102_set_leading)
HXLINE(1103)		this->format->leading = value;
HXLINE(1104)		return value;
            	}
