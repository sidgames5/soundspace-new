...
HXLINE( 294)					_hx_tmp1 = hx::IsNull( rule->format );
            				}
            				else {
...
HXDLIN( 304)					int _g11 = ::_UnicodeString::UnicodeString_Impl__obj::get_length(input);
HXDLIN( 304)					while((_g1 < _g11)){
...
HXDLIN( 332)			while((_g12 < rules->length)){
HXLINE( 332)				 ::flixel::text::FlxTextFormatMarkerPair rule1 = rules->__get(_g12).StaticCast<  ::flixel::text::FlxTextFormatMarkerPair >();
HXDLIN( 332)				_g12 = (_g12 + 1);
HXLINE( 333)				input = ::StringTools_obj::replace(input,rule1->marker,HX_("",00,00,00,00));
            			}
            		}
HXLINE( 336)		{
...
HXDLIN( 336)				int i1 = (_g2 - 1);
HXLINE( 339)				int delIndex = rangeStarts->__get(i1);
HXLINE( 340)				int markerLength1 = ::_UnicodeString::UnicodeString_Impl__obj::get_length(rulesToApply->__get(i1).StaticCast<  ::flixel::text::FlxTextFormatMarkerPair >()->marker);
HXLINE( 343)				{
HXLINE( 343)					int _g21 = 0;
HXDLIN( 343)					int _g31 = rangeStarts->length;
HXDLIN( 343)					while((_g21 < _g31)){
HXLINE( 343)						_g21 = (_g21 + 1);
HXDLIN( 343)						int j = (_g21 - 1);
HXLINE( 345)						if ((rangeStarts->__get(j) > delIndex)) {
HXLINE( 347)							::Array< int > rangeStarts1 = rangeStarts;
HXDLIN( 347)							int j1 = j;
HXDLIN( 347)							rangeStarts1[j1] = (rangeStarts1->__get(j1) - markerLength1);
            						}
HXLINE( 349)						if ((rangeEnds->__get(j) > delIndex)) {
HXLINE( 351)							::Array< int > rangeEnds1 = rangeEnds;
HXDLIN( 351)							int j2 = j;
HXDLIN( 351)							rangeEnds1[j2] = (rangeEnds1->__get(j2) - markerLength1);
            						}
            					}
            				}
HXLINE( 356)				delIndex = rangeEnds->__get(i1);
HXLINE( 359)				{
HXLINE( 359)					int _g4 = 0;
HXDLIN( 359)					int _g5 = rangeStarts->length;
HXDLIN( 359)					while((_g4 < _g5)){
HXLINE( 359)						_g4 = (_g4 + 1);
HXDLIN( 359)						int j3 = (_g4 - 1);
HXLINE( 361)						if ((rangeStarts->__get(j3) > delIndex)) {
HXLINE( 363)							::Array< int > rangeStarts2 = rangeStarts;
HXDLIN( 363)							int j4 = j3;
HXDLIN( 363)							rangeStarts2[j4] = (rangeStarts2->__get(j4) - markerLength1);
            						}
HXLINE( 365)						if ((rangeEnds->__get(j3) > delIndex)) {
HXLINE( 367)							::Array< int > rangeEnds2 = rangeEnds;
HXDLIN( 367)							int j5 = j3;
HXDLIN( 367)							rangeEnds2[j5] = (rangeEnds2->__get(j5) - markerLength1);
            						}
            					}
            				}
            			}
...
HXLINE( 376)		{
HXLINE( 376)			int _g41 = 0;
HXDLIN( 376)			int _g51 = rangeStarts->length;
HXDLIN( 376)			while((_g41 < _g51)){
HXLINE( 376)				_g41 = (_g41 + 1);
HXDLIN( 376)				int i2 = (_g41 - 1);
HXLINE( 377)				this->addFormat(rulesToApply->__get(i2).StaticCast<  ::flixel::text::FlxTextFormatMarkerPair >()->format,rangeStarts->__get(i2),rangeEnds->__get(i2));
            			}
            		}
...
HXLINE( 418)					_hx_tmp1 = hx::IsLessEq( End,range->start );
            				}
            				else {
...
HXLINE( 421)					_hx_tmp2 = hx::IsLess( End,range->end );
            				}
            				else {
...
HXLINE( 428)					_hx_tmp3 = hx::IsLess( End,range->end );
            				}
            				else {
...
HXLINE( 434)					_hx_tmp4 = hx::IsGreaterEq( End,range->end );
            				}
            				else {
...
HXLINE( 475)			BorderStyle = BorderStyle;
            		}
...
HXLINE( 803)			int _hx_tmp2 = ::Std_obj::_hx_int(newWidth);
HXDLIN( 803)			this->makeGraphic(_hx_tmp2,::Std_obj::_hx_int(newHeight),0,false,key);
...
HXLINE( 808)			 ::openfl::text::TextField _hx_tmp3 = this->textField;
HXDLIN( 808)			_hx_tmp3->set_height((this->get_height() * ((Float)1.2)));
...
HXDLIN( 826)		bool _hx_tmp5;
HXDLIN( 826)		if (hx::IsNotNull( this->textField )) {
HXLINE( 826)			_hx_tmp5 = hx::IsNotNull( this->textField->get_text() );
            		}
            		else {
HXLINE( 826)			_hx_tmp5 = false;
            		}
HXDLIN( 826)		if (_hx_tmp5) {
HXLINE( 826)			_hx_tmp4 = (this->textField->get_text().length > 0);
            		}
            		else {
...
HXDLIN( 949)					int _g11 = iterations;
HXDLIN( 949)					while((_g2 < _g11)){
HXLINE( 949)						_g2 = (_g2 + 1);
HXDLIN( 949)						int i1 = (_g2 - 1);
HXLINE( 951)						{
HXLINE( 951)							 ::openfl::display::BitmapData graphic1;
HXDLIN( 951)							if (this->_hasBorderAlpha) {
HXLINE( 951)								graphic1 = this->_borderPixels;
            							}
            							else {
HXLINE( 951)								graphic1 = this->graphic->bitmap;
            							}
HXDLIN( 951)							this->_matrix->translate(-(curDelta),-(curDelta));
HXDLIN( 951)							this->drawTextFieldTo(graphic1);
            						}
HXLINE( 952)						{
HXLINE( 952)							 ::openfl::display::BitmapData graphic2;
HXDLIN( 952)							if (this->_hasBorderAlpha) {
HXLINE( 952)								graphic2 = this->_borderPixels;
            							}
            							else {
HXLINE( 952)								graphic2 = this->graphic->bitmap;
            							}
HXDLIN( 952)							this->_matrix->translate(curDelta,( (Float)(0) ));
HXDLIN( 952)							this->drawTextFieldTo(graphic2);
            						}
HXLINE( 953)						{
HXLINE( 953)							 ::openfl::display::BitmapData graphic3;
HXDLIN( 953)							if (this->_hasBorderAlpha) {
HXLINE( 953)								graphic3 = this->_borderPixels;
            							}
            							else {
HXLINE( 953)								graphic3 = this->graphic->bitmap;
            							}
HXDLIN( 953)							this->_matrix->translate(curDelta,( (Float)(0) ));
HXDLIN( 953)							this->drawTextFieldTo(graphic3);
            						}
HXLINE( 954)						{
HXLINE( 954)							 ::openfl::display::BitmapData graphic4;
HXDLIN( 954)							if (this->_hasBorderAlpha) {
HXLINE( 954)								graphic4 = this->_borderPixels;
            							}
            							else {
HXLINE( 954)								graphic4 = this->graphic->bitmap;
            							}
HXDLIN( 954)							this->_matrix->translate(( (Float)(0) ),curDelta);
HXDLIN( 954)							this->drawTextFieldTo(graphic4);
            						}
HXLINE( 955)						{
HXLINE( 955)							 ::openfl::display::BitmapData graphic5;
HXDLIN( 955)							if (this->_hasBorderAlpha) {
HXLINE( 955)								graphic5 = this->_borderPixels;
            							}
            							else {
HXLINE( 955)								graphic5 = this->graphic->bitmap;
            							}
HXDLIN( 955)							this->_matrix->translate(( (Float)(0) ),curDelta);
HXDLIN( 955)							this->drawTextFieldTo(graphic5);
            						}
HXLINE( 956)						{
HXLINE( 956)							 ::openfl::display::BitmapData graphic6;
HXDLIN( 956)							if (this->_hasBorderAlpha) {
HXLINE( 956)								graphic6 = this->_borderPixels;
            							}
            							else {
HXLINE( 956)								graphic6 = this->graphic->bitmap;
            							}
HXDLIN( 956)							this->_matrix->translate(-(curDelta),( (Float)(0) ));
HXDLIN( 956)							this->drawTextFieldTo(graphic6);
            						}
HXLINE( 957)						{
HXLINE( 957)							 ::openfl::display::BitmapData graphic7;
HXDLIN( 957)							if (this->_hasBorderAlpha) {
HXLINE( 957)								graphic7 = this->_borderPixels;
            							}
            							else {
HXLINE( 957)								graphic7 = this->graphic->bitmap;
            							}
HXDLIN( 957)							this->_matrix->translate(-(curDelta),( (Float)(0) ));
HXDLIN( 957)							this->drawTextFieldTo(graphic7);
            						}
HXLINE( 958)						{
HXLINE( 958)							 ::openfl::display::BitmapData graphic8;
HXDLIN( 958)							if (this->_hasBorderAlpha) {
HXLINE( 958)								graphic8 = this->_borderPixels;
            							}
            							else {
HXLINE( 958)								graphic8 = this->graphic->bitmap;
            							}
HXDLIN( 958)							this->_matrix->translate(( (Float)(0) ),-(curDelta));
HXDLIN( 958)							this->drawTextFieldTo(graphic8);
            						}
...
HXLINE( 970)				Float curDelta1 = delta;
HXLINE( 971)				{
HXLINE( 971)					int _g3 = 0;
HXDLIN( 971)					int _g12 = iterations;
HXDLIN( 971)					while((_g3 < _g12)){
HXLINE( 971)						_g3 = (_g3 + 1);
HXDLIN( 971)						int i2 = (_g3 - 1);
HXLINE( 973)						{
HXLINE( 973)							 ::openfl::display::BitmapData graphic9;
HXDLIN( 973)							if (this->_hasBorderAlpha) {
HXLINE( 973)								graphic9 = this->_borderPixels;
            							}
            							else {
HXLINE( 973)								graphic9 = this->graphic->bitmap;
            							}
HXDLIN( 973)							this->_matrix->translate(-(curDelta1),-(curDelta1));
HXDLIN( 973)							this->drawTextFieldTo(graphic9);
            						}
HXLINE( 974)						{
HXLINE( 974)							 ::openfl::display::BitmapData graphic10;
HXDLIN( 974)							if (this->_hasBorderAlpha) {
HXLINE( 974)								graphic10 = this->_borderPixels;
            							}
            							else {
HXLINE( 974)								graphic10 = this->graphic->bitmap;
            							}
HXDLIN( 974)							this->_matrix->translate((curDelta1 * ( (Float)(2) )),( (Float)(0) ));
HXDLIN( 974)							this->drawTextFieldTo(graphic10);
            						}
HXLINE( 975)						{
HXLINE( 975)							 ::openfl::display::BitmapData graphic11;
HXDLIN( 975)							if (this->_hasBorderAlpha) {
HXLINE( 975)								graphic11 = this->_borderPixels;
            							}
            							else {
HXLINE( 975)								graphic11 = this->graphic->bitmap;
            							}
HXDLIN( 975)							this->_matrix->translate(( (Float)(0) ),(curDelta1 * ( (Float)(2) )));
HXDLIN( 975)							this->drawTextFieldTo(graphic11);
            						}
HXLINE( 976)						{
HXLINE( 976)							 ::openfl::display::BitmapData graphic12;
HXDLIN( 976)							if (this->_hasBorderAlpha) {
HXLINE( 976)								graphic12 = this->_borderPixels;
            							}
            							else {
HXLINE( 976)								graphic12 = this->graphic->bitmap;
            							}
HXDLIN( 976)							this->_matrix->translate((-(curDelta1) * ( (Float)(2) )),( (Float)(0) ));
HXDLIN( 976)							this->drawTextFieldTo(graphic12);
            						}
HXLINE( 978)						this->_matrix->translate(curDelta1,-(curDelta1));
HXLINE( 979)						curDelta1 = (curDelta1 + delta);
            					}
            				}
            			}
            			break;
...
HXDLIN(1017)				_g = (_g + 1);
HXLINE(1019)				int _hx_tmp1 = (this->textField->get_text().length - 1);
HXDLIN(1019)				if (hx::IsLess( _hx_tmp1,formatRange->range->start )) {
...
HXLINE(1028)					 ::Dynamic _hx_tmp2;
HXDLIN(1028)					if (UseBorderColor) {
HXLINE(1028)						_hx_tmp2 = (formatRange->format->borderColor & 16777215);
            					}
            					else {
HXLINE(1028)						_hx_tmp2 = textFormat->color;
            					}
HXDLIN(1028)					FormatAdjusted->color = _hx_tmp2;
            				}
HXLINE(1031)				 ::openfl::text::TextField _hx_tmp3 = this->textField;
HXDLIN(1031)				int formatRange1 = ( (int)(formatRange->range->start) );
HXDLIN(1031)				int formatRange2 = ( (int)(formatRange->range->end) );
HXDLIN(1031)				_hx_tmp3->setTextFormat(FormatAdjusted,formatRange1,::Std_obj::_hx_int(::Math_obj::min(( (Float)(formatRange2) ),( (Float)(this->textField->get_text().length) ))));
            			}
            			_hx_goto_59:;
            		}
            	}
