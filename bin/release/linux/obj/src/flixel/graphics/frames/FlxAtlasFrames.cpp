...
HXLINE(  70)		if (::Std_obj::is( ::Dynamic(data->__Field(HX_("frames",a6,af,85,ac),hx::paccDynamic)),hx::ArrayBase::__mClass)) {
HXLINE(  72)			int _g = 0;
...
HXLINE(  80)			int _g2 = 0;
HXDLIN(  80)			::Array< ::String > _g11 = ::Reflect_obj::fields( ::Dynamic(data->__Field(HX_("frames",a6,af,85,ac),hx::paccDynamic)));
HXDLIN(  80)			while((_g2 < _g11->length)){
HXLINE(  80)				::String frameName = _g11->__get(_g2);
HXDLIN(  80)				_g2 = (_g2 + 1);
...
HXLINE( 107)			Float X2 = ( (Float)( ::Dynamic(FrameData->__Field(HX_("frame",2d,78,83,06),hx::paccDynamic))->__Field(HX_("x",78,00,00,00),hx::paccDynamic)) );
HXDLIN( 107)			Float Y2 = ( (Float)( ::Dynamic(FrameData->__Field(HX_("frame",2d,78,83,06),hx::paccDynamic))->__Field(HX_("y",79,00,00,00),hx::paccDynamic)) );
...
HXDLIN( 107)			_this->x = X2;
HXDLIN( 107)			_this->y = Y2;
...
HXLINE( 112)			Float X3 = ( (Float)( ::Dynamic(FrameData->__Field(HX_("frame",2d,78,83,06),hx::paccDynamic))->__Field(HX_("x",78,00,00,00),hx::paccDynamic)) );
HXDLIN( 112)			Float Y3 = ( (Float)( ::Dynamic(FrameData->__Field(HX_("frame",2d,78,83,06),hx::paccDynamic))->__Field(HX_("y",79,00,00,00),hx::paccDynamic)) );
HXDLIN( 112)			Float Width1 = ( (Float)( ::Dynamic(FrameData->__Field(HX_("frame",2d,78,83,06),hx::paccDynamic))->__Field(HX_("w",77,00,00,00),hx::paccDynamic)) );
HXDLIN( 112)			Float Height1 = ( (Float)( ::Dynamic(FrameData->__Field(HX_("frame",2d,78,83,06),hx::paccDynamic))->__Field(HX_("h",68,00,00,00),hx::paccDynamic)) );
HXDLIN( 112)			 ::flixel::math::FlxRect _this1 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 112)			_this1->x = X3;
HXDLIN( 112)			_this1->y = Y3;
HXDLIN( 112)			_this1->width = Width1;
HXDLIN( 112)			_this1->height = Height1;
HXDLIN( 112)			 ::flixel::math::FlxRect rect1 = _this1;
HXDLIN( 112)			rect1->_inPool = false;
HXDLIN( 112)			frameRect = rect1;
            		}
...
HXLINE( 246)			HX_STACK_DO_THROW((HX_("Invalid nodeType ",3b,e0,cb,e1) + ::_Xml::XmlType_Impl__obj::toString(x->nodeType)));
            		}
...
HXLINE( 325)					 ::Dynamic _hx_tmp1 = ::Std_obj::parseInt(sprite1->get(HX_("oX",09,61,00,00)));
HXDLIN( 325)					offset->set(_hx_tmp1,::Std_obj::parseInt(sprite1->get(HX_("oY",0a,61,00,00))));
HXLINE( 326)					 ::Dynamic _hx_tmp2 = ::Std_obj::parseInt(sprite1->get(HX_("oW",08,61,00,00)));
HXDLIN( 326)					sourceSize->set(_hx_tmp2,::Std_obj::parseInt(sprite1->get(HX_("oH",f9,60,00,00))));
            				}
