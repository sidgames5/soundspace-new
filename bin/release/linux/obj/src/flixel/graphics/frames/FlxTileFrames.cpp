...
HXLINE( 506)			 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXDLIN( 160)					int _g11 = numCols;
HXDLIN( 160)					while((_g2 < _g11)){
...
HXLINE( 201)		 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 202)		 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set(0,0);
...
HXDLIN( 443)						 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set(0,0);
HXDLIN( 443)						point3->_inPool = false;
HXDLIN( 443)						result->addAtlasFrame(rect1,point2,point3,null(),null(),null(),null());
