...
HXDLIN( 682)				Float X2 = ( (Float)((X1 - this->border)) );
HXLINE( 683)				int Y1 = ::Std_obj::_hx_int(node->rect->width);
HXLINE( 682)				Float Y2 = ( (Float)((Y1 - this->border)) );
...
HXDLIN( 683)				Float X4 = ( (Float)((X3 - this->border)) );
HXDLIN( 683)				int Y3 = ::Std_obj::_hx_int(node->rect->height);
HXDLIN( 683)				Float Y4 = ( (Float)((Y3 - this->border)) );
...
HXLINE( 684)			 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set(0,0);
