...
HXDLIN( 123)				_this1->width = ( (Float)(0) );
HXDLIN( 123)				_this1->height = ( (Float)(0) );
            			}
            			else {
...
HXLINE( 153)				{
HXLINE( 153)					int _g4 = 0;
HXDLIN( 153)					int _g5 = numberOfVertices;
HXDLIN( 153)					while((_g4 < _g5)){
HXLINE( 153)						_g4 = (_g4 + 1);
HXDLIN( 153)						int i3 = (_g4 - 1);
HXLINE( 155)						{
...
HXDLIN( 276)		_hx_tmp1->verticesPosition = (_hx_tmp1->verticesPosition + 8);
HXLINE( 277)		 ::flixel::graphics::tile::FlxDrawTrianglesItem _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 277)		_hx_tmp2->indicesPosition = (_hx_tmp2->indicesPosition + 6);
            	}
