...
HXLINE( 194)					_hx_tmp5 = (this->curFrame == 0);
            				}
            				else {
...
HXLINE( 201)					_hx_tmp6 = (this->curFrame == (this->frames->length - 1));
            				}
            				else {
...
HXLINE( 204)					 ::flixel::animation::FlxAnimation _g1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 204)					_g1->set_curFrame((_g1->curFrame + 1));
            				}
            			}
            		}
            		_hx_goto_10:;
