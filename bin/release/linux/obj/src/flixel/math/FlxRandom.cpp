...
HXDLIN( 291)			{
HXLINE( 291)				int _g11 = StartIndex;
HXDLIN( 291)				int _g21 = (EndIndex + 1);
HXDLIN( 291)				while((_g11 < _g21)){
HXLINE( 291)					_g11 = (_g11 + 1);
HXDLIN( 291)					int i1 = (_g11 - 1);
...
HXDLIN( 495)		if ((NewSeed < 1)) {
HXDLIN( 495)			lowerBound = ( (Float)(1) );
            		}
            		else {
HXDLIN( 495)			lowerBound = ( (Float)(NewSeed) );
            		}
HXDLIN( 495)		Float NewSeed1;
HXDLIN( 495)		if ((lowerBound > (int)2147483646)) {
HXDLIN( 495)			NewSeed1 = ( (Float)((int)2147483646) );
            		}
            		else {
...
HXDLIN( 495)		if ((NewSeed2 < 1)) {
HXDLIN( 495)			lowerBound1 = ( (Float)(1) );
            		}
            		else {
HXDLIN( 495)			lowerBound1 = ( (Float)(NewSeed2) );
            		}
HXDLIN( 495)		Float _hx_tmp;
HXDLIN( 495)		if ((lowerBound1 > (int)2147483646)) {
HXDLIN( 495)			_hx_tmp = ( (Float)((int)2147483646) );
            		}
            		else {
HXDLIN( 495)			_hx_tmp = lowerBound1;
            		}
HXDLIN( 495)		return (::flixel::math::FlxRandom_obj::_recordingSeed = (_this->initialSeed = ::Std_obj::_hx_int((_this->internalSeed = ( (Float)(::Std_obj::_hx_int(_hx_tmp)) )))));
            	}
...
static hx::StaticInfo FlxRandom_obj_sStaticStorageInfo[] = {
	...
	{hx::fsInt,(void *) &FlxRandom_obj::_stateSeed,HX_("_stateSeed",e3,7f,9a,8a)},
	{hx::fsInt,(void *) &FlxRandom_obj::_recordingSeed,HX_("_recordingSeed",43,b5,11,4b)},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
static ::String FlxRandom_obj_sStaticFields[] = {
	...
	HX_("_stateSeed",e3,7f,9a,8a),
	HX_("_recordingSeed",43,b5,11,4b),
	HX_("updateStateSeed",d9,d4,82,7e),
	HX_("updateRecordingSeed",39,bd,46,a0),
	HX_("getRecordingSeed",8c,6e,e0,76),
	::String(null())
};
...
HXDLIN( 467)		_stateSeed = 1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_472_boot)
HXDLIN( 472)		_recordingSeed = 1;
            	}
}
