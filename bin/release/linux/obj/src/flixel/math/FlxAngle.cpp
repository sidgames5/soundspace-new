...
HXLINE( 217)					int f1 = Facing;
HXDLIN( 217)					if ((f1 == (256 | 16))) {
HXLINE( 210)						degrees = -45;
            					}
            					else {
HXLINE( 218)						int f2 = Facing;
HXDLIN( 218)						if ((f2 == (4096 | 1))) {
HXLINE( 210)							degrees = 135;
            						}
            						else {
HXLINE( 219)							int f3 = Facing;
HXDLIN( 219)							if ((f3 == (4096 | 16))) {
HXLINE( 210)								degrees = 45;
            							}
            							else {
HXLINE( 210)								degrees = 0;
...
HXLINE( 237)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 237)			point1->_inPool = false;
HXDLIN( 237)			p = point1;
            		}
...
HXLINE( 256)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 256)			point1->_inPool = false;
HXDLIN( 256)			p = point1;
            		}
