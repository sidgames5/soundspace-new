...
HXLINE( 433)		Float dx = ((Sprite->x + Sprite->origin->x) - ( (Float)(Touch->screenX) ));
HXLINE( 434)		Float dy = ((Sprite->y + Sprite->origin->y) - ( (Float)(Touch->screenY) ));
...
HXLINE( 449)		Float dx = ((Sprite->x + Sprite->origin->x) - ( (Float)(Touch->screenX) ));
HXLINE( 450)		Float dy = ((Sprite->y + Sprite->origin->y) - ( (Float)(Touch->screenY) ));
