...
HXDLIN( 320)		return (::Math_obj::abs(dp) < ((Float)9.99999999999999841e-15));
            	}
...
HXLINE( 356)		bool p = (::Math_obj::abs(((this1->x * v->y) - (this1->y * v->x))) < ((Float)9.99999999999999841e-15));
...
HXDLIN( 370)		return (::Math_obj::abs(((this1->x * v->y) - (this1->y * v->x))) < ((Float)9.99999999999999841e-15));
            	}
...
HXDLIN( 409)		return (::Math_obj::abs((((this1->x * this1->x) + (this1->y * this1->y)) - ( (Float)(1) ))) < ((Float)9.99999999999999841e-15));
            	}
...
HXLINE( 517)		{
HXLINE( 517)			 ::flixel::math::FlxPoint _g = this1;
HXDLIN( 517)			_g->set_x((_g->x * ( (Float)(-1) )));
            		}
HXLINE( 518)		{
HXLINE( 518)			 ::flixel::math::FlxPoint _g1 = this1;
HXDLIN( 518)			_g1->set_y((_g1->y * ( (Float)(-1) )));
            		}
...
HXDLIN( 524)		{
HXDLIN( 524)			 ::flixel::math::FlxPoint _g = this2;
HXDLIN( 524)			_g->set_x((_g->x * ( (Float)(-1) )));
            		}
HXDLIN( 524)		{
HXDLIN( 524)			 ::flixel::math::FlxPoint _g1 = this2;
HXDLIN( 524)			_g1->set_y((_g1->y * ( (Float)(-1) )));
            		}
...
HXLINE( 613)		Float r;
HXDLIN( 613)		if ((::Math_obj::abs(((this1->x * v->y) - (this1->y * v->x))) < ((Float)9.99999999999999841e-15))) {
HXLINE( 613)			r = ::Math_obj::NaN;
            		}
            		else {
HXLINE( 613)			bool r1;
HXDLIN( 613)			if (!((((this1->x * this1->x) + (this1->y * this1->y)) < ((Float)9.99999999999999841e-15)))) {
HXLINE( 613)				r1 = (((v->x * v->x) + (v->y * v->y)) < ((Float)9.99999999999999841e-15));
            			}
            			else {
HXLINE( 613)				r1 = true;
            			}
...
HXDLIN( 613)					{
HXLINE( 613)						 ::flixel::math::FlxPoint _g = _this;
HXDLIN( 613)						_g->set_x((_g->x - a->x));
            					}
HXDLIN( 613)					{
HXLINE( 613)						 ::flixel::math::FlxPoint _g1 = _this;
HXDLIN( 613)						_g1->set_y((_g1->y - a->y));
            					}
            				}
...
HXLINE( 631)		if ((::Math_obj::abs(((this1->x * v->y) - (this1->y * v->x))) < ((Float)9.99999999999999841e-15))) {
HXLINE( 632)			return ::Math_obj::NaN;
            		}
HXLINE( 633)		bool _hx_tmp;
HXDLIN( 633)		if (!((((this1->x * this1->x) + (this1->y * this1->y)) < ((Float)9.99999999999999841e-15)))) {
HXLINE( 633)			_hx_tmp = (((v->x * v->x) + (v->y * v->y)) < ((Float)9.99999999999999841e-15));
            		}
            		else {
...
HXDLIN( 637)			{
HXLINE( 637)				 ::flixel::math::FlxPoint _g = _this;
HXDLIN( 637)				_g->set_x((_g->x - a->x));
            			}
HXDLIN( 637)			{
HXLINE( 637)				 ::flixel::math::FlxPoint _g1 = _this;
HXDLIN( 637)				_g1->set_y((_g1->y - a->y));
            			}
            		}
...
HXLINE( 652)		Float t;
HXDLIN( 652)		if ((::Math_obj::abs(((this1->x * v->y) - (this1->y * v->x))) < ((Float)9.99999999999999841e-15))) {
HXLINE( 652)			t = ::Math_obj::NaN;
            		}
            		else {
HXLINE( 652)			bool t1;
HXDLIN( 652)			if (!((((this1->x * this1->x) + (this1->y * this1->y)) < ((Float)9.99999999999999841e-15)))) {
HXLINE( 652)				t1 = (((v->x * v->x) + (v->y * v->y)) < ((Float)9.99999999999999841e-15));
            			}
            			else {
HXLINE( 652)				t1 = true;
            			}
...
HXDLIN( 652)					{
HXLINE( 652)						 ::flixel::math::FlxPoint _g = _this;
HXDLIN( 652)						_g->set_x((_g->x - a->x));
            					}
HXDLIN( 652)					{
HXLINE( 652)						 ::flixel::math::FlxPoint _g1 = _this;
HXDLIN( 652)						_g1->set_y((_g1->y - a->y));
            					}
            				}
...
HXLINE( 689)		Float t1;
HXDLIN( 689)		if ((::Math_obj::abs(((this1->x * v->y) - (this1->y * v->x))) < ((Float)9.99999999999999841e-15))) {
HXLINE( 689)			t1 = ::Math_obj::NaN;
            		}
            		else {
HXLINE( 689)			bool t11;
HXDLIN( 689)			if (!((((this1->x * this1->x) + (this1->y * this1->y)) < ((Float)9.99999999999999841e-15)))) {
HXLINE( 689)				t11 = (((v->x * v->x) + (v->y * v->y)) < ((Float)9.99999999999999841e-15));
            			}
            			else {
HXLINE( 689)				t11 = true;
            			}
...
HXDLIN( 689)					{
HXLINE( 689)						 ::flixel::math::FlxPoint _g = _this;
HXDLIN( 689)						_g->set_x((_g->x - a->x));
            					}
HXDLIN( 689)					{
HXLINE( 689)						 ::flixel::math::FlxPoint _g1 = _this;
HXDLIN( 689)						_g1->set_y((_g1->y - a->y));
            					}
            				}
...
HXLINE( 690)		Float t2;
HXDLIN( 690)		if ((::Math_obj::abs(((v->x * this1->y) - (v->y * this1->x))) < ((Float)9.99999999999999841e-15))) {
HXLINE( 690)			t2 = ::Math_obj::NaN;
            		}
            		else {
HXLINE( 690)			bool t21;
HXDLIN( 690)			if (!((((v->x * v->x) + (v->y * v->y)) < ((Float)9.99999999999999841e-15)))) {
HXLINE( 690)				t21 = (((this1->x * this1->x) + (this1->y * this1->y)) < ((Float)9.99999999999999841e-15));
            			}
            			else {
HXLINE( 690)				t21 = true;
            			}
...
HXDLIN( 690)				{
HXLINE( 690)					 ::flixel::math::FlxPoint _this1 = ::flixel::math::_FlxVector::FlxVector_Impl__obj::_vector1;
HXDLIN( 690)					{
HXLINE( 690)						 ::flixel::math::FlxPoint _g2 = _this1;
HXDLIN( 690)						_g2->set_x((_g2->x - b->x));
            					}
HXDLIN( 690)					{
HXLINE( 690)						 ::flixel::math::FlxPoint _g3 = _this1;
HXDLIN( 690)						_g3->set_y((_g3->y - b->y));
            					}
            				}
HXDLIN( 690)				 ::flixel::math::FlxPoint this3 = ::flixel::math::_FlxVector::FlxVector_Impl__obj::_vector1;
HXDLIN( 690)				t2 = (((this3->y * this1->x) + (-(this3->x) * this1->y)) / ((v->y * this1->x) + (-(v->x) * this1->y)));
            			}
            		}
...
HXLINE( 788)		{
HXLINE( 788)			 ::flixel::math::FlxPoint _g = this1;
HXDLIN( 788)			_g->set_x((_g->x - (d * normal->x)));
            		}
HXLINE( 789)		{
HXLINE( 789)			 ::flixel::math::FlxPoint _g1 = this1;
HXDLIN( 789)			_g1->set_y((_g1->y - (d * normal->y)));
            		}
...
HXLINE( 805)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 805)			point1->_inPool = false;
HXDLIN( 805)			proj1 = point1;
            		}
