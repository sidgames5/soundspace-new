...
HXDLIN(  28)		switch((int)(e->_hx_getIndex())){
            			case (int)0: {
HXLINE(  29)				 ::hscript::Const _g19 = e->_hx_getObject(0).StaticCast<  ::hscript::Const >();
            			}
            			break;
            			case (int)1: {
HXLINE(  29)				::String _g27 = e->_hx_getString(0);
            			}
            			break;
            			case (int)2: {
HXLINE(  30)				 ::hscript::CType _g32 = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN(  30)				::String _g31 = e->_hx_getString(0);
HXDLIN(  30)				{
...
HXDLIN(  32)						f(e3);
            			...
            			break;
            			case (int)5: {
HXLINE(  33)				::String _g49 = e->_hx_getString(1);
HXDLIN(  33)				{
...
HXDLIN(  33)					f(e4);
            			...
            			break;
            			case (int)6: {
HXLINE(  34)				::String _g36 = e->_hx_getString(0);
HXDLIN(  34)				{
...
HXDLIN(  34)						f(e21);
            			...
            			break;
            			case (int)7: {
HXLINE(  35)				bool _g13 = e->_hx_getBool(1);
HXDLIN(  35)				::String _g12 = e->_hx_getString(0);
HXDLIN(  35)				{
...
HXDLIN(  38)					f(e7);
            			...
            			break;
            			case (int)11: {
HXLINE(  40)				::String _g28 = e->_hx_getString(0);
HXDLIN(  40)				{
...
HXDLIN(  40)						f(e8);
            			...
            			break;
            			case (int)14: {
HXLINE(  42)				 ::hscript::CType _g44 = e->_hx_getObject(3).StaticCast<  ::hscript::CType >();
HXDLIN(  42)				::String _g43 = e->_hx_getString(2);
HXDLIN(  42)				::Array< ::Dynamic> _g41 = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN(  42)				{
...
HXDLIN(  45)						f(e14);
            			...
            			break;
            			case (int)18: {
HXLINE(  46)				::String _g17 = e->_hx_getString(0);
HXDLIN(  46)				{
...
HXDLIN(  47)				f(e16);
            			...
            			break;
            			case (int)20: {
HXLINE(  48)				 ::hscript::CType _g5 = e->_hx_getObject(2).StaticCast<  ::hscript::CType >();
HXDLIN(  48)				::String _g4 = e->_hx_getString(1);
HXDLIN(  48)				{
...
HXDLIN(  49)				{
HXLINE(  49)					int _g6 = 0;
HXDLIN(  49)					while((_g6 < fl->length)){
HXLINE(  49)						 ::Dynamic fi = fl->__get(_g6);
HXDLIN(  49)						_g6 = (_g6 + 1);
...
HXLINE(  53)					{
HXLINE(  53)						int _g7 = 0;
HXDLIN(  53)						while((_g7 < cases->length)){
HXLINE(  53)							 ::Dynamic c4 = cases->__get(_g7);
HXDLIN(  53)							_g7 = (_g7 + 1);
HXLINE(  54)							{
HXLINE(  54)								int _g8 = 0;
HXDLIN(  54)								::Array< ::Dynamic> _g11 = ( (::Array< ::Dynamic>)(c4->__Field(HX_("values",e2,03,b7,4f),hx::paccDynamic)) );
HXDLIN(  54)								while((_g8 < _g11->length)){
HXLINE(  54)									 ::hscript::Expr v = _g11->__get(_g8).StaticCast<  ::hscript::Expr >();
HXDLIN(  54)									_g8 = (_g8 + 1);
HXDLIN(  54)									f(v);
            								}
            							}
...
HXLINE(  58)						int _g9 = 0;
HXDLIN(  58)						while((_g9 < args1->length)){
HXLINE(  58)							 ::hscript::Expr a1 = args1->__get(_g9).StaticCast<  ::hscript::Expr >();
HXDLIN(  58)							_g9 = (_g9 + 1);
HXDLIN(  58)							f(a1);
            						}
            					}
HXDLIN(  58)					f(e24);
            			...
            			break;
            			case (int)26: {
HXLINE(  59)				 ::hscript::CType _g46 = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN(  59)				{
...
HXDLIN(  64)		switch((int)(e->_hx_getIndex())){
            			case (int)0: {
HXLINE(  65)				 ::hscript::Const _g19 = e->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXLINE(  64)				edef = e;
            			}
            			break;
            			case (int)1: {
HXLINE(  65)				::String _g27 = e->_hx_getString(0);
HXLINE(  64)				edef = e;
            			}
            			break;
            			case (int)2: {
...
HXDLIN(  86)						::Array< ::Dynamic> _g16 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN(  86)						{
HXLINE(  86)							int _g21 = 0;
HXDLIN(  86)							::Array< ::Dynamic> _g31 = ( (::Array< ::Dynamic>)(c4->__Field(HX_("values",e2,03,b7,4f),hx::paccDynamic)) );
HXDLIN(  86)							while((_g21 < _g31->length)){
HXLINE(  86)								 ::hscript::Expr v2 = _g31->__get(_g21).StaticCast<  ::hscript::Expr >();
HXDLIN(  86)								_g21 = (_g21 + 1);
HXDLIN(  86)								_g16->push(f(v2));
            							}
            						}
HXDLIN(  86)						_g6->push( ::Dynamic(hx::Anon_obj::Create(2)
            							...
            							->setFixed(1,HX_("values",e2,03,b7,4f),_g16)));
            					}
            				}
...
HXLINE(  64)				edef = ::hscript::Expr_obj::ESwitch(edef14,_g6,edef15);
            			}
            			break;
            			case (int)24: {
...
HXDLIN(  87)					{
HXLINE(  87)						int _g17 = 0;
HXDLIN(  87)						while((_g17 < args2->length)){
HXLINE(  87)							 ::hscript::Expr a1 = args2->__get(_g17).StaticCast<  ::hscript::Expr >();
HXDLIN(  87)							_g17 = (_g17 + 1);
HXDLIN(  87)							_g7->push(f(a1));
            						}
            					}
HXDLIN(  87)					edef17 = _g7;
            				}
