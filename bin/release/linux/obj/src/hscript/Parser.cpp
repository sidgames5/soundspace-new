...
HXDLIN( 141)					::Array< ::String > _g11 = priorities->__get(i).StaticCast< ::Array< ::String > >();
HXDLIN( 141)					while((_g2 < _g11->length)){
HXLINE( 141)						::String x = _g11->__get(_g2);
HXDLIN( 141)						_g2 = (_g2 + 1);
...
HXLINE( 145)		{
HXLINE( 145)			{
HXLINE( 145)				::String x1 = HX_("!",21,00,00,00);
HXLINE( 146)				{
...
HXLINE( 145)			{
HXLINE( 145)				::String x2 = HX_("++",a0,25,00,00);
HXLINE( 146)				{
HXLINE( 146)					bool _hx_tmp1;
HXDLIN( 146)					if ((x2 != HX_("++",a0,25,00,00))) {
HXLINE( 146)						_hx_tmp1 = (x2 == HX_("--",60,27,00,00));
            					}
            					else {
HXLINE( 146)						_hx_tmp1 = true;
            					}
HXDLIN( 146)					this->unops->set(x2,_hx_tmp1);
            				}
            			}
HXLINE( 145)			{
HXLINE( 145)				::String x3 = HX_("--",60,27,00,00);
HXLINE( 146)				{
HXLINE( 146)					bool _hx_tmp2;
HXDLIN( 146)					if ((x3 != HX_("++",a0,25,00,00))) {
HXLINE( 146)						_hx_tmp2 = (x3 == HX_("--",60,27,00,00));
            					}
            					else {
HXLINE( 146)						_hx_tmp2 = true;
            					}
HXDLIN( 146)					this->unops->set(x3,_hx_tmp2);
            				}
            			}
HXLINE( 145)			{
HXLINE( 145)				::String x4 = HX_("-",2d,00,00,00);
HXLINE( 146)				{
HXLINE( 146)					bool _hx_tmp3;
HXDLIN( 146)					if ((x4 != HX_("++",a0,25,00,00))) {
HXLINE( 146)						_hx_tmp3 = (x4 == HX_("--",60,27,00,00));
            					}
            					else {
HXLINE( 146)						_hx_tmp3 = true;
            					}
HXDLIN( 146)					this->unops->set(x4,_hx_tmp3);
            				}
            			}
HXLINE( 145)			{
HXLINE( 145)				::String x5 = HX_("~",7e,00,00,00);
HXLINE( 146)				{
HXLINE( 146)					bool _hx_tmp4;
HXDLIN( 146)					if ((x5 != HX_("++",a0,25,00,00))) {
HXLINE( 146)						_hx_tmp4 = (x5 == HX_("--",60,27,00,00));
            					}
            					else {
HXLINE( 146)						_hx_tmp4 = true;
            					}
HXDLIN( 146)					this->unops->set(x5,_hx_tmp4);
            				}
            			}
            		}
            	}
...
HXDLIN( 182)				int i1 = (_g2 - 1);
HXLINE( 183)				this->idents[( (int)(this->identChars.charCodeAt(i1)) )] = true;
            			}
            		}
            	}
...
HXLINE( 280)		switch((int)(e->_hx_getIndex())){
            			case (int)2: {
HXLINE( 283)				::String _g20 = e->_hx_getString(0);
...
HXLINE( 283)						return false;
            			...
            			break;
            			case (int)4: {
HXLINE( 281)				::Array< ::Dynamic> _g10 = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 281)				return true;
            			}
            			break;
            			case (int)6: {
HXLINE( 285)				 ::hscript::Expr _g28 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 285)				::String _g27 = e->_hx_getString(0);
HXDLIN( 285)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 285)				return this->isBlock(e2);
            			}
            			break;
            			case (int)7: {
HXLINE( 286)				::String _g7 = e->_hx_getString(0);
HXDLIN( 286)				 ::hscript::Expr e3 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 286)					return false;
            			...
            			break;
            			case (int)9: {
HXLINE( 284)				 ::hscript::Expr _g1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 284)				 ::hscript::Expr e21 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 284)					return this->isBlock(e11);
            			...
            			break;
            			case (int)10: {
HXLINE( 287)				 ::hscript::Expr _g11 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 287)				 ::hscript::Expr e4 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 287)				return this->isBlock(e4);
            			}
            			break;
            			case (int)11: {
HXLINE( 289)				 ::hscript::Expr _g17 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 289)				::String _g16 = e->_hx_getString(0);
HXDLIN( 289)				 ::hscript::Expr e5 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 289)				return this->isBlock(e5);
            			}
            			break;
            			case (int)14: {
HXLINE( 282)				 ::hscript::CType _g26 = e->_hx_getObject(3).StaticCast<  ::hscript::CType >();
HXDLIN( 282)				::String _g25 = e->_hx_getString(2);
HXDLIN( 282)				::Array< ::Dynamic> _g23 = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 282)				 ::hscript::Expr e6 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
...
HXLINE( 290)					return false;
            			...
            			break;
            			case (int)20: {
HXLINE( 291)				 ::hscript::CType _g5 = e->_hx_getObject(2).StaticCast<  ::hscript::CType >();
HXDLIN( 291)				::String _g4 = e->_hx_getString(1);
HXDLIN( 291)				 ::hscript::Expr _g3 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 291)				 ::hscript::Expr e8 = e->_hx_getObject(3).StaticCast<  ::hscript::Expr >();
HXDLIN( 291)				return this->isBlock(e8);
            			}
            			break;
            			case (int)21: {
HXLINE( 281)				::Array< ::Dynamic> _g19 = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 281)				return true;
            			}
            			break;
            			case (int)23: {
HXLINE( 281)				 ::hscript::Expr _g15 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 281)				::Array< ::Dynamic> _g14 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 281)				 ::hscript::Expr _g13 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 281)				return true;
            			}
            			break;
            			case (int)24: {
HXLINE( 288)				 ::hscript::Expr _g30 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 288)				 ::hscript::Expr e9 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 288)				return this->isBlock(e9);
            			}
            			break;
            			case (int)25: {
HXLINE( 292)				::Array< ::Dynamic> _g34 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 292)				::String _g33 = e->_hx_getString(0);
HXDLIN( 292)				 ::hscript::Expr e10 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 303)					 ::hscript::Expr _g2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 303)					 ::hscript::CType _g1 = e->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 303)					::String _g = e->_hx_getString(0);
...
HXLINE( 440)							if ((e1->_hx_getIndex() == 0)) {
HXLINE( 443)								 ::hscript::Const _g = e1->_hx_getObject(0).StaticCast<  ::hscript::Const >();
...
HXLINE( 370)								return this->parseExprNext(::hscript::Expr_obj::EParent(e2));
            							...
            							break;
            							case (int)9: {
HXLINE( 385)								if ((e2->_hx_getIndex() == 1)) {
...
HXLINE( 376)											return this->parseExprNext(::hscript::Expr_obj::ECheckType(e2,t));
            										...
            										break;
            										case (int)9: {
HXLINE( 378)											if ((e2->_hx_getIndex() == 1)) {
...
HXLINE( 408)									if ((c1->_hx_getIndex() == 2)) {
HXLINE( 409)										::String _g1 = c1->_hx_getString(0);
HXDLIN( 409)										{
HXLINE( 410)											 ::hscript::Token tk2 = this->token();
HXLINE( 411)											{
HXLINE( 411)												 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 411)												_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk2,_this1->head);
            											}
HXLINE( 412)											{
HXLINE( 412)												 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN( 412)												_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this2->head);
            											}
...
HXLINE( 419)										 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN( 419)										_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this3->head);
            									}
            								}
            								else {
HXLINE( 422)									 ::haxe::ds::GenericStack_hscript_Token _this4 = this->tokens;
HXDLIN( 422)									_this4->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this4->head);
            								}
            							}
            							break;
            							case (int)2: {
HXLINE( 397)								::String _g11 = tk->_hx_getString(0);
HXDLIN( 397)								{
HXLINE( 398)									 ::hscript::Token tk21 = this->token();
HXLINE( 399)									{
HXLINE( 399)										 ::haxe::ds::GenericStack_hscript_Token _this5 = this->tokens;
HXDLIN( 399)										_this5->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk21,_this5->head);
            									}
HXLINE( 400)									{
HXLINE( 400)										 ::haxe::ds::GenericStack_hscript_Token _this6 = this->tokens;
HXDLIN( 400)										_this6->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this6->head);
            									}
HXLINE( 401)									if (hx::IsNotNull( tk21 )) {
HXLINE( 401)										if ((tk21->_hx_getIndex() == 14)) {
...
HXLINE( 396)								return this->parseExprNext(::hscript::Expr_obj::EObject(::Array_obj< ::Dynamic>::__new(0)));
            							...
            							break;
            							default:{
HXLINE( 424)								 ::haxe::ds::GenericStack_hscript_Token _this7 = this->tokens;
HXDLIN( 424)								_this7->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this7->head);
            							}
            						}
            					}
...
HXLINE( 432)						{
HXLINE( 432)							 ::haxe::ds::GenericStack_hscript_Token _this8 = this->tokens;
HXDLIN( 432)							_this8->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this8->head);
            						}
            					}
            					_hx_goto_35:;
...
HXLINE( 454)						{
HXLINE( 454)							 ::haxe::ds::GenericStack_hscript_Token _this9 = this->tokens;
HXDLIN( 454)							_this9->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this9->head);
            						}
...
HXDLIN( 460)					if ((a1->length == 1)) {
HXLINE( 460)						_hx_tmp3 = hx::IsNotNull( a1->__get(0).StaticCast<  ::hscript::Expr >() );
            					}
            					else {
HXLINE( 460)						_hx_tmp3 = false;
            					}
HXDLIN( 460)					if (_hx_tmp3) {
HXLINE( 461)						 ::hscript::Expr _g2 = a1->__get(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 461)						switch((int)(_g2->_hx_getIndex())){
            							case (int)10: {
HXLINE( 462)								 ::hscript::Expr _g21 = _g2->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 462)								 ::hscript::Expr _g12 = _g2->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 463)								::String tmp = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 464)								 ::hscript::Expr e3 = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hscript::Expr_obj::EVar(tmp,null(),::hscript::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp,a1->__get(0).StaticCast<  ::hscript::Expr >()))->init(2,::hscript::Expr_obj::EIdent(tmp)));
HXLINE( 469)								return this->parseExprNext(e3);
            							}
            							break;
            							case (int)11: {
HXLINE( 462)								 ::hscript::Expr _g5 = _g2->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 462)								 ::hscript::Expr _g4 = _g2->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 462)								::String _g3 = _g2->_hx_getString(0);
HXLINE( 463)								::String tmp1 = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 464)								 ::hscript::Expr e4 = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hscript::Expr_obj::EVar(tmp1,null(),::hscript::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp1,a1->__get(0).StaticCast<  ::hscript::Expr >()))->init(2,::hscript::Expr_obj::EIdent(tmp1)));
HXLINE( 469)								return this->parseExprNext(e4);
            							}
            							break;
            							case (int)24: {
HXLINE( 462)								 ::hscript::Expr _g7 = _g2->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 462)								 ::hscript::Expr _g6 = _g2->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 463)								::String tmp2 = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 464)								 ::hscript::Expr e5 = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,::hscript::Expr_obj::EVar(tmp2,null(),::hscript::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0))))->init(1,this->mapCompr(tmp2,a1->__get(0).StaticCast<  ::hscript::Expr >()))->init(2,::hscript::Expr_obj::EIdent(tmp2)));
HXLINE( 469)								return this->parseExprNext(e5);
            							}
            							break;
            							default:{
            							}
...
HXLINE( 516)								goto _hx_goto_40;
            							...
            							break;
            							default:{
HXLINE( 517)								 ::hscript::Token tk2 = _g;
HXLINE( 518)								this->unexpected(tk2);
            							}
            						}
            					}
            				}
...
HXLINE( 527)				edef = ::hscript::Expr_obj::EParent(this->mapCompr(tmp,e2));
            			...
            			break;
            			case (int)4: {
HXLINE( 536)				::Array< ::Dynamic> _g5 = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 536)				if ((_g5->length == 1)) {
HXLINE( 536)					 ::hscript::Expr e1 = _g5->__get(0).StaticCast<  ::hscript::Expr >();
...
HXDLIN( 561)				 ::Dynamic _hx_tmp2 = this->opPriority->get(op);
HXDLIN( 561)				if (hx::IsLessEq( _hx_tmp2,this->opPriority->get(op2) )) {
HXLINE( 561)					_hx_tmp1 = !(this->opRightAssoc->exists(op));
            				}
            				else {
...
HXLINE( 644)				if ((tk1->_hx_getIndex() == 2)) {
HXLINE( 645)					::String id1 = tk1->_hx_getString(0);
HXDLIN( 645)					name = id1;
            				}
            				else {
HXLINE( 646)					 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 646)					_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk1,_this1->head);
            				}
            			}
...
HXLINE( 595)				{
HXLINE( 595)					 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN( 595)					_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk2,_this2->head);
            				}
HXLINE( 596)				if (semic) {
HXLINE( 596)					 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN( 596)					_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,::hscript::Token_obj::TSemicolon_dyn(),_this3->head);
            				}
            			}
HXLINE( 598)			return ::hscript::Expr_obj::EIf(cond,e11,e2);
...
HXLINE( 660)				if (hx::IsNull( tk3 )) {
HXLINE( 666)					this->unexpected(tk3);
HXLINE( 667)					goto _hx_goto_46;
            				}
            				else {
HXLINE( 660)					switch((int)(tk3->_hx_getIndex())){
            						case (int)4: {
...
HXLINE( 652)			{
HXLINE( 652)				 ::haxe::ds::GenericStack_hscript_Token _this4 = this->tokens;
HXDLIN( 652)				_this4->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk4,_this4->head);
            			}
...
HXLINE( 695)				if (hx::IsNull( tk5 )) {
HXLINE( 757)					this->unexpected(tk5);
HXLINE( 758)					goto _hx_goto_47;
            				}
            				else {
HXLINE( 695)					switch((int)(tk5->_hx_getIndex())){
            						case (int)2: {
HXLINE( 732)							::String _hx_switch_1 = tk5->_hx_getString(0);
...
HXLINE( 703)									if (hx::IsNull( tk5 )) {
HXLINE( 709)										this->unexpected(tk5);
HXLINE( 710)										goto _hx_goto_49;
            									}
            									else {
HXLINE( 703)										switch((int)(tk5->_hx_getIndex())){
            											case (int)9: {
            											}
            											break;
            											case (int)14: {
...
HXLINE( 716)									{
HXLINE( 716)										 ::haxe::ds::GenericStack_hscript_Token _this5 = this->tokens;
HXDLIN( 716)										_this5->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk5,_this5->head);
            									}
HXLINE( 717)									if (hx::IsNull( tk5 )) {
HXLINE( 723)										this->parseFullExpr(exprs);
            									}
            									else {
HXLINE( 717)										switch((int)(tk5->_hx_getIndex())){
            											case (int)0: {
...
HXLINE( 723)													this->parseFullExpr(exprs);
            											...
            											break;
            											case (int)2: {
HXLINE( 718)												::String _hx_switch_2 = tk5->_hx_getString(0);
...
HXLINE( 738)									{
HXLINE( 738)										 ::haxe::ds::GenericStack_hscript_Token _this6 = this->tokens;
HXDLIN( 738)										_this6->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk5,_this6->head);
            									}
HXLINE( 739)									if (hx::IsNull( tk5 )) {
HXLINE( 745)										this->parseFullExpr(exprs1);
            									}
            									else {
HXLINE( 739)										switch((int)(tk5->_hx_getIndex())){
            											case (int)0: {
...
HXLINE( 745)													this->parseFullExpr(exprs1);
            											...
            											break;
            											case (int)2: {
HXLINE( 740)												::String _hx_switch_3 = tk5->_hx_getString(0);
...
HXLINE( 745)												this->parseFullExpr(exprs1);
            								...
            								_hx_goto_52:;
HXLINE( 748)								if ((exprs1->length == 1)) {
HXLINE( 749)									def = exprs1->__get(0).StaticCast<  ::hscript::Expr >();
            								}
            								else {
HXLINE( 750)									if ((exprs1->length == 0)) {
HXLINE( 751)										def = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(0));
            									}
            									else {
HXLINE( 753)										def = ::hscript::Expr_obj::EBlock(exprs1);
            									}
            								}
...
HXLINE( 673)			 ::hscript::Expr e6 = this->parseExpr();
HXLINE( 674)			return ::hscript::Expr_obj::EThrow(e6);
HXLINE( 672)			goto _hx_goto_45;
            		}
            		if (  (_hx_switch_0==HX_("try",3b,69,58,00)) ){
HXLINE( 676)			 ::hscript::Expr e7 = this->parseExpr();
HXLINE( 677)			{
...
HXLINE( 688)			return ::hscript::Expr_obj::ETry(e7,vname1,t10,ec);
...
HXLINE( 607)			 ::hscript::Expr e8 = null();
HXLINE( 608)			if (::Type_obj::enumEq(tk6,::hscript::Token_obj::TOp(HX_("=",3d,00,00,00)))) {
HXLINE( 609)				e8 = this->parseExpr();
            			}
            			else {
HXLINE( 611)				 ::haxe::ds::GenericStack_hscript_Token _this7 = this->tokens;
HXDLIN( 611)				_this7->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk6,_this7->head);
            			}
HXLINE( 612)			return ::hscript::Expr_obj::EVar(ident,t13,e8);
HXLINE( 599)			goto _hx_goto_45;
            		}
            		if (  (_hx_switch_0==HX_("while",b1,43,bd,c9)) ){
HXLINE( 614)			 ::hscript::Expr econd1 = this->parseExpr();
HXLINE( 615)			 ::hscript::Expr e9 = this->parseExpr();
HXLINE( 616)			return ::hscript::Expr_obj::EWhile(econd1,e9);
...
HXLINE( 777)									return ::hscript::Expr_obj::EFunction(::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(1)
            							...
            							break;
            							case (int)26: {
HXLINE( 778)								 ::hscript::Expr _hx_tmp1 = e1->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 778)								if ((_hx_tmp1->_hx_getIndex() == 1)) {
...
HXLINE( 788)							{
HXLINE( 788)								 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 788)								_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            							}
...
HXLINE( 807)					return ::hscript::Expr_obj::ETernary(e1,e21,e3);
            				...
            				default:{
HXLINE( 809)					{
HXLINE( 809)						 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN( 809)						_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this2->head);
            					}
HXLINE( 810)					return e1;
            				}
            			}
...
HXLINE( 918)						 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 918)						_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this1->head);
            					}
            					else {
...
HXLINE( 902)													if (hx::IsEq( op1.charCodeAt(0),62 )) {
HXLINE( 906)														{
HXLINE( 906)															 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN( 906)															 ::hscript::Token item = ::hscript::Token_obj::TOp(op1.substr(1,null()));
HXDLIN( 906)															_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,item,_this2->head);
            														}
...
HXLINE( 916)								 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN( 916)								_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this3->head);
            							}
            						}
            						else {
HXLINE( 918)							 ::haxe::ds::GenericStack_hscript_Token _this4 = this->tokens;
HXDLIN( 918)							_this4->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this4->head);
            						}
            					}
...
HXLINE( 931)									 ::hscript::Token t3 = _g;
HXDLIN( 931)									_gthis->unexpected(t3);
            								}
            							}
            						}
...
HXLINE( 925)					{
HXLINE( 925)						 ::haxe::ds::GenericStack_hscript_Token _this5 = this->tokens;
HXDLIN( 925)						_this5->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,b,_this5->head);
            					}
HXLINE( 926)					{
HXLINE( 926)						 ::haxe::ds::GenericStack_hscript_Token _this6 = this->tokens;
HXDLIN( 926)						_this6->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,a,_this6->head);
            					}
HXLINE( 928)					 ::Dynamic withReturn =  ::Dynamic(new _hx_Closure_0(_gthis));
HXLINE( 937)					if (hx::IsNull( a )) {
HXLINE( 953)						 ::hscript::CType t4 = this->parseType();
HXLINE( 954)						 ::hscript::Token _g1 = this->token();
HXDLIN( 954)						if (hx::IsNull( _g1 )) {
HXLINE( 966)							 ::hscript::Token t5 = _g1;
HXDLIN( 966)							return this->unexpected(t5);
            						}
            						else {
HXLINE( 954)							switch((int)(_g1->_hx_getIndex())){
            								case (int)5: {
HXLINE( 965)									return this->parseTypeNext(::hscript::CType_obj::CTParent(t4));
            								}
            								break;
            								case (int)9: {
HXLINE( 956)									::Array< ::Dynamic> args1 = ::Array_obj< ::Dynamic>::__new(1)->init(0,t4);
HXLINE( 958)									while(true){
HXLINE( 959)										args1->push(this->parseType());
...
HXLINE( 960)											goto _hx_goto_62;
            									...
            									_hx_goto_62:;
HXLINE( 962)									{
HXLINE( 962)										 ::hscript::Token t6 = this->token();
HXDLIN( 962)										if (hx::IsNotEq( t6,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 962)											this->unexpected(t6);
            										}
            									}
HXLINE( 963)									return withReturn(args1);
            								}
            								break;
            								default:{
HXLINE( 966)									 ::hscript::Token t7 = _g1;
HXDLIN( 966)									return this->unexpected(t7);
            								}
            							}
            						}
            					}
...
HXLINE( 937)						switch((int)(a->_hx_getIndex())){
            							case (int)2: {
HXLINE( 938)								::String _g2 = a->_hx_getString(0);
HXLINE( 937)								if (hx::IsNull( b )) {
HXLINE( 953)									 ::hscript::CType t8 = this->parseType();
HXLINE( 954)									 ::hscript::Token _g3 = this->token();
HXDLIN( 954)									if (hx::IsNull( _g3 )) {
HXLINE( 966)										 ::hscript::Token t9 = _g3;
HXDLIN( 966)										return this->unexpected(t9);
            									}
            									else {
HXLINE( 954)										switch((int)(_g3->_hx_getIndex())){
            											case (int)5: {
HXLINE( 965)												return this->parseTypeNext(::hscript::CType_obj::CTParent(t8));
            											}
            											break;
            											case (int)9: {
HXLINE( 956)												::Array< ::Dynamic> args2 = ::Array_obj< ::Dynamic>::__new(1)->init(0,t8);
HXLINE( 958)												while(true){
...
HXLINE( 960)														goto _hx_goto_64;
            												...
            												_hx_goto_64:;
HXLINE( 962)												{
HXLINE( 962)													 ::hscript::Token t10 = this->token();
HXDLIN( 962)													if (hx::IsNotEq( t10,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 962)														this->unexpected(t10);
            													}
            												}
HXLINE( 963)												return withReturn(args2);
            											...
            											break;
            											default:{
HXLINE( 966)												 ::hscript::Token t11 = _g3;
HXDLIN( 966)												return this->unexpected(t11);
            											}
            										}
            									}
            								}
...
HXLINE( 940)										::Array< ::Dynamic> _g4 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 940)										{
HXLINE( 940)											int _g11 = 0;
HXDLIN( 940)											::Array< ::Dynamic> _g21 = this->parseFunctionArgs();
HXDLIN( 940)											while((_g11 < _g21->length)){
HXLINE( 940)												 ::Dynamic arg = _g21->__get(_g11);
HXDLIN( 940)												_g11 = (_g11 + 1);
HXLINE( 941)												{
HXLINE( 941)													 ::hscript::Expr _g12 = arg->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic);
HXLINE( 942)													if (hx::IsNotNull( _g12 )) {
HXLINE( 943)														 ::hscript::Expr v1 = _g12;
...
HXDLIN( 947)												_g4->push(::hscript::CType_obj::CTNamed( ::Dynamic(arg->__Field(HX_("name",4b,72,ff,48),hx::paccDynamic)),_hx_tmp));
            											}
            										}
HXLINE( 940)										::Array< ::Dynamic> args3 = _g4;
HXLINE( 950)										return withReturn(args3);
            									}
            									else {
HXLINE( 953)										 ::hscript::CType t12 = this->parseType();
HXLINE( 954)										 ::hscript::Token _g5 = this->token();
HXDLIN( 954)										if (hx::IsNull( _g5 )) {
HXLINE( 966)											 ::hscript::Token t13 = _g5;
HXDLIN( 966)											return this->unexpected(t13);
            										}
            										else {
HXLINE( 954)											switch((int)(_g5->_hx_getIndex())){
            												case (int)5: {
HXLINE( 965)													return this->parseTypeNext(::hscript::CType_obj::CTParent(t12));
            												}
            												break;
            												case (int)9: {
HXLINE( 956)													::Array< ::Dynamic> args4 = ::Array_obj< ::Dynamic>::__new(1)->init(0,t12);
HXLINE( 958)													while(true){
...
HXLINE( 960)															goto _hx_goto_66;
            													...
            													_hx_goto_66:;
HXLINE( 962)													{
HXLINE( 962)														 ::hscript::Token t14 = this->token();
HXDLIN( 962)														if (hx::IsNotEq( t14,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 962)															this->unexpected(t14);
            														}
            													}
HXLINE( 963)													return withReturn(args4);
            												...
            												break;
            												default:{
HXLINE( 966)													 ::hscript::Token t15 = _g5;
HXDLIN( 966)													return this->unexpected(t15);
            												}
            											}
            										}
            									}
            							...
            							break;
            							case (int)5: {
HXLINE( 940)								::Array< ::Dynamic> _g6 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 940)								{
HXLINE( 940)									int _g13 = 0;
HXDLIN( 940)									::Array< ::Dynamic> _g22 = this->parseFunctionArgs();
HXDLIN( 940)									while((_g13 < _g22->length)){
HXLINE( 940)										 ::Dynamic arg1 = _g22->__get(_g13);
HXDLIN( 940)										_g13 = (_g13 + 1);
HXLINE( 941)										{
HXLINE( 941)											 ::hscript::Expr _g14 = arg1->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic);
HXLINE( 942)											if (hx::IsNotNull( _g14 )) {
HXLINE( 943)												 ::hscript::Expr v2 = _g14;
HXLINE( 944)												if (!(this->resumeErrors)) {
HXLINE( 944)													HX_STACK_DO_THROW(::hscript::Error_obj::ECustom(HX_("Default values not allowed in function types",28,46,7a,e6)));
            												}
            											}
...
HXDLIN( 947)										_g6->push(::hscript::CType_obj::CTNamed( ::Dynamic(arg1->__Field(HX_("name",4b,72,ff,48),hx::paccDynamic)),_hx_tmp1));
            									}
            								}
HXLINE( 940)								::Array< ::Dynamic> args5 = _g6;
HXLINE( 950)								return withReturn(args5);
            							}
            							break;
            							default:{
HXLINE( 953)								 ::hscript::CType t16 = this->parseType();
HXLINE( 954)								 ::hscript::Token _g7 = this->token();
HXDLIN( 954)								if (hx::IsNull( _g7 )) {
HXLINE( 966)									 ::hscript::Token t17 = _g7;
HXDLIN( 966)									return this->unexpected(t17);
            								}
            								else {
HXLINE( 954)									switch((int)(_g7->_hx_getIndex())){
            										case (int)5: {
HXLINE( 965)											return this->parseTypeNext(::hscript::CType_obj::CTParent(t16));
            										}
            										break;
            										case (int)9: {
HXLINE( 956)											::Array< ::Dynamic> args6 = ::Array_obj< ::Dynamic>::__new(1)->init(0,t16);
HXLINE( 958)											while(true){
HXLINE( 959)												args6->push(this->parseType());
HXLINE( 960)												if (!(this->maybe(::hscript::Token_obj::TComma_dyn()))) {
HXLINE( 960)													goto _hx_goto_63;
            											...
            											_hx_goto_63:;
HXLINE( 962)											{
HXLINE( 962)												 ::hscript::Token t18 = this->token();
HXDLIN( 962)												if (hx::IsNotEq( t18,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 962)													this->unexpected(t18);
            												}
            											}
HXLINE( 963)											return withReturn(args6);
            										}
            										break;
            										default:{
HXLINE( 966)											 ::hscript::Token t19 = _g7;
HXDLIN( 966)											return this->unexpected(t19);
            										}
            									}
            								}
            							}
...
HXLINE( 974)							switch((int)(t->_hx_getIndex())){
            								case (int)2: {
HXLINE( 982)									::String _g8 = t->_hx_getString(0);
HXDLIN( 982)									if ((_g8 == HX_("var",e7,de,59,00))) {
HXLINE( 977)										::String name = this->getIdent();
HXLINE( 978)										{
HXLINE( 978)											 ::hscript::Token t20 = this->token();
HXDLIN( 978)											if (hx::IsNotEq( t20,::hscript::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 978)												this->unexpected(t20);
            											}
            										}
...
HXLINE( 981)										{
HXLINE( 981)											 ::hscript::Token t21 = this->token();
HXDLIN( 981)											if (hx::IsNotEq( t21,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE( 981)												this->unexpected(t21);
            											}
            										}
            									}
            									else {
HXLINE( 982)										::String name1 = _g8;
HXDLIN( 982)										{
HXLINE( 983)											{
HXLINE( 983)												 ::hscript::Token t22 = this->token();
HXDLIN( 983)												if (hx::IsNotEq( t22,::hscript::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 983)													this->unexpected(t22);
            												}
            											}
...
HXLINE(1010)					{
HXLINE(1010)						 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN(1010)						_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            					}
...
HXLINE(1014)				{
HXLINE(1014)					 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN(1014)					_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this2->head);
            				}
HXLINE(1015)				return t;
            			}
            		}
...
HXLINE(1019)			 ::hscript::CType _g2 = t2->_hx_getObject(1).StaticCast<  ::hscript::CType >();
...
HXLINE(1073)					{
HXLINE(1073)						 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN(1073)						_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            					}
HXLINE(1074)					goto _hx_goto_76;
            				}
            			}
...
HXLINE(1141)						{
HXLINE(1141)							 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN(1141)							_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this2->head);
            						}
HXLINE(1142)						goto _hx_goto_82;
            					}
            				}
...
HXLINE(1112)					{
HXLINE(1112)						 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN(1112)						_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t2,_this3->head);
            					}
HXLINE(1113)					goto _hx_goto_85;
            				}
HXLINE(1115)				t2 = this->token();
HXLINE(1116)				if (hx::IsNull( t2 )) {
HXLINE(1122)					this->unexpected(t2);
            				}
            				else {
HXLINE(1116)					switch((int)(t2->_hx_getIndex())){
            						case (int)2: {
...
HXLINE(1118)							path->push(id);
            						...
            						break;
            						case (int)3: {
HXLINE(1119)							if ((t2->_hx_getString(0) == HX_("*",2a,00,00,00))) {
...
HXLINE(1279)						if ((c1 >= 127)) {
HXLINE(1279)							::String x = ::String::fromCharCode(c1);
...
HXLINE(1280)							if ((c1 >= 127)) {
HXLINE(1280)								::String x1 = ::String::fromCharCode(c1);
HXDLIN(1280)								if (hx::IsNotNull( b->charBuf )) {
HXLINE(1280)									b->flush();
            								}
HXDLIN(1280)								if (hx::IsNull( b->b )) {
HXLINE(1280)									b->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            								}
            								else {
HXLINE(1280)									::Array< ::String > b2 = b->b;
HXDLIN(1280)									b2->push(::Std_obj::string(x1));
            								}
            							}
            							else {
...
HXLINE(1302)							::String x2 = ::String::fromCharCode(k);
HXDLIN(1302)							if (hx::IsNotNull( b->charBuf )) {
HXLINE(1302)								b->flush();
            							}
HXDLIN(1302)							if (hx::IsNull( b->b )) {
HXLINE(1302)								b->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2));
            							}
            							else {
HXLINE(1302)								::Array< ::String > b3 = b->b;
HXDLIN(1302)								b3->push(::Std_obj::string(x2));
            							}
            						}
            						else {
...
HXLINE(1310)						if ((c1 == 10)) {
HXLINE(1310)							this->line++;
            						}
HXLINE(1311)						if ((c1 >= 127)) {
HXLINE(1311)							::String x3 = ::String::fromCharCode(c1);
HXDLIN(1311)							if (hx::IsNotNull( b->charBuf )) {
HXLINE(1311)								b->flush();
            							}
HXDLIN(1311)							if (hx::IsNull( b->b )) {
HXLINE(1311)								b->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3));
            							}
            							else {
HXLINE(1311)								::Array< ::String > b4 = b->b;
HXDLIN(1311)								b4->push(::Std_obj::string(x3));
            							}
            						}
            						else {
...
HXLINE(1397)								exp1 = ((Float)1.);
            							...
            							break;
            							case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: {
HXLINE(1369)								n1 = ((n1 * ( (Float)(10) )) + (_hx_char - 48));
            							}
            							break;
...
HXLINE(1382)												 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN(1382)												_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this3->head);
            											}
            										}
            										break;
            										case (int)3: {
...
HXLINE(1378)														 ::hscript::Const _g1 = tk->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXDLIN(1378)														if ((_g1->_hx_getIndex() == 0)) {
HXLINE(1378)															int e1 = _g1->_hx_getInt(0);
HXDLIN(1378)															pow = -(e1);
            														}
            														else {
HXLINE(1379)															 ::haxe::ds::GenericStack_hscript_Token _this5 = this->tokens;
HXDLIN(1379)															_this5->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this5->head);
            														}
            													}
            													else {
HXLINE(1379)														 ::haxe::ds::GenericStack_hscript_Token _this6 = this->tokens;
HXDLIN(1379)														_this6->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this6->head);
            													}
            												}
            											}
            											else {
HXLINE(1382)												 ::haxe::ds::GenericStack_hscript_Token _this7 = this->tokens;
HXDLIN(1382)												_this7->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this7->head);
            											}
            										}
            										break;
            										default:{
HXLINE(1382)											 ::haxe::ds::GenericStack_hscript_Token _this8 = this->tokens;
HXDLIN(1382)											_this8->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this8->head);
            										}
            									}
            								}
...
HXLINE(1386)								return ::hscript::Token_obj::TConst(::hscript::Const_obj::CFloat((((::Math_obj::pow(( (Float)(10) ),( (Float)(pow) )) / exp1) * n1) * ( (Float)(10) ))));
            							}
            							break;
            							case (int)120: {
HXLINE(1399)								bool _hx_tmp2;
HXDLIN(1399)								if (!((n1 > 0))) {
HXLINE(1399)									_hx_tmp2 = (exp1 > 0);
            								}
            								else {
...
HXLINE(1403)								int n2 = 0;
HXLINE(1404)								while(true){
HXLINE(1405)									_hx_char = this->input.cca(this->readPos++);
HXLINE(1406)									switch((int)(_hx_char)){
            										case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: {
HXLINE(1408)											n2 = (((n2 << 4) + _hx_char) - 48);
            										}
            										break;
            										case (int)65: case (int)66: case (int)67: case (int)68: case (int)69: case (int)70: {
HXLINE(1410)											n2 = ((n2 << 4) + (_hx_char - 55));
            										}
            										break;
            										case (int)97: case (int)98: case (int)99: case (int)100: case (int)101: case (int)102: {
HXLINE(1412)											n2 = ((n2 << 4) + (_hx_char - 87));
            										}
            										break;
            										default:{
...
HXDLIN(1442)								if ((exp1 > 0)) {
HXLINE(1442)									_hx_tmp3 = ::hscript::Const_obj::CFloat(((n1 * ( (Float)(10) )) / exp1));
            								}
            								else {
...
HXLINE(1492)						_hx_tmp4 = (_hx_char == 58);
            					}
            					else {
...
HXLINE(1582)				return this->evalPreproCond(e1);
            			...
            			break;
            			case (int)6: {
HXLINE(1585)				 ::hscript::Expr _g6 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN(1585)				 ::hscript::Expr _g5 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN(1585)				::String _hx_switch_0 = e->_hx_getString(0);
            				if (  (_hx_switch_0==HX_("&&",40,21,00,00)) ){
HXLINE(1583)					 ::hscript::Expr e2 = _g6;
HXDLIN(1583)					 ::hscript::Expr e11 = _g5;
...
HXLINE(1585)					 ::hscript::Expr e21 = _g6;
HXDLIN(1585)					 ::hscript::Expr e12 = _g5;
...
HXLINE(1589)					return false;
            			...
            			break;
            			case (int)7: {
HXLINE(1579)				bool _g1 = e->_hx_getBool(1);
