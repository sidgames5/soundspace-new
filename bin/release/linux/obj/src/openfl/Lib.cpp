...
HXDLIN( 153)		if (::Std_obj::is(value,hx::ClassOf< ::hx::Class >())) {
...
HXDLIN( 156)			if (!(::Std_obj::is(value,hx::ClassOf< bool >()))) {
...
HXDLIN( 157)				if (!(::Std_obj::is(value,hx::ClassOf< int >()))) {
HXLINE( 157)					_hx_tmp1 = hx::IsEq( value,hx::ClassOf< int >() );
            				}
            				else {
...
HXDLIN( 158)					if (!(::Std_obj::is(value,hx::ClassOf< ::Float >()))) {
HXLINE( 158)						_hx_tmp2 = hx::IsEq( value,hx::ClassOf< ::Float >() );
            					}
            					else {
...
HXDLIN( 193)		if (::Std_obj::is(value,hx::ClassOf< ::hx::Class >())) {
...
HXLINE( 558)				::cpp::VirtualArray v1;
HXDLIN( 558)				if (hx::IsNull( args )) {
HXLINE( 558)					v1 = ::cpp::VirtualArray_obj::__new(0);
            				}
            				else {
HXLINE( 558)					v1 = args;
            				}
HXDLIN( 558)				::Reflect_obj::callMethod(closure,closure,v1);
            			}
            			HX_END_LOCAL_FUNC0((void))
