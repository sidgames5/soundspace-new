...
HXLINE( 591)			this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,4);
            		}
            		else {
...
HXDLIN( 591)				 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 591)				_this->buffer = this3;
...
HXDLIN( 591)					_this1->buffer = this4;
HXDLIN( 591)					_this1->copyFromArray(array1,null());
HXDLIN( 591)					this2 = _this1;
            				}
            				else {
...
HXDLIN( 591)							 ::haxe::io::Bytes this5 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 591)							_this2->buffer = this5;
