...
HX_DEFINE_DYNAMIC_FUNC0(FloatMap_obj,keyValueIterator,return )
 ...
 ::Dynamic FloatMap_obj::keys(){
            	HX_STACKFRAME(&_hx_pos_ea32ed7fa92041fa_335_keys)
HXDLIN( 335)		return this->floatKeys->copy()->iterator();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FloatMap_obj,keys,return )
 ...
 ::Dynamic FloatMap_obj::iterator(){
            	HX_STACKFRAME(&_hx_pos_ea32ed7fa92041fa_340_iterator)
HXDLIN( 340)		return this->values->copy()->iterator();
            	}
