...
bool ShapeCache_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x00123adc;
}
...
HXLINE(  68)			 ::haxe::ds::StringMap formatMap1 =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE(  69)			formatMap1->set(wordKey,getPositions->get_positions());
HXLINE(  70)			this->_hx___shortWordMap->set(formatKey,formatMap1);
            		}
...
HXLINE(  95)				 ::openfl::text::_internal::CacheMeasurement measurement1 =  ::openfl::text::_internal::CacheMeasurement_obj::__alloc( HX_CTX ,wordKey,getPositions->get_positions());
HXLINE(  96)				formatMap->set(hash,measurement1);
            			}
            		}
            		else {
HXLINE( 101)			 ::haxe::ds::IntMap formatMap1 =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 102)			 ::openfl::text::_internal::CacheMeasurement measurement2 =  ::openfl::text::_internal::CacheMeasurement_obj::__alloc( HX_CTX ,wordKey,getPositions->get_positions());
HXLINE( 103)			measurement2->hash = hash;
HXLINE( 104)			formatMap1->set(hash,measurement2);
HXLINE( 105)			this->_hx___longWordMap->set(formatKey,formatMap1);
            		}
