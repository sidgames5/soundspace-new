...
bool TextLayout_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2c6ef496;
}
...
HXLINE( 150)			 ::Dynamic _hx_tmp3 = this->_hx___hbBuffer;
HXDLIN( 150)			Float _hx_tmp4 = (uintptr_t)this->text.wc_str();
HXDLIN( 150)			::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::addUTF16(_hx_tmp3,_hx_tmp4,this->text.length,0,-1);
...
HXLINE( 158)				_hx_tmp5 = hx::IsNotNull( _positions );
            			}
            			else {
...
HXLINE( 170)						{
HXLINE( 170)							int _g2 = (lastCluster + 1);
HXDLIN( 170)							int _g11 = info->cluster;
HXDLIN( 170)							while((_g2 < _g11)){
HXLINE( 170)								_g2 = (_g2 + 1);
HXDLIN( 170)								int j = (_g2 - 1);
HXLINE( 174)								::Array< ::Dynamic> _hx_tmp6 = this->get_positions();
HXDLIN( 174)								 ::lime::math::Vector2 _hx_tmp7 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0);
HXDLIN( 174)								_hx_tmp6->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,0,_hx_tmp7, ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0)));
            							}
            						}
HXLINE( 177)						::Array< ::Dynamic> _hx_tmp8 = this->get_positions();
HXDLIN( 177)						int info1 = info->codepoint;
HXDLIN( 177)						 ::lime::math::Vector2 _hx_tmp9 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,((( (Float)(position->xAdvance) ) / ( (Float)(64) )) + this->letterSpacing),(( (Float)(position->yAdvance) ) / ( (Float)(64) )));
HXDLIN( 177)						_hx_tmp8->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,info1,_hx_tmp9, ::lime::math::Vector2_obj::__alloc( HX_CTX ,(( (Float)(position->xOffset) ) / ( (Float)(64) )),(( (Float)(position->yOffset) ) / ( (Float)(64) )))));
