...
bool HTMLParser_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x18d41e21;
}
...
HXLINE(  66)					::String segment1 = segments->__get(_g);
HXDLIN(  66)					_g = (_g + 1);
HXLINE(  68)					if ((segment1 == HX_("",00,00,00,00))) {
HXLINE(  68)						continue;
            					}
HXLINE(  70)					bool isClosingTag = (segment1.substr(0,1) == HX_("/",2f,00,00,00));
HXLINE(  71)					int tagEndIndex = segment1.indexOf(HX_(">",3e,00,00,00),null());
HXLINE(  72)					int start = (tagEndIndex + 1);
HXLINE(  73)					int spaceIndex = segment1.indexOf(HX_(" ",20,00,00,00),null());
...
HXDLIN(  74)					::String tagName3 = segment1.substring(tagName,tagName1);
...
HXLINE(  90)							_hx_tmp2 = (textFormatRanges->get_length() > 0);
            						}
            						else {
...
HXLINE(  98)							sub = ::StringTools_obj::htmlUnescape(segment1.substr(start,null()));
...
HXLINE( 113)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexHref->match(segment1)) {
...
HXLINE( 131)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexFace->match(segment1)) {
...
HXLINE( 136)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexColor->match(segment1)) {
...
HXLINE( 141)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexSize->match(segment1)) {
...
HXLINE( 146)										_hx_tmp3 = hx::IsEq( firstChar,45 );
            									}
            									else {
...
HXLINE( 119)									_hx_tmp4 = !(noLineBreak);
            								}
            								else {
...
HXLINE( 124)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexAlign->match(segment1)) {
...
HXLINE( 167)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexBlockIndent->match(segment1)) {
...
HXLINE( 172)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexIndent->match(segment1)) {
...
HXLINE( 177)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexLeading->match(segment1)) {
...
HXLINE( 182)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexLeftMargin->match(segment1)) {
...
HXLINE( 187)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexRightMargin->match(segment1)) {
...
HXLINE( 192)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexTabStops->match(segment1)) {
...
HXDLIN( 197)										while((_g1 < values->length)){
HXLINE( 197)											::String stop = values->__get(_g1);
...
HXLINE( 209)							if ((start < segment1.length)) {
HXLINE( 211)								sub = ::StringTools_obj::htmlUnescape(segment1.substring(start,null()));
...
HXLINE( 219)							sub = ::StringTools_obj::htmlUnescape(segment1);
