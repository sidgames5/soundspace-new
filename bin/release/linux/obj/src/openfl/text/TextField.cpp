...
HXLINE( 924)				bool _hx_tmp3;
HXDLIN( 924)				if ((y >= group1->offsetY)) {
HXLINE( 924)					_hx_tmp3 = (y <= (group1->offsetY + group1->height));
            				}
            				else {
HXLINE( 924)					_hx_tmp3 = false;
            				}
HXDLIN( 924)				if (_hx_tmp3) {
HXLINE( 926)					bool _hx_tmp4;
HXDLIN( 926)					if ((x >= group1->offsetX)) {
HXLINE( 926)						_hx_tmp4 = (x <= (group1->offsetX + group1->width));
            					}
            					else {
...
HXLINE( 930)						{
HXLINE( 930)							int _g3 = 0;
HXDLIN( 930)							int _g4 = group1->positions->length;
HXDLIN( 930)							while((_g3 < _g4)){
HXLINE( 930)								_g3 = (_g3 + 1);
HXDLIN( 930)								int i1 = (_g3 - 1);
HXLINE( 932)								Float advance1;
HXDLIN( 932)								bool advance2;
HXDLIN( 932)								if ((i1 >= 0)) {
HXLINE( 932)									advance2 = (i1 < group1->positions->length);
            								}
            								else {
HXLINE( 932)									advance2 = false;
            								}
HXDLIN( 932)								if (advance2) {
HXLINE( 932)									advance1 = group1->positions->__get(i1).StaticCast<  ::openfl::text::_internal::GlyphPosition >()->advance->x;
            								}
            								else {
...
HXLINE( 936)									return (group1->startIndex + i1);
            								}
            							}
            						}
...
HXLINE(1019)				bool _hx_tmp3;
HXDLIN(1019)				if ((y >= group1->offsetY)) {
HXLINE(1019)					_hx_tmp3 = (y <= (group1->offsetY + group1->height));
            				}
            				else {
HXLINE(1019)					_hx_tmp3 = false;
            				}
HXDLIN(1019)				if (_hx_tmp3) {
...
HXLINE(1046)				bool _hx_tmp1;
HXDLIN(1046)				if ((group1->startIndex <= charIndex)) {
HXLINE(1046)					_hx_tmp1 = (group1->endIndex >= charIndex);
            				}
            				else {
...
HXLINE(1235)			HX_STACK_DO_THROW( ::openfl::errors::RangeError_obj::__alloc( HX_CTX ,HX_("The supplied index is out of bounds",37,5a,d3,87)));
            		}
...
HXLINE(1244)				bool _hx_tmp3;
HXDLIN(1244)				bool _hx_tmp4;
HXDLIN(1244)				if ((group1->start <= beginIndex)) {
HXLINE(1244)					_hx_tmp4 = (group1->end > beginIndex);
            				}
            				else {
HXLINE(1244)					_hx_tmp4 = false;
            				}
HXDLIN(1244)				if (!(_hx_tmp4)) {
HXLINE(1244)					if ((group1->start < endIndex)) {
HXLINE(1244)						_hx_tmp3 = (group1->end >= endIndex);
            					}
            					else {
...
HXLINE(1438)			HX_STACK_DO_THROW( ::openfl::errors::RangeError_obj::__alloc( HX_CTX ,null()));
            		}
...
HXLINE(1485)						bool _hx_tmp5;
HXDLIN(1485)						if ((range->start <= beginIndex)) {
HXLINE(1485)							_hx_tmp5 = (range->end >= endIndex);
            						}
            						else {
HXLINE(1485)							_hx_tmp5 = false;
            						}
HXDLIN(1485)						if (_hx_tmp5) {
HXLINE(1487)							bool _hx_tmp6;
HXDLIN(1487)							if ((range->start == beginIndex)) {
HXLINE(1487)								_hx_tmp6 = (range->end == endIndex);
            							}
            							else {
HXLINE(1487)								_hx_tmp6 = false;
            							}
HXDLIN(1487)							if (_hx_tmp6) {
...
HXLINE(1527)							bool _hx_tmp7;
HXDLIN(1527)							if ((range->start >= beginIndex)) {
HXLINE(1527)								_hx_tmp7 = (range->end <= endIndex);
            							}
            							else {
HXLINE(1527)								_hx_tmp7 = false;
            							}
HXDLIN(1527)							if (_hx_tmp7) {
...
HXLINE(1543)								bool _hx_tmp8;
HXDLIN(1543)								if ((range->start > beginIndex)) {
HXLINE(1543)									_hx_tmp8 = (range->end > beginIndex);
            								}
            								else {
HXLINE(1543)									_hx_tmp8 = false;
            								}
HXDLIN(1543)								if (_hx_tmp8) {
HXLINE(1546)									range->start = endIndex;
HXLINE(1547)									goto _hx_goto_28;
            								}
            								else {
HXLINE(1549)									bool _hx_tmp9;
HXDLIN(1549)									if ((range->start < beginIndex)) {
HXLINE(1549)										_hx_tmp9 = (range->end <= endIndex);
            									}
            									else {
HXLINE(1549)										_hx_tmp9 = false;
            									}
HXDLIN(1549)									if (_hx_tmp9) {
...
HXLINE(1713)					_hx_tmp1 = (url != HX_("",00,00,00,00));
            				}
            				else {
...
HXLINE(1788)				bool _hx_tmp1;
HXDLIN(1788)				if ((charIndex >= group1->startIndex)) {
HXLINE(1788)					_hx_tmp1 = (charIndex < group1->endIndex);
            				}
            				else {
HXLINE(1788)					_hx_tmp1 = false;
            				}
...
HXLINE(1794)						{
HXLINE(1794)							int _g1 = 0;
HXDLIN(1794)							int _g2 = (charIndex - group1->startIndex);
HXDLIN(1794)							while((_g1 < _g2)){
HXLINE(1794)								_g1 = (_g1 + 1);
HXDLIN(1794)								int i = (_g1 - 1);
...
HXLINE(1821)				bool _hx_tmp2;
HXDLIN(1821)				if ((charIndex >= group1->startIndex)) {
HXLINE(1821)					_hx_tmp2 = (charIndex <= group1->endIndex);
            				}
            				else {
HXLINE(1821)					_hx_tmp2 = false;
            				}
HXDLIN(1821)				if (_hx_tmp2) {
HXLINE(1823)					x = group1->offsetX;
HXLINE(1825)					{
HXLINE(1825)						int _g1 = 0;
HXDLIN(1825)						int _g2 = (charIndex - group1->startIndex);
HXDLIN(1825)						while((_g1 < _g2)){
HXLINE(1825)							_g1 = (_g1 + 1);
HXDLIN(1825)							int i = (_g1 - 1);
...
HXLINE(1837)					{
HXLINE(1837)						int _g11 = 0;
HXDLIN(1837)						int _g21 = (this->get_scrollV() - 1);
HXDLIN(1837)						while((_g11 < _g21)){
HXLINE(1837)							_g11 = (_g11 + 1);
HXDLIN(1837)							int i1 = (_g11 - 1);
HXLINE(1839)							y = (y - this->_hx___textEngine->lineHeights->get(i1));
            						}
            					}
...
HXDLIN(1881)				int i1 = (_g2 - 1);
HXLINE(1883)				group = this->_hx___textEngine->layoutGroups->get(i1).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
HXLINE(1885)				if ((i1 < (this->_hx___textEngine->layoutGroups->get_length() - 1))) {
HXLINE(1887)					nextGroup = this->_hx___textEngine->layoutGroups->get((i1 + 1)).StaticCast<  ::openfl::text::_internal::TextLayoutGroup >();
            				}
            				else {
...
HXLINE(1901)					_hx_tmp2 = (y <= (group->offsetY + group->height));
            				}
            				else {
...
HXLINE(1901)						_hx_tmp1 = hx::IsNull( nextGroup );
            					}
            					else {
...
HXDLIN(1903)					bool _hx_tmp4;
HXDLIN(1903)					if ((x >= group->offsetX)) {
HXLINE(1903)						_hx_tmp4 = (x <= (group->offsetX + group->width));
            					}
            					else {
HXLINE(1903)						_hx_tmp4 = false;
            					}
HXDLIN(1903)					if (!(_hx_tmp4)) {
HXLINE(1904)						if (!(precise)) {
HXLINE(1904)							if (hx::IsNotNull( nextGroup )) {
HXLINE(1903)								_hx_tmp3 = (nextGroup->lineIndex != group->lineIndex);
            							}
            							else {
HXLINE(1903)								_hx_tmp3 = true;
            							}
            						}
            						else {
...
HXLINE(2065)							 ::openfl::text::_internal::TextFormatRange range2 = range;
HXDLIN(2065)							range2->start = (range2->start + offset);
HXLINE(2066)							 ::openfl::text::_internal::TextFormatRange range3 = range;
HXDLIN(2066)							range3->end = (range3->end + offset);
            						}
            						else {
HXLINE(2068)							bool _hx_tmp4;
HXDLIN(2068)							if ((range->start < beginIndex)) {
HXLINE(2068)								_hx_tmp4 = (range->end >= endIndex);
            							}
            							else {
HXLINE(2068)								_hx_tmp4 = false;
            							}
HXDLIN(2068)							if (_hx_tmp4) {
HXLINE(2072)								 ::openfl::text::_internal::TextFormatRange range4 = range;
HXDLIN(2072)								range4->end = (range4->end + offset);
            							}
            						}
            					}
            				}
...
HXLINE(2084)						 ::openfl::text::_internal::TextFormatRange range5 = range;
HXDLIN(2084)						range5->start = (range5->start + offset);
HXLINE(2085)						 ::openfl::text::_internal::TextFormatRange range6 = range;
HXDLIN(2085)						range6->end = (range6->end + offset);
            					}
            					else {
HXLINE(2087)						bool _hx_tmp5;
HXDLIN(2087)						if ((range->start <= beginIndex)) {
HXLINE(2087)							_hx_tmp5 = (range->end > endIndex);
            						}
            						else {
HXLINE(2087)							_hx_tmp5 = false;
            						}
HXDLIN(2087)						if (_hx_tmp5) {
HXLINE(2090)							 ::openfl::text::_internal::TextFormatRange range7 = range;
HXDLIN(2090)							range7->end = (range7->end + offset);
            						}
            						else {
HXLINE(2092)							bool _hx_tmp6;
HXDLIN(2092)							if ((range->start >= beginIndex)) {
HXLINE(2092)								_hx_tmp6 = (range->end <= endIndex);
            							}
            							else {
...
HXLINE(2097)								bool _hx_tmp7;
HXDLIN(2097)								bool _hx_tmp8;
HXDLIN(2097)								if ((range->end > endIndex)) {
HXLINE(2097)									_hx_tmp8 = (range->start > beginIndex);
            								}
            								else {
HXLINE(2097)									_hx_tmp8 = false;
            								}
HXDLIN(2097)								if (_hx_tmp8) {
HXLINE(2097)									_hx_tmp7 = (range->start <= endIndex);
            								}
            								else {
HXLINE(2097)									_hx_tmp7 = false;
            								}
HXDLIN(2097)								if (_hx_tmp7) {
HXLINE(2101)									range->start = beginIndex;
HXLINE(2102)									 ::openfl::text::_internal::TextFormatRange range8 = range;
HXDLIN(2102)									range8->end = (range8->end + offset);
            								}
            								else {
HXLINE(2104)									bool _hx_tmp9;
HXDLIN(2104)									bool _hx_tmp10;
HXDLIN(2104)									if ((range->start < beginIndex)) {
HXLINE(2104)										_hx_tmp10 = (range->end > beginIndex);
            									}
            									else {
HXLINE(2104)										_hx_tmp10 = false;
            									}
HXDLIN(2104)									if (_hx_tmp10) {
HXLINE(2104)										_hx_tmp9 = (range->end <= endIndex);
            									}
            									else {
HXLINE(2104)										_hx_tmp9 = false;
            									}
HXDLIN(2104)									if (_hx_tmp9) {
...
HXLINE(2120)			bool _hx_tmp11;
HXDLIN(2120)			if ((beginIndex == endIndex)) {
HXLINE(2120)				_hx_tmp11 = (this->_hx___textEngine->textFormatRanges->get(0).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->start > 0);
            			}
            			else {
HXLINE(2120)				_hx_tmp11 = false;
            			}
HXDLIN(2120)			if (_hx_tmp11) {
HXLINE(2123)				::Dynamic this2 = this->_hx___textEngine->textFormatRanges;
HXDLIN(2123)				 ::openfl::text::TextFormat value1 = this->get_defaultTextFormat()->clone();
HXDLIN(2123)				( ( ::openfl::_Vector::ObjectVector)(this2) )->unshift( ::openfl::text::_internal::TextFormatRange_obj::__alloc( HX_CTX ,value1,0,this->_hx___textEngine->textFormatRanges->get(0).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->start));
            			}
            			else {
HXLINE(2125)				bool _hx_tmp12;
HXDLIN(2125)				if ((beginIndex != endIndex)) {
HXLINE(2125)					::Dynamic this3 = this->_hx___textEngine->textFormatRanges;
HXDLIN(2125)					 ::openfl::text::_internal::TextFormatRange _hx_tmp13 = ( ( ::openfl::_Vector::ObjectVector)(this3) )->get((this->_hx___textEngine->textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXDLIN(2125)					_hx_tmp12 = (_hx_tmp13->end < this->_hx___text.length);
            				}
            				else {
HXLINE(2125)					_hx_tmp12 = false;
            				}
HXDLIN(2125)				if (_hx_tmp12) {
HXLINE(2128)					::Dynamic this4 = this->_hx___textEngine->textFormatRanges;
HXDLIN(2128)					 ::openfl::text::TextFormat value2 = this->get_defaultTextFormat()->clone();
HXLINE(2129)					::Dynamic this5 = this->_hx___textEngine->textFormatRanges;
HXDLIN(2129)					 ::openfl::text::_internal::TextFormatRange value3 = ( ( ::openfl::_Vector::ObjectVector)(this5) )->get((this->_hx___textEngine->textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >();
HXLINE(2128)					( ( ::openfl::_Vector::ObjectVector)(this4) )->push( ::openfl::text::_internal::TextFormatRange_obj::__alloc( HX_CTX ,value2,value3->end,this->_hx___text.length));
            				}
            			}
            		}
...
HXDLIN(2209)						goto _hx_goto_66;
            					...
            					if (  (_hx_switch_0==3) ){
HXLINE(2206)						 ::openfl::text::TextField _g1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(2206)						Float _hx_tmp1 = _g1->get_x();
HXDLIN(2206)						_g1->set_x((_hx_tmp1 + (cacheWidth - this->_hx___textEngine->width)));
...
HXLINE(2238)			int _hx_tmp2 = this->getLineOffset(this->getLineIndexOfChar(this->_hx___caretIndex));
HXDLIN(2238)			_hx_tmp1 = (_hx_tmp2 == this->_hx___caretIndex);
            		}
            		else {
...
HXLINE(2260)				bool _hx_tmp3;
HXDLIN(2260)				if ((caret->x < tempScrollH)) {
HXLINE(2260)					_hx_tmp3 = (tempScrollH > 0);
            				}
            				else {
HXLINE(2260)					_hx_tmp3 = false;
            				}
HXDLIN(2260)				if (!(_hx_tmp3)) {
...
HXLINE(2264)				Float caret2 = caret->x;
HXDLIN(2264)				if (!((caret2 > ((tempScrollH + this->get_width()) - ( (Float)(4) ))))) {
...
HXLINE(2272)		bool _hx_tmp4;
HXDLIN(2272)		if ((tempScrollH > 0)) {
HXLINE(2272)			_hx_tmp4 = hx::IsNotEq( this->get_type(),1 );
            		}
            		else {
HXLINE(2272)			_hx_tmp4 = false;
            		}
HXDLIN(2272)		if (_hx_tmp4) {
HXLINE(2275)			int lineLength = this->getLineLength(this->getLineIndexOfChar(this->_hx___caretIndex));
HXLINE(2276)			int _hx_tmp5 = this->get_scrollH();
HXDLIN(2276)			if ((((_hx_tmp5 + this->get_width()) - ( (Float)(4) )) > lineLength)) {
...
HXLINE(2326)					Float _hx_tmp2 = (tempHeight + this->_hx___textEngine->lineHeights->get(i));
HXDLIN(2326)					if ((_hx_tmp2 <= (this->get_height() - ( (Float)(4) )))) {
...
HXDLIN(2348)			int _hx_tmp1 = _g->get_scrollH();
HXDLIN(2348)			Float _hx_tmp2 = this->get_mouseX();
HXDLIN(2348)			_g->set_scrollH((_hx_tmp1 + ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min(((_hx_tmp2 - this->get_width()) * ((Float).1)),( (Float)(10) )),( (Float)(1) )))));
            		}
            		else {
HXLINE(2350)			if ((this->get_mouseX() < 1)) {
HXLINE(2352)				 ::openfl::text::TextField _g1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(2352)				int _hx_tmp3 = _g1->get_scrollH();
HXDLIN(2352)				_g1->set_scrollH((_hx_tmp3 - ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min((this->get_mouseX() * ((Float)-.1)),( (Float)(10) )),( (Float)(1) )))));
            			}
            		}
HXLINE(2355)		this->_hx___mouseScrollVCounter++;
HXLINE(2357)		int _hx_tmp4 = this->_hx___mouseScrollVCounter;
HXDLIN(2357)		if ((_hx_tmp4 > (this->stage->get_frameRate() / ( (Float)(10) )))) {
HXLINE(2359)			Float _hx_tmp5 = this->get_mouseY();
HXDLIN(2359)			if ((_hx_tmp5 > (this->get_height() - ( (Float)(2) )))) {
HXLINE(2361)				 ::openfl::text::TextField _g2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(2361)				int _hx_tmp6 = _g2->get_scrollV();
HXDLIN(2361)				Float _hx_tmp7 = this->get_mouseY();
HXDLIN(2361)				_g2->set_scrollV((_hx_tmp6 + ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min(((_hx_tmp7 - this->get_height()) * ((Float).03)),( (Float)(5) )),( (Float)(1) )))));
            			}
            			else {
HXLINE(2363)				if ((this->get_mouseY() < 2)) {
HXLINE(2365)					 ::openfl::text::TextField _g3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(2365)					int _hx_tmp8 = _g3->get_scrollV();
HXDLIN(2365)					_g3->set_scrollV((_hx_tmp8 - ::Std_obj::_hx_int(::Math_obj::max(::Math_obj::min((this->get_mouseY() * ((Float)-.03)),( (Float)(5) )),( (Float)(1) )))));
            				}
            			}
...
HXLINE(2824)				_hx_tmp1 = hx::IsEq( this->stage->get_focus(),hx::ObjectPtr<OBJ_>(this) );
            			}
            			else {
...
HXLINE(3132)			_hx_tmp = !(::Std_obj::is(event->relatedObject,hx::ClassOf< ::openfl::text::TextField >()));
            		}
            		else {
...
HXLINE(3221)						bool _hx_tmp2;
HXDLIN(3221)						if ((pos < rightPos)) {
HXLINE(3221)							_hx_tmp2 = (pos != -1);
            						}
            						else {
HXLINE(3221)							_hx_tmp2 = false;
            						}
HXDLIN(3221)						if (_hx_tmp2) {
...
HXLINE(3294)					_hx_tmp1 = (this->_hx___caretIndex < this->_hx___text.length);
            				}
            				else {
HXLINE(3294)					_hx_tmp1 = false;
            				}
...
HXLINE(3257)					 ::openfl::events::TextEvent te1 =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,HX_("\n",0a,00,00,00));
HXLINE(3259)					this->dispatchEvent(te1);
HXLINE(3261)					if (!(te1->isDefaultPrevented())) {
