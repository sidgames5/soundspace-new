...
HXDLIN( 713)				 ::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + 4),val1);
            			}
HXLINE( 714)			{
HXLINE( 714)				 ::lime::utils::ArrayBufferView this4 = this->_hx___array;
HXDLIN( 714)				 ::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + 8),0);
            			}
HXLINE( 715)			{
HXLINE( 715)				 ::lime::utils::ArrayBufferView this5 = this->_hx___array;
HXDLIN( 715)				Float val2 = this->c;
HXDLIN( 715)				 ::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + 12),val2);
            			}
HXLINE( 716)			{
HXLINE( 716)				 ::lime::utils::ArrayBufferView this6 = this->_hx___array;
HXDLIN( 716)				Float val3 = this->d;
HXDLIN( 716)				 ::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + 16),val3);
            			}
HXLINE( 717)			{
HXLINE( 717)				 ::lime::utils::ArrayBufferView this7 = this->_hx___array;
HXDLIN( 717)				 ::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + 20),0);
            			}
HXLINE( 718)			{
HXLINE( 718)				 ::lime::utils::ArrayBufferView this8 = this->_hx___array;
HXDLIN( 718)				Float val4 = this->tx;
HXDLIN( 718)				 ::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + 24),val4);
            			}
HXLINE( 719)			{
HXLINE( 719)				 ::lime::utils::ArrayBufferView this9 = this->_hx___array;
HXDLIN( 719)				Float val5 = this->ty;
HXDLIN( 719)				 ::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + 28),val5);
            			}
HXLINE( 720)			{
HXLINE( 720)				 ::lime::utils::ArrayBufferView this10 = this->_hx___array;
HXDLIN( 720)				 ::__hxcpp_memory_set_float(this10->buffer->b,(this10->byteOffset + 32),1);
            			}
            		}
            		else {
HXLINE( 724)			{
...
HXDLIN( 725)				 ::__hxcpp_memory_set_float(this12->buffer->b,(this12->byteOffset + 4),val7);
            			}
HXLINE( 726)			{
HXLINE( 726)				 ::lime::utils::ArrayBufferView this13 = this->_hx___array;
HXDLIN( 726)				Float val8 = this->tx;
HXDLIN( 726)				 ::__hxcpp_memory_set_float(this13->buffer->b,(this13->byteOffset + 8),val8);
            			}
HXLINE( 727)			{
HXLINE( 727)				 ::lime::utils::ArrayBufferView this14 = this->_hx___array;
HXDLIN( 727)				Float val9 = this->b;
HXDLIN( 727)				 ::__hxcpp_memory_set_float(this14->buffer->b,(this14->byteOffset + 12),val9);
            			}
HXLINE( 728)			{
HXLINE( 728)				 ::lime::utils::ArrayBufferView this15 = this->_hx___array;
HXDLIN( 728)				Float val10 = this->d;
HXDLIN( 728)				 ::__hxcpp_memory_set_float(this15->buffer->b,(this15->byteOffset + 16),val10);
            			}
HXLINE( 729)			{
HXLINE( 729)				 ::lime::utils::ArrayBufferView this16 = this->_hx___array;
HXDLIN( 729)				Float val11 = this->ty;
HXDLIN( 729)				 ::__hxcpp_memory_set_float(this16->buffer->b,(this16->byteOffset + 20),val11);
            			}
HXLINE( 730)			{
HXLINE( 730)				 ::lime::utils::ArrayBufferView this17 = this->_hx___array;
HXDLIN( 730)				 ::__hxcpp_memory_set_float(this17->buffer->b,(this17->byteOffset + 24),0);
            			}
HXLINE( 731)			{
HXLINE( 731)				 ::lime::utils::ArrayBufferView this18 = this->_hx___array;
HXDLIN( 731)				 ::__hxcpp_memory_set_float(this18->buffer->b,(this18->byteOffset + 28),0);
            			}
HXLINE( 732)			{
HXLINE( 732)				 ::lime::utils::ArrayBufferView this19 = this->_hx___array;
HXDLIN( 732)				 ::__hxcpp_memory_set_float(this19->buffer->b,(this19->byteOffset + 32),1);
            			}
            		}
