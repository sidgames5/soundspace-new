...
HXLINE( 338)		{
HXLINE( 338)			 ::lime::utils::ArrayBufferView this2 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 338)			Float val = this->redMultiplier;
HXDLIN( 338)			 ::__hxcpp_memory_set_float(this2->buffer->b,this2->byteOffset,val);
            		}
HXLINE( 339)		{
HXLINE( 339)			 ::lime::utils::ArrayBufferView this3 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 339)			Float val1 = (this->redOffset / ( (Float)(255) ));
HXDLIN( 339)			 ::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + 16),val1);
            		}
HXLINE( 340)		{
HXLINE( 340)			 ::lime::utils::ArrayBufferView this4 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 340)			Float val2 = this->greenMultiplier;
HXDLIN( 340)			 ::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + 24),val2);
            		}
HXLINE( 341)		{
HXLINE( 341)			 ::lime::utils::ArrayBufferView this5 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 341)			Float val3 = (this->greenOffset / ( (Float)(255) ));
HXDLIN( 341)			 ::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + 36),val3);
            		}
HXLINE( 342)		{
HXLINE( 342)			 ::lime::utils::ArrayBufferView this6 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 342)			Float val4 = this->blueMultiplier;
HXDLIN( 342)			 ::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + 48),val4);
            		}
HXLINE( 343)		{
HXLINE( 343)			 ::lime::utils::ArrayBufferView this7 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 343)			Float val5 = (this->blueOffset / ( (Float)(255) ));
HXDLIN( 343)			 ::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + 56),val5);
            		}
HXLINE( 344)		{
HXLINE( 344)			 ::lime::utils::ArrayBufferView this8 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 344)			Float val6 = this->alphaMultiplier;
HXDLIN( 344)			 ::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + 72),val6);
            		}
HXLINE( 345)		{
HXLINE( 345)			 ::lime::utils::ArrayBufferView this9 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 345)			Float val7 = (this->alphaOffset / ( (Float)(255) ));
HXDLIN( 345)			 ::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + 76),val7);
            		}
