...
bool RegisterMap_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x663763e0;
}
...
HXLINE( 677)			return (a->number - b->number);
            		...
            		int _hx_run( ::openfl::display3D::_internal::_AGALConverter::RegisterMapEntry a1, ::openfl::display3D::_internal::_AGALConverter::RegisterMapEntry b1){
            			HX_STACKFRAME(&_hx_pos_b37c0bf690c3fac4_684_toGLSL)
HXLINE( 684)			return (a1->type - b1->type);
            		}
            		HX_END_LOCAL_FUNC2(return)
