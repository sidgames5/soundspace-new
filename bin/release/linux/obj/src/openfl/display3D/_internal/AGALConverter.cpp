...
bool AGALConverter_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2f8b938e;
}
...
HXLINE( 278)						_hx_tmp1 = hx::IsNotEq( existingUsage,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_ARRAY_dyn() );
            					}
            					else {
...
HXDLIN( 309)					if (hx::IsNotEq( existingUsage1,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn() )) {
HXLINE( 309)						_hx_tmp2 = hx::IsNotEq( existingUsage1,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_ARRAY_dyn() );
            					}
            					else {
...
HXDLIN( 344)					if (hx::IsNotEq( existingUsage2,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_dyn() )) {
HXLINE( 344)						_hx_tmp3 = hx::IsNotEq( existingUsage2,::openfl::display3D::_internal::_AGALConverter::RegisterUsage_obj::VECTOR_4_ARRAY_dyn() );
            					}
            					else {
