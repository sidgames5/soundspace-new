...
HXLINE( 113)		 ::lime::utils::ArrayBufferView this1;
...
HXDLIN( 113)					_this1->buffer = this3;
...
HXDLIN( 113)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 113)							_this2->buffer = this4;
...
HXDLIN( 168)						_this1->buffer = this3;
...
HXDLIN( 168)								 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 168)								_this2->buffer = this4;
...
HXLINE( 178)				{
HXLINE( 178)					 ::lime::utils::ArrayBufferView this5 = this->_hx___tempFloat32Array;
HXDLIN( 178)					Float val = data->get(i);
HXDLIN( 178)					 ::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + ((i - start) * 4)),val);
            				}
            			}
            		}
