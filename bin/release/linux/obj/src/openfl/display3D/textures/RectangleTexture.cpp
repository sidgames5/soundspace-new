...
HXLINE( 103)		 ::lime::utils::ArrayBufferView this1;
...
HXDLIN( 103)					 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 103)					_this1->buffer = this3;
...
HXDLIN( 103)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 103)							_this2->buffer = this4;
