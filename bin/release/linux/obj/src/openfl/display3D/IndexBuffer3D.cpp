...
HXDLIN(  83)							 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(  83)							_this2->buffer = this4;
...
HXDLIN( 130)						_this1->buffer = this3;
...
HXDLIN( 130)								 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 130)								_this2->buffer = this4;
...
HXLINE( 140)				{
HXLINE( 140)					 ::lime::utils::ArrayBufferView this5 = this->_hx___tempUInt16Array;
HXDLIN( 140)					int val = data->get(i);
HXDLIN( 140)					 ::__hxcpp_memory_set_ui16(this5->buffer->b,(this5->byteOffset + ((i - startOffset) * 2)),val);
            				}
            			}
            		}
