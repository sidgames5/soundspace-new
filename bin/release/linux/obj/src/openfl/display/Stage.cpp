...
HXLINE(1303)					int i1 = (length - 2);
HXLINE(1305)					while((i1 >= 0)){
HXLINE(1307)						stack->__get(i1).StaticCast<  ::openfl::display::DisplayObject >()->_hx___dispatch(event);
...
HXLINE(1416)			::Sys_obj::println(::Std_obj::string(::haxe::CallStack_obj::toString(::haxe::CallStack_obj::exceptionStack())));
...
HXLINE(1483)				_hx_tmp = ::Std_obj::is(this->_hx___focus,hx::ClassOf< ::openfl::display::Sprite >());
            			}
            			else {
...
HXLINE(1486)				bool _hx_tmp2;
HXDLIN(1486)				if (sprite->get_buttonMode()) {
HXLINE(1486)					_hx_tmp2 = hx::IsEq( sprite->focusRect,true );
            				}
            				else {
...
HXLINE(1532)				bool _hx_tmp3;
HXDLIN(1532)				if ((type == HX_("keyDown",a1,69,47,9c))) {
HXLINE(1532)					_hx_tmp3 = (keyCode1 == 9);
            				}
            				else {
...
HXLINE(1546)							int _hx_tmp4 = a->get_tabIndex();
HXDLIN(1546)							return (_hx_tmp4 - b->get_tabIndex());
            						}
...
HXLINE(1570)								bool _hx_tmp5;
HXDLIN(1570)								if ((index == -1)) {
HXLINE(1570)									_hx_tmp5 = hx::IsNotNull( current );
            								}
            								else {
...
HXLINE(1576)								bool _hx_tmp6;
HXDLIN(1576)								if (hx::IsNotNull( currentParent )) {
HXLINE(1576)									_hx_tmp6 = currentParent->get_tabChildren();
            								}
            								else {
HXLINE(1576)									_hx_tmp6 = false;
            								}
HXDLIN(1576)								if (_hx_tmp6) {
...
HXLINE(1584)									int i1 = (currentIndex + nextOffset);
HXLINE(1585)									while(true){
HXLINE(1585)										bool _hx_tmp7;
HXDLIN(1585)										if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(modifier)) {
HXLINE(1585)											_hx_tmp7 = (i1 >= 0);
            										}
            										else {
HXLINE(1585)											_hx_tmp7 = (i1 < currentParent->get_numChildren());
            										}
HXDLIN(1585)										if (!(_hx_tmp7)) {
HXLINE(1585)											goto _hx_goto_20;
            										}
HXLINE(1587)										 ::openfl::display::DisplayObject sibling = currentParent->getChildAt(i1);
HXLINE(1588)										if (::Std_obj::is(sibling,hx::ClassOf< ::openfl::display::InteractiveObject >())) {
...
HXLINE(1626)					bool _hx_tmp8;
HXDLIN(1626)					if ((tabStack->length != 1)) {
HXLINE(1626)						if ((tabStack->length == 0)) {
HXLINE(1626)							_hx_tmp8 = hx::IsNotNull( this->get_focus() );
            						}
            						else {
HXLINE(1626)							_hx_tmp8 = false;
            						}
            					}
            					else {
HXLINE(1626)						_hx_tmp8 = true;
            					}
HXDLIN(1626)					if (_hx_tmp8) {
...
HXLINE(1667)					bool _hx_tmp9;
HXDLIN(1667)					if (hx::IsNotNull( focusEvent )) {
HXLINE(1667)						_hx_tmp9 = !(focusEvent->isDefaultPrevented());
            					}
            					else {
HXLINE(1667)						_hx_tmp9 = true;
            					}
HXDLIN(1667)					if (_hx_tmp9) {
...
HXLINE(1702)			f9(window10,keyCode,modifier);
            		}
...
HXLINE(1703)			f10(window11,keyCode1,modifier1);
            		}
            		HX_END_LOCAL_FUNC2((void))
...
HXLINE(1706)			f13(window14,x,y,button);
            		}
...
HXLINE(1707)			f14(window15,x1,y1);
            		}
            		HX_END_LOCAL_FUNC2((void))
...
HXLINE(1708)			f15(window16,x2,y2);
            		}
            		HX_END_LOCAL_FUNC2((void))
...
HXLINE(1709)			f16(window17,x3,y3,button1);
            		}
            		HX_END_LOCAL_FUNC3((void))
...
HXLINE(1710)			f17(window18,deltaX,deltaY,deltaMode);
            		}
            		HX_END_LOCAL_FUNC3((void))
...
HXLINE(1711)			f18(window19,x4,y4);
            		}
            		HX_END_LOCAL_FUNC2((void))
...
HXLINE(1715)			f19(window20,width,height);
            		}
            		HX_END_LOCAL_FUNC2((void))
...
HXLINE(1717)			f21(window22,text,start,length);
            		}
            		HX_END_LOCAL_FUNC3((void))
...
HXLINE(1718)			f22(window23,text1);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE(1693)		 ::Dynamic f = this->_hx___onLimeWindowActivate_dyn();
HXDLIN(1693)		 ::lime::ui::Window window1 = window;
HXDLIN(1693)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(f,window1));
HXDLIN(1693)		window->onActivate->add(_hx_tmp,null(),null());
HXLINE(1694)		 ::Dynamic f1 = this->_hx___onLimeWindowClose_dyn();
HXDLIN(1694)		 ::lime::ui::Window window2 = window;
HXDLIN(1694)		 ::Dynamic _hx_tmp1 =  ::Dynamic(new _hx_Closure_1(f1,window2));
HXDLIN(1694)		window->onClose->add(_hx_tmp1,false,-9000);
HXLINE(1695)		 ::Dynamic f2 = this->_hx___onLimeWindowDeactivate_dyn();
HXDLIN(1695)		 ::lime::ui::Window window3 = window;
HXDLIN(1695)		 ::Dynamic _hx_tmp2 =  ::Dynamic(new _hx_Closure_2(f2,window3));
HXDLIN(1695)		window->onDeactivate->add(_hx_tmp2,null(),null());
HXLINE(1696)		 ::Dynamic f3 = this->_hx___onLimeWindowDropFile_dyn();
HXDLIN(1696)		 ::lime::ui::Window window4 = window;
HXDLIN(1696)		 ::Dynamic _hx_tmp3 =  ::Dynamic(new _hx_Closure_3(f3,window4));
HXDLIN(1696)		window->onDropFile->add(_hx_tmp3,null(),null());
HXLINE(1697)		 ::Dynamic f4 = this->_hx___onLimeWindowEnter_dyn();
HXDLIN(1697)		 ::lime::ui::Window window5 = window;
HXDLIN(1697)		 ::Dynamic _hx_tmp4 =  ::Dynamic(new _hx_Closure_4(window5,f4));
HXDLIN(1697)		window->onEnter->add(_hx_tmp4,null(),null());
HXLINE(1698)		 ::Dynamic f5 = this->_hx___onLimeWindowExpose_dyn();
HXDLIN(1698)		 ::lime::ui::Window window6 = window;
HXDLIN(1698)		 ::Dynamic _hx_tmp5 =  ::Dynamic(new _hx_Closure_5(f5,window6));
HXDLIN(1698)		window->onExpose->add(_hx_tmp5,null(),null());
HXLINE(1699)		 ::Dynamic f6 = this->_hx___onLimeWindowFocusIn_dyn();
HXDLIN(1699)		 ::lime::ui::Window window7 = window;
HXDLIN(1699)		 ::Dynamic _hx_tmp6 =  ::Dynamic(new _hx_Closure_6(f6,window7));
HXDLIN(1699)		window->onFocusIn->add(_hx_tmp6,null(),null());
HXLINE(1700)		 ::Dynamic f7 = this->_hx___onLimeWindowFocusOut_dyn();
HXDLIN(1700)		 ::lime::ui::Window window8 = window;
HXDLIN(1700)		 ::Dynamic _hx_tmp7 =  ::Dynamic(new _hx_Closure_7(window8,f7));
HXDLIN(1700)		window->onFocusOut->add(_hx_tmp7,null(),null());
HXLINE(1701)		 ::Dynamic f8 = this->_hx___onLimeWindowFullscreen_dyn();
HXDLIN(1701)		 ::lime::ui::Window window9 = window;
HXDLIN(1701)		 ::Dynamic _hx_tmp8 =  ::Dynamic(new _hx_Closure_8(window9,f8));
HXDLIN(1701)		window->onFullscreen->add(_hx_tmp8,null(),null());
HXLINE(1702)		 ::Dynamic f9 = this->_hx___onLimeKeyDown_dyn();
HXDLIN(1702)		 ::lime::ui::Window window10 = window;
HXDLIN(1702)		 ::Dynamic _hx_tmp9 =  ::Dynamic(new _hx_Closure_9(window10,f9));
HXDLIN(1702)		window->onKeyDown->add(_hx_tmp9,null(),null());
HXLINE(1703)		 ::Dynamic f10 = this->_hx___onLimeKeyUp_dyn();
HXDLIN(1703)		 ::lime::ui::Window window11 = window;
HXDLIN(1703)		 ::Dynamic _hx_tmp10 =  ::Dynamic(new _hx_Closure_10(window11,f10));
HXDLIN(1703)		window->onKeyUp->add(_hx_tmp10,null(),null());
HXLINE(1704)		 ::Dynamic f11 = this->_hx___onLimeWindowLeave_dyn();
HXDLIN(1704)		 ::lime::ui::Window window12 = window;
HXDLIN(1704)		 ::Dynamic _hx_tmp11 =  ::Dynamic(new _hx_Closure_11(window12,f11));
HXDLIN(1704)		window->onLeave->add(_hx_tmp11,null(),null());
HXLINE(1705)		 ::Dynamic f12 = this->_hx___onLimeWindowMinimize_dyn();
HXDLIN(1705)		 ::lime::ui::Window window13 = window;
HXDLIN(1705)		 ::Dynamic _hx_tmp12 =  ::Dynamic(new _hx_Closure_12(window13,f12));
HXDLIN(1705)		window->onMinimize->add(_hx_tmp12,null(),null());
HXLINE(1706)		 ::Dynamic f13 = this->_hx___onLimeMouseDown_dyn();
HXDLIN(1706)		 ::lime::ui::Window window14 = window;
HXDLIN(1706)		 ::Dynamic _hx_tmp13 =  ::Dynamic(new _hx_Closure_13(f13,window14));
HXDLIN(1706)		window->onMouseDown->add(_hx_tmp13,null(),null());
HXLINE(1707)		 ::Dynamic f14 = this->_hx___onLimeMouseMove_dyn();
HXDLIN(1707)		 ::lime::ui::Window window15 = window;
HXDLIN(1707)		 ::Dynamic _hx_tmp14 =  ::Dynamic(new _hx_Closure_14(f14,window15));
HXDLIN(1707)		window->onMouseMove->add(_hx_tmp14,null(),null());
HXLINE(1708)		 ::Dynamic f15 = this->_hx___onLimeMouseMoveRelative_dyn();
HXDLIN(1708)		 ::lime::ui::Window window16 = window;
HXDLIN(1708)		 ::Dynamic _hx_tmp15 =  ::Dynamic(new _hx_Closure_15(window16,f15));
HXDLIN(1708)		window->onMouseMoveRelative->add(_hx_tmp15,null(),null());
HXLINE(1709)		 ::Dynamic f16 = this->_hx___onLimeMouseUp_dyn();
HXDLIN(1709)		 ::lime::ui::Window window17 = window;
HXDLIN(1709)		 ::Dynamic _hx_tmp16 =  ::Dynamic(new _hx_Closure_16(window17,f16));
HXDLIN(1709)		window->onMouseUp->add(_hx_tmp16,null(),null());
HXLINE(1710)		 ::Dynamic f17 = this->_hx___onLimeMouseWheel_dyn();
HXDLIN(1710)		 ::lime::ui::Window window18 = window;
HXDLIN(1710)		 ::Dynamic _hx_tmp17 =  ::Dynamic(new _hx_Closure_17(window18,f17));
HXDLIN(1710)		window->onMouseWheel->add(_hx_tmp17,null(),null());
HXLINE(1711)		 ::Dynamic f18 = this->_hx___onLimeWindowMove_dyn();
HXDLIN(1711)		 ::lime::ui::Window window19 = window;
HXDLIN(1711)		 ::Dynamic _hx_tmp18 =  ::Dynamic(new _hx_Closure_18(window19,f18));
...
HXLINE(1715)		 ::Dynamic f19 = this->_hx___onLimeWindowResize_dyn();
HXDLIN(1715)		 ::lime::ui::Window window20 = window;
HXDLIN(1715)		 ::Dynamic _hx_tmp19 =  ::Dynamic(new _hx_Closure_19(f19,window20));
HXDLIN(1715)		window->onResize->add(_hx_tmp19,null(),null());
HXLINE(1716)		 ::Dynamic f20 = this->_hx___onLimeWindowRestore_dyn();
HXDLIN(1716)		 ::lime::ui::Window window21 = window;
HXDLIN(1716)		 ::Dynamic _hx_tmp20 =  ::Dynamic(new _hx_Closure_20(window21,f20));
HXDLIN(1716)		window->onRestore->add(_hx_tmp20,null(),null());
HXLINE(1717)		 ::Dynamic f21 = this->_hx___onLimeTextEdit_dyn();
HXDLIN(1717)		 ::lime::ui::Window window22 = window;
HXDLIN(1717)		 ::Dynamic _hx_tmp21 =  ::Dynamic(new _hx_Closure_21(window22,f21));
HXDLIN(1717)		window->onTextEdit->add(_hx_tmp21,null(),null());
HXLINE(1718)		 ::Dynamic f22 = this->_hx___onLimeTextInput_dyn();
HXDLIN(1718)		 ::lime::ui::Window window23 = window;
HXDLIN(1718)		 ::Dynamic _hx_tmp22 =  ::Dynamic(new _hx_Closure_22(window23,f22));
...
HXLINE(1786)			f(gamepad1,axis,value);
            		}
            		HX_END_LOCAL_FUNC2((void))
...
HXLINE(1787)			f1(gamepad2,button);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE(1788)			f2(gamepad3,button1);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE(1786)		 ::Dynamic f = this->_hx___onLimeGamepadAxisMove_dyn();
HXDLIN(1786)		 ::lime::ui::Gamepad gamepad1 = gamepad;
HXDLIN(1786)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(gamepad1,f));
HXDLIN(1786)		gamepad->onAxisMove->add(_hx_tmp,null(),null());
HXLINE(1787)		 ::Dynamic f1 = this->_hx___onLimeGamepadButtonDown_dyn();
HXDLIN(1787)		 ::lime::ui::Gamepad gamepad2 = gamepad;
HXDLIN(1787)		 ::Dynamic _hx_tmp1 =  ::Dynamic(new _hx_Closure_1(gamepad2,f1));
HXDLIN(1787)		gamepad->onButtonDown->add(_hx_tmp1,null(),null());
HXLINE(1788)		 ::Dynamic f2 = this->_hx___onLimeGamepadButtonUp_dyn();
HXDLIN(1788)		 ::lime::ui::Gamepad gamepad3 = gamepad;
HXDLIN(1788)		 ::Dynamic _hx_tmp2 =  ::Dynamic(new _hx_Closure_2(f2,gamepad3));
HXDLIN(1788)		gamepad->onButtonUp->add(_hx_tmp2,null(),null());
HXLINE(1789)		 ::Dynamic f3 = this->_hx___onLimeGamepadDisconnect_dyn();
HXDLIN(1789)		 ::lime::ui::Gamepad gamepad4 = gamepad;
HXDLIN(1789)		 ::Dynamic _hx_tmp3 =  ::Dynamic(new _hx_Closure_3(f3,gamepad4));
...
HXLINE(1910)			int _hx_tmp1 = ::Std_obj::_hx_int((deltaX * window->_hx___scale));
HXDLIN(1910)			this->_hx___onMouseWheel(( (Float)(_hx_tmp1) ),( (Float)(::Std_obj::_hx_int((deltaY * window->_hx___scale))) ),deltaMode);
            		}
            		else {
HXLINE(1914)			int _hx_tmp2 = ::Std_obj::_hx_int(deltaX);
HXDLIN(1914)			this->_hx___onMouseWheel(( (Float)(_hx_tmp2) ),( (Float)(::Std_obj::_hx_int(deltaY)) ),deltaMode);
            		}
            	}
...
HXLINE(2471)		 ::openfl::events::MouseEvent event3 = null();
HXLINE(2476)		Float event4 = this->_hx___mouseX;
HXDLIN(2476)		Float event5 = this->_hx___mouseY;
HXDLIN(2476)		event3 = ::openfl::events::MouseEvent_obj::_hx___create(type,button,event4,event5,target->_hx___globalToLocal(targetPoint,localPoint),target,null());
HXLINE(2479)		this->_hx___dispatchStack(event3,stack);
HXLINE(2485)		if (hx::IsNotNull( clickType )) {
HXLINE(2490)			Float event6 = this->_hx___mouseX;
HXDLIN(2490)			Float event7 = this->_hx___mouseY;
HXDLIN(2490)			event3 = ::openfl::events::MouseEvent_obj::_hx___create(clickType,button,event6,event7,target->_hx___globalToLocal(targetPoint,localPoint),target,null());
HXLINE(2493)			this->_hx___dispatchStack(event3,stack);
...
HXLINE(2507)					Float event8 = this->_hx___mouseX;
HXDLIN(2507)					Float event9 = this->_hx___mouseY;
HXDLIN(2507)					event3 = ::openfl::events::MouseEvent_obj::_hx___create(HX_("doubleClick",77,03,76,cd),button,event8,event9,target->_hx___globalToLocal(targetPoint,localPoint),target,null());
HXLINE(2510)					this->_hx___dispatchStack(event3,stack);
...
HXLINE(2525)		bool _hx_tmp1;
HXDLIN(2525)		if ((::openfl::ui::Mouse_obj::_hx___cursor == HX_("auto",6f,df,76,40))) {
HXLINE(2525)			_hx_tmp1 = !(::openfl::ui::Mouse_obj::_hx___hidden);
            		}
            		else {
HXLINE(2525)			_hx_tmp1 = false;
            		}
HXDLIN(2525)		if (_hx_tmp1) {
...
HXLINE(2535)					 ::openfl::display::DisplayObject target1 = stack->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(2535)					_g = (_g + 1);
HXLINE(2537)					cursor = target1->_hx___getCursor();
HXLINE(2539)					if (hx::IsNotNull( cursor )) {
HXLINE(2541)						 ::lime::ui::Window _hx_tmp2 = this->window;
HXDLIN(2541)						_hx_tmp2->set_cursor(::openfl::ui::_MouseCursor::MouseCursor_Impl__obj::toLimeCursor(cursor));
...
HXLINE(2553)		 ::openfl::events::MouseEvent event10;
HXLINE(2555)		if (hx::IsNotEq( target,this->_hx___mouseOverTarget )) {
HXLINE(2557)			if (hx::IsNotNull( this->_hx___mouseOverTarget )) {
HXLINE(2563)				Float event11 = this->_hx___mouseX;
HXDLIN(2563)				Float event12 = this->_hx___mouseY;
HXDLIN(2563)				 ::openfl::geom::Point event13 = this->_hx___mouseOverTarget->_hx___globalToLocal(targetPoint,localPoint);
HXDLIN(2563)				event10 = ::openfl::events::MouseEvent_obj::_hx___create(HX_("mouseOut",69,e7,1d,a4),button,event11,event12,event13,this->_hx___mouseOverTarget,null());
HXLINE(2567)				this->_hx___dispatchStack(event10,this->_hx___mouseOutStack);
            			}
            		}
...
HXLINE(2586)				Float event14 = this->_hx___mouseX;
HXDLIN(2586)				Float event15 = this->_hx___mouseY;
HXDLIN(2586)				event10 = ::openfl::events::MouseEvent_obj::_hx___create(HX_("rollOut",11,f9,11,5d),button,event14,event15,this->_hx___mouseOverTarget->_hx___globalToLocal(targetPoint,localPoint),( ( ::openfl::display::InteractiveObject)(item) ),null());
HXLINE(2589)				event10->bubbles = false;
HXLINE(2591)				this->_hx___dispatchTarget(item,event10);
            			}
            			else {
HXLINE(2599)				i = (i + 1);
            			}
...
HXLINE(2603)		{
HXLINE(2603)			int _g1 = 0;
HXDLIN(2603)			while((_g1 < stack->length)){
HXLINE(2603)				 ::openfl::display::DisplayObject item1 = stack->__get(_g1).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(2603)				_g1 = (_g1 + 1);
HXLINE(2605)				bool _hx_tmp3;
HXDLIN(2605)				if ((this->_hx___rollOutStack->indexOf(item1,null()) == -1)) {
HXLINE(2605)					_hx_tmp3 = hx::IsNotNull( this->_hx___mouseOverTarget );
            				}
            				else {
HXLINE(2605)					_hx_tmp3 = false;
            				}
HXDLIN(2605)				if (_hx_tmp3) {
HXLINE(2607)					if (item1->hasEventListener(HX_("rollOver",71,ab,a8,12))) {
HXLINE(2613)						Float event16 = this->_hx___mouseX;
HXDLIN(2613)						Float event17 = this->_hx___mouseY;
HXDLIN(2613)						event10 = ::openfl::events::MouseEvent_obj::_hx___create(HX_("rollOver",71,ab,a8,12),button,event16,event17,this->_hx___mouseOverTarget->_hx___globalToLocal(targetPoint,localPoint),( ( ::openfl::display::InteractiveObject)(item1) ),null());
HXLINE(2616)						event10->bubbles = false;
HXLINE(2618)						this->_hx___dispatchTarget(item1,event10);
            					}
HXLINE(2625)					bool _hx_tmp4;
HXDLIN(2625)					if (!(item1->hasEventListener(HX_("rollOut",11,f9,11,5d)))) {
HXLINE(2625)						_hx_tmp4 = item1->hasEventListener(HX_("rollOver",71,ab,a8,12));
            					}
            					else {
HXLINE(2625)						_hx_tmp4 = true;
            					}
HXDLIN(2625)					if (_hx_tmp4) {
HXLINE(2627)						this->_hx___rollOutStack->push(item1);
            					}
            				}
            			}
            		}
...
HXLINE(2639)				Float event18 = this->_hx___mouseX;
HXDLIN(2639)				Float event19 = this->_hx___mouseY;
HXDLIN(2639)				event10 = ::openfl::events::MouseEvent_obj::_hx___create(HX_("mouseOver",19,4a,0d,f6),button,event18,event19,target->_hx___globalToLocal(targetPoint,localPoint),target,null());
HXLINE(2642)				this->_hx___dispatchStack(event10,stack);
            			}
...
HXLINE(2667)				::Array< ::Dynamic> stack1 = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(2669)				if (this->_hx___hitTest(this->_hx___mouseX,this->_hx___mouseY,true,stack1,true,hx::ObjectPtr<OBJ_>(this))) {
HXLINE(2671)					dropTarget = stack1->__get((stack1->length - 1)).StaticCast<  ::openfl::display::DisplayObject >();
            				}
...
HXLINE(2838)				 ::openfl::display::DisplayObject item1 = stack->__get(_g).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(2838)				_g = (_g + 1);
HXLINE(2840)				if ((touchOutStack->indexOf(item1,null()) == -1)) {
HXLINE(2842)					if (item1->hasEventListener(HX_("touchRollOver",50,d6,19,fe))) {
HXLINE(2844)						touchEvent = ::openfl::events::TouchEvent_obj::_hx___create(HX_("touchRollOver",50,d6,19,fe),null(),touchX,touchY,touchOverTarget->_hx___globalToLocal(targetPoint,localPoint),( ( ::openfl::display::InteractiveObject)(item1) ));
...
HXLINE(2851)						this->_hx___dispatchTarget(item1,touchEvent);
            					}
HXLINE(2854)					if (item1->hasEventListener(HX_("touchRollOut",12,0f,74,87))) {
HXLINE(2856)						touchOutStack->push(item1);
            					}
            				}
            			}
            		}
...
HXLINE(2932)			 ::openfl::geom::Matrix _hx_tmp1 = this->_hx___displayMatrix;
HXDLIN(2932)			Float _hx_tmp2 = -(this->get_fullScreenSourceRect()->x);
HXDLIN(2932)			_hx_tmp1->translate(_hx_tmp2,-(this->get_fullScreenSourceRect()->y));
HXLINE(2933)			this->_hx___displayMatrix->scale(displayScaleX,displayScaleY);
HXLINE(2935)			 ::openfl::geom::Rectangle _hx_tmp3 = this->_hx___displayRect;
HXDLIN(2935)			Float _hx_tmp4 = this->get_fullScreenSourceRect()->get_left();
HXDLIN(2935)			Float _hx_tmp5 = this->get_fullScreenSourceRect()->get_right();
HXDLIN(2935)			Float _hx_tmp6 = this->get_fullScreenSourceRect()->get_top();
HXDLIN(2935)			_hx_tmp3->setTo(_hx_tmp4,_hx_tmp5,_hx_tmp6,this->get_fullScreenSourceRect()->get_bottom());
            		}
            		else {
HXLINE(2939)			bool _hx_tmp7;
HXDLIN(2939)			if ((this->_hx___logicalWidth == 0)) {
HXLINE(2939)				_hx_tmp7 = (this->_hx___logicalHeight == 0);
            			}
            			else {
...
HXLINE(2978)			_hx_tmp8 = (this->stageHeight != cacheHeight);
            		}
            		else {
HXLINE(2978)			_hx_tmp8 = true;
            		}
...
HXLINE(3037)				Float _hx_tmp2 = this->get_mouseX();
HXDLIN(3037)				mouse->setTo(_hx_tmp2,this->get_mouseY());
...
HXLINE(3045)				Float _hx_tmp3 = this->_hx___dragObject->get_x();
HXDLIN(3045)				this->_hx___dragOffsetX = (_hx_tmp3 - mouse->x);
HXLINE(3046)				Float _hx_tmp4 = this->_hx___dragObject->get_y();
HXDLIN(3046)				this->_hx___dragOffsetY = (_hx_tmp4 - mouse->y);
...
HXLINE(3110)				bool _hx_tmp1;
HXDLIN(3110)				if (!(this->_hx___renderDirty)) {
HXLINE(3110)					_hx_tmp1 = this->_hx___wasDirty;
            				}
            				else {
...
HXLINE(3222)				 ::openfl::events::FocusEvent event1 =  ::openfl::events::FocusEvent_obj::__alloc( HX_CTX ,HX_("focusIn",dd,45,83,41),true,false,oldFocus,false,0);
HXLINE(3223)				::Array< ::Dynamic> stack1 = ::Array_obj< ::Dynamic>::__new();
HXLINE(3224)				value->_hx___getInteractive(stack1);
HXLINE(3225)				stack1->reverse();
HXLINE(3226)				this->_hx___dispatchStack(event1,stack1);
            			}
            		}
...
HXDLIN(3353)		HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,HX_("Error: The Stage class does not implement this property or method.",a3,36,62,11)));
...
HXDLIN(3363)		HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,HX_("Error: The Stage class does not implement this property or method.",a3,36,62,11)));
