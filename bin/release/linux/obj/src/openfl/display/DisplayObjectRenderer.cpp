...
HXLINE( 129)					_hx_tmp1 = displayObject->_hx___worldVisible;
            				}
            				else {
...
HXLINE( 154)				 ::openfl::display::OpenGLRenderer renderer2 = ( ( ::openfl::display::OpenGLRenderer)(renderer) );
HXLINE( 155)				renderer2->setViewport();
            			}
            		}
            	}
...
HXLINE( 226)					_hx_tmp4 = (renderer->_hx___type == HX_("opengl",6f,64,94,21));
            				}
            				else {
HXLINE( 226)					_hx_tmp4 = false;
            				}
HXDLIN( 226)				if (_hx_tmp4) {
HXLINE( 226)					_hx_tmp3 = hx::IsNull( textField->_hx___cacheBitmap );
            				}
            				else {
HXLINE( 226)					_hx_tmp3 = false;
            				}
HXDLIN( 226)				if (_hx_tmp3) {
HXLINE( 226)					_hx_tmp2 = !(textField->_hx___domRender);
            				}
            				else {
...
HXLINE( 233)					_hx_tmp6 = (renderer->_hx___type == HX_("opengl",6f,64,94,21));
            				}
            				else {
HXLINE( 233)					_hx_tmp6 = false;
            				}
HXDLIN( 233)				if (_hx_tmp6) {
HXLINE( 233)					_hx_tmp5 = hx::IsNull( tilemap->_hx___cacheBitmap );
            				}
            				else {
...
HXLINE( 249)				_hx_tmp7 = !(colorTransform->_hx___isDefault(true));
            			}
            			else {
...
HXLINE( 263)			bool _hx_tmp8;
HXDLIN( 263)			if (!(softwareDirty)) {
HXLINE( 263)				_hx_tmp8 = hardwareDirty;
            			}
            			else {
HXLINE( 263)				_hx_tmp8 = true;
            			}
...
HXLINE( 279)				bool _hx_tmp9;
HXDLIN( 279)				if (softwareDirty) {
HXLINE( 279)					if ((renderType != HX_("canvas",d8,54,42,b8))) {
HXLINE( 279)						_hx_tmp9 = (renderType == HX_("cairo",88,30,19,41));
            					}
            					else {
HXLINE( 279)						_hx_tmp9 = true;
            					}
            				}
            				else {
HXLINE( 279)					_hx_tmp9 = false;
            				}
HXDLIN( 279)				if (_hx_tmp9) {
HXLINE( 279)					needRender = true;
            				}
HXLINE( 280)				bool _hx_tmp10;
HXDLIN( 280)				if (hardwareDirty) {
HXLINE( 280)					_hx_tmp10 = (renderType == HX_("opengl",6f,64,94,21));
            				}
            				else {
...
HXLINE( 286)			bool _hx_tmp11;
HXDLIN( 286)			if (hasFilters) {
HXLINE( 286)				_hx_tmp11 = !(needRender);
            			}
            			else {
HXLINE( 286)				_hx_tmp11 = false;
            			}
HXDLIN( 286)			if (_hx_tmp11) {
HXLINE( 288)				int _g1 = 0;
HXDLIN( 288)				::Array< ::Dynamic> _g2 = displayObject->_hx___filters;
HXDLIN( 288)				while((_g1 < _g2->length)){
HXLINE( 288)					 ::openfl::filters::BitmapFilter filter = _g2->__get(_g1).StaticCast<  ::openfl::filters::BitmapFilter >();
...
HXLINE( 306)					_hx_tmp14 = (bitmapMatrix->b != displayObject->_hx___cacheBitmapMatrix->b);
            				}
            				else {
HXLINE( 306)					_hx_tmp14 = true;
            				}
HXDLIN( 306)				if (!(_hx_tmp14)) {
HXLINE( 306)					_hx_tmp13 = (bitmapMatrix->c != displayObject->_hx___cacheBitmapMatrix->c);
            				}
            				else {
HXLINE( 306)					_hx_tmp13 = true;
            				}
HXDLIN( 306)				if (!(_hx_tmp13)) {
HXLINE( 305)					_hx_tmp12 = (bitmapMatrix->d != displayObject->_hx___cacheBitmapMatrix->d);
            				}
            				else {
...
HXLINE( 305)				_hx_tmp12 = false;
            			}
HXDLIN( 305)			if (_hx_tmp12) {
HXLINE( 311)				needRender = true;
            			}
HXLINE( 314)			bool _hx_tmp15;
HXDLIN( 314)			bool _hx_tmp16;
HXDLIN( 314)			bool _hx_tmp17;
HXDLIN( 314)			bool _hx_tmp18;
HXDLIN( 314)			if (!(needRender)) {
HXLINE( 314)				_hx_tmp18 = (renderer->_hx___type != HX_("opengl",6f,64,94,21));
            			}
            			else {
HXLINE( 314)				_hx_tmp18 = false;
            			}
HXDLIN( 314)			if (_hx_tmp18) {
HXLINE( 314)				_hx_tmp17 = hx::IsNotNull( displayObject->_hx___cacheBitmapData );
            			}
            			else {
HXLINE( 314)				_hx_tmp17 = false;
            			}
HXDLIN( 314)			if (_hx_tmp17) {
HXLINE( 314)				_hx_tmp16 = hx::IsNotNull( displayObject->_hx___cacheBitmapData->image );
            			}
            			else {
HXLINE( 314)				_hx_tmp16 = false;
            			}
HXDLIN( 314)			if (_hx_tmp16) {
HXLINE( 314)				_hx_tmp15 = (displayObject->_hx___cacheBitmapData->image->version < displayObject->_hx___cacheBitmapData->_hx___textureVersion);
            			}
            			else {
HXLINE( 314)				_hx_tmp15 = false;
            			}
...
HXLINE( 333)			bool _hx_tmp19;
HXDLIN( 333)			if (!(updateTransform)) {
HXLINE( 333)				_hx_tmp19 = needRender;
            			}
            			else {
HXLINE( 333)				_hx_tmp19 = true;
            			}
HXDLIN( 333)			if (_hx_tmp19) {
...
HXLINE( 347)						_hx_tmp20 = (filterHeight > displayObject->_hx___cacheBitmapData->height);
            					}
            					else {
...
HXLINE( 371)				bool _hx_tmp21;
HXDLIN( 371)				if ((filterWidth >= ((Float)0.5))) {
HXLINE( 371)					_hx_tmp21 = (filterHeight >= ((Float)0.5));
            				}
            				else {
HXLINE( 371)					_hx_tmp21 = false;
            				}
...
HXLINE( 379)					bool _hx_tmp22;
HXDLIN( 379)					bool _hx_tmp23;
HXDLIN( 379)					if (hx::IsNotNull( displayObject->_hx___cacheBitmapData )) {
HXLINE( 379)						_hx_tmp23 = (bitmapWidth > displayObject->_hx___cacheBitmapData->width);
            					}
            					else {
HXLINE( 379)						_hx_tmp23 = true;
            					}
HXDLIN( 379)					if (!(_hx_tmp23)) {
HXLINE( 379)						_hx_tmp22 = (bitmapHeight > displayObject->_hx___cacheBitmapData->height);
            					}
            					else {
HXLINE( 379)						_hx_tmp22 = true;
            					}
HXDLIN( 379)					if (_hx_tmp22) {
...
HXLINE( 412)						 ::openfl::text::TextField textField1 = ( ( ::openfl::text::TextField)(displayObject) );
HXLINE( 413)						if (hx::IsNotNull( textField1->_hx___cacheBitmap )) {
HXLINE( 415)							 ::openfl::geom::Matrix textField2 = textField1->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 415)							textField2->tx = (textField2->tx - textField1->_hx___offsetX);
HXLINE( 416)							 ::openfl::geom::Matrix textField3 = textField1->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 416)							textField3->ty = (textField3->ty - textField1->_hx___offsetY);
            						}
            					}
...
HXLINE( 432)			bool _hx_tmp24;
HXDLIN( 432)			if (!(updateTransform)) {
HXLINE( 432)				_hx_tmp24 = needRender;
            			}
            			else {
HXLINE( 432)				_hx_tmp24 = true;
            			}
HXDLIN( 432)			if (_hx_tmp24) {
...
HXLINE( 464)				bool _hx_tmp25;
HXDLIN( 464)				if (hx::IsNotNull( displayObject->_hx___cacheBitmapRenderer )) {
HXLINE( 464)					_hx_tmp25 = (renderType != displayObject->_hx___cacheBitmapRenderer->_hx___type);
            				}
            				else {
HXLINE( 464)					_hx_tmp25 = true;
            				}
...
HXLINE( 505)				 ::openfl::geom::Matrix displayObject3 = displayObject->_hx___cacheBitmapRenderer->_hx___worldTransform;
HXDLIN( 505)				displayObject3->tx = (displayObject3->tx - offsetX);
HXLINE( 506)				 ::openfl::geom::Matrix displayObject4 = displayObject->_hx___cacheBitmapRenderer->_hx___worldTransform;
HXDLIN( 506)				displayObject4->ty = (displayObject4->ty - offsetY);
...
HXLINE( 545)						{
HXLINE( 545)							int _g11 = 0;
HXDLIN( 545)							::Array< ::Dynamic> _g21 = displayObject->_hx___filters;
HXDLIN( 545)							while((_g11 < _g21->length)){
HXLINE( 545)								 ::openfl::filters::BitmapFilter filter1 = _g21->__get(_g11).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN( 545)								_g11 = (_g11 + 1);
HXLINE( 550)								if (filter1->_hx___preserveObject) {
HXLINE( 552)									needCopyOfOriginal = true;
            								}
            							}
            						}
HXLINE( 556)						 ::openfl::display::BitmapData bitmap1 = displayObject->_hx___cacheBitmapData;
HXLINE( 557)						 ::openfl::display::BitmapData bitmap2 = null();
HXLINE( 558)						 ::openfl::display::BitmapData bitmap3 = null();
HXLINE( 561)						bool _hx_tmp26;
HXDLIN( 561)						bool _hx_tmp27;
HXDLIN( 561)						if (hx::IsNotNull( displayObject->_hx___cacheBitmapData2 )) {
HXLINE( 561)							_hx_tmp27 = (bitmapWidth > displayObject->_hx___cacheBitmapData2->width);
            						}
            						else {
HXLINE( 561)							_hx_tmp27 = true;
            						}
HXDLIN( 561)						if (!(_hx_tmp27)) {
HXLINE( 561)							_hx_tmp26 = (bitmapHeight > displayObject->_hx___cacheBitmapData2->height);
            						}
            						else {
HXLINE( 561)							_hx_tmp26 = true;
            						}
...
HXLINE( 583)							bool _hx_tmp28;
HXDLIN( 583)							bool _hx_tmp29;
HXDLIN( 583)							if (hx::IsNotNull( displayObject->_hx___cacheBitmapData3 )) {
HXLINE( 583)								_hx_tmp29 = (bitmapWidth > displayObject->_hx___cacheBitmapData3->width);
            							}
            							else {
HXLINE( 583)								_hx_tmp29 = true;
            							}
HXDLIN( 583)							if (!(_hx_tmp29)) {
HXLINE( 583)								_hx_tmp28 = (bitmapHeight > displayObject->_hx___cacheBitmapData3->height);
            							}
            							else {
HXLINE( 583)								_hx_tmp28 = true;
            							}
HXDLIN( 583)							if (_hx_tmp28) {
...
HXLINE( 611)						{
HXLINE( 611)							int _g3 = 0;
HXDLIN( 611)							::Array< ::Dynamic> _g4 = displayObject->_hx___filters;
HXDLIN( 611)							while((_g3 < _g4->length)){
HXLINE( 611)								 ::openfl::filters::BitmapFilter filter2 = _g4->__get(_g3).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN( 611)								_g3 = (_g3 + 1);
HXLINE( 613)								if (filter2->_hx___preserveObject) {
HXLINE( 615)									childRenderer->_hx___setRenderTarget(bitmap3);
HXLINE( 616)									childRenderer->_hx___renderFilterPass(bitmap1,childRenderer->_hx___defaultDisplayShader,filter2->_hx___smooth,null());
            								}
HXLINE( 619)								{
HXLINE( 619)									int _g31 = 0;
HXDLIN( 619)									int _g41 = filter2->_hx___numShaderPasses;
HXDLIN( 619)									while((_g31 < _g41)){
HXLINE( 619)										_g31 = (_g31 + 1);
HXDLIN( 619)										int i = (_g31 - 1);
HXLINE( 621)										 ::openfl::display::BitmapData shader1;
HXDLIN( 621)										if (filter2->_hx___preserveObject) {
HXLINE( 621)											shader1 = bitmap3;
            										}
            										else {
HXLINE( 621)											shader1 = null();
            										}
HXDLIN( 621)										shader = filter2->_hx___initShader(childRenderer,i,shader1);
HXLINE( 622)										childRenderer->_hx___setBlendMode(filter2->_hx___shaderBlendMode);
HXLINE( 623)										childRenderer->_hx___setRenderTarget(bitmap2);
HXLINE( 624)										childRenderer->_hx___renderFilterPass(bitmap1,shader,filter2->_hx___smooth,null());
HXLINE( 626)										cacheBitmap = bitmap1;
HXLINE( 627)										bitmap1 = bitmap2;
HXLINE( 628)										bitmap2 = cacheBitmap;
            									}
            								}
HXLINE( 631)								filter2->_hx___renderDirty = false;
            							}
            						}
HXLINE( 634)						displayObject->_hx___cacheBitmap->_hx___bitmapData = bitmap1;
            					}
...
HXLINE( 668)						bool needSecondBitmapData1 = false;
HXLINE( 669)						bool needCopyOfOriginal1 = false;
HXLINE( 671)						{
HXLINE( 671)							int _g12 = 0;
HXDLIN( 671)							::Array< ::Dynamic> _g22 = displayObject->_hx___filters;
HXDLIN( 671)							while((_g12 < _g22->length)){
HXLINE( 671)								 ::openfl::filters::BitmapFilter filter3 = _g22->__get(_g12).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN( 671)								_g12 = (_g12 + 1);
HXLINE( 673)								if (filter3->_hx___needSecondBitmapData) {
HXLINE( 675)									needSecondBitmapData1 = true;
            								}
HXLINE( 677)								if (filter3->_hx___preserveObject) {
HXLINE( 679)									needCopyOfOriginal1 = true;
            								}
            							}
            						}
HXLINE( 683)						 ::openfl::display::BitmapData bitmap4 = displayObject->_hx___cacheBitmapData;
HXLINE( 684)						 ::openfl::display::BitmapData bitmap21 = null();
HXLINE( 685)						 ::openfl::display::BitmapData bitmap31 = null();
HXLINE( 687)						if (needSecondBitmapData1) {
HXLINE( 689)							bool _hx_tmp30;
HXDLIN( 689)							bool _hx_tmp31;
HXDLIN( 689)							bool _hx_tmp32;
HXDLIN( 689)							if (hx::IsNotNull( displayObject->_hx___cacheBitmapData2 )) {
HXLINE( 689)								_hx_tmp32 = hx::IsNull( displayObject->_hx___cacheBitmapData2->image );
            							}
            							else {
HXLINE( 689)								_hx_tmp32 = true;
            							}
HXDLIN( 689)							if (!(_hx_tmp32)) {
HXLINE( 689)								_hx_tmp31 = (bitmapWidth > displayObject->_hx___cacheBitmapData2->width);
            							}
            							else {
HXLINE( 689)								_hx_tmp31 = true;
            							}
HXDLIN( 689)							if (!(_hx_tmp31)) {
HXLINE( 689)								_hx_tmp30 = (bitmapHeight > displayObject->_hx___cacheBitmapData2->height);
            							}
            							else {
HXLINE( 689)								_hx_tmp30 = true;
            							}
HXDLIN( 689)							if (_hx_tmp30) {
...
HXLINE( 700)							bitmap21 = displayObject->_hx___cacheBitmapData2;
            						}
            						else {
HXLINE( 704)							bitmap21 = bitmap4;
            						}
HXLINE( 707)						if (needCopyOfOriginal1) {
HXLINE( 709)							bool _hx_tmp33;
HXDLIN( 709)							bool _hx_tmp34;
HXDLIN( 709)							bool _hx_tmp35;
HXDLIN( 709)							if (hx::IsNotNull( displayObject->_hx___cacheBitmapData3 )) {
HXLINE( 709)								_hx_tmp35 = hx::IsNull( displayObject->_hx___cacheBitmapData3->image );
            							}
            							else {
HXLINE( 709)								_hx_tmp35 = true;
            							}
HXDLIN( 709)							if (!(_hx_tmp35)) {
HXLINE( 709)								_hx_tmp34 = (bitmapWidth > displayObject->_hx___cacheBitmapData3->width);
            							}
            							else {
HXLINE( 709)								_hx_tmp34 = true;
            							}
HXDLIN( 709)							if (!(_hx_tmp34)) {
HXLINE( 709)								_hx_tmp33 = (bitmapHeight > displayObject->_hx___cacheBitmapData3->height);
            							}
            							else {
HXLINE( 709)								_hx_tmp33 = true;
            							}
HXDLIN( 709)							if (_hx_tmp33) {
...
HXLINE( 720)							bitmap31 = displayObject->_hx___cacheBitmapData3;
            						}
...
HXLINE( 725)						 ::openfl::display::BitmapData cacheBitmap1;
HXDLIN( 725)						 ::openfl::display::BitmapData lastBitmap;
HXLINE( 727)						{
HXLINE( 727)							int _g32 = 0;
HXDLIN( 727)							::Array< ::Dynamic> _g42 = displayObject->_hx___filters;
HXDLIN( 727)							while((_g32 < _g42->length)){
HXLINE( 727)								 ::openfl::filters::BitmapFilter filter4 = _g42->__get(_g32).StaticCast<  ::openfl::filters::BitmapFilter >();
HXDLIN( 727)								_g32 = (_g32 + 1);
HXLINE( 729)								if (filter4->_hx___preserveObject) {
HXLINE( 731)									bitmap31->copyPixels(bitmap4,bitmap4->rect,destPoint,null(),null(),null());
            								}
HXLINE( 734)								lastBitmap = filter4->_hx___applyFilter(bitmap21,bitmap4,bitmap4->rect,destPoint);
HXLINE( 736)								if (filter4->_hx___preserveObject) {
HXLINE( 739)									 ::openfl::geom::ColorTransform _hx_tmp36;
HXDLIN( 739)									if (hx::IsNotNull( displayObject->_hx___objectTransform )) {
HXLINE( 739)										_hx_tmp36 = displayObject->_hx___objectTransform->_hx___colorTransform;
            									}
            									else {
HXLINE( 739)										_hx_tmp36 = null();
            									}
HXLINE( 738)									lastBitmap->draw(bitmap31,null(),_hx_tmp36,null(),null(),null());
            								}
HXLINE( 741)								filter4->_hx___renderDirty = false;
HXLINE( 743)								bool _hx_tmp37;
HXDLIN( 743)								if (needSecondBitmapData1) {
HXLINE( 743)									_hx_tmp37 = hx::IsEq( lastBitmap,bitmap21 );
            								}
            								else {
HXLINE( 743)									_hx_tmp37 = false;
            								}
HXDLIN( 743)								if (_hx_tmp37) {
HXLINE( 745)									cacheBitmap1 = bitmap4;
HXLINE( 746)									bitmap4 = bitmap21;
HXLINE( 747)									bitmap21 = cacheBitmap1;
            								}
            							}
            						}
HXLINE( 751)						if (hx::IsNotEq( displayObject->_hx___cacheBitmapData,bitmap4 )) {
HXLINE( 757)							cacheBitmap1 = displayObject->_hx___cacheBitmapData;
HXLINE( 758)							displayObject->_hx___cacheBitmapData = bitmap4;
HXLINE( 759)							displayObject->_hx___cacheBitmapData2 = cacheBitmap1;
...
HXLINE( 779)			bool _hx_tmp38;
HXDLIN( 779)			if (!(updateTransform)) {
HXLINE( 779)				_hx_tmp38 = needRender;
            			}
            			else {
HXLINE( 779)				_hx_tmp38 = true;
            			}
HXDLIN( 779)			if (_hx_tmp38) {
...
HXLINE( 806)		bool _hx_tmp39;
HXDLIN( 806)		if (updated) {
HXLINE( 806)			_hx_tmp39 = (displayObject->_hx___drawableType == 7);
            		}
            		else {
HXLINE( 806)			_hx_tmp39 = false;
            		}
HXDLIN( 806)		if (_hx_tmp39) {
HXLINE( 808)			 ::openfl::text::TextField textField4 = ( ( ::openfl::text::TextField)(displayObject) );
HXLINE( 809)			if (hx::IsNotNull( textField4->_hx___cacheBitmap )) {
HXLINE( 811)				 ::openfl::geom::Matrix textField5 = textField4->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 811)				textField5->tx = (textField5->tx - textField4->_hx___offsetX);
HXLINE( 812)				 ::openfl::geom::Matrix textField6 = textField4->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 812)				textField6->ty = (textField6->ty - textField4->_hx___offsetY);
            			}
            		}
