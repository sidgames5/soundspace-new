...
HXLINE( 196)						_hx_tmp11 = !(shape->_hx___isCacheBitmapRender);
            					}
            					else {
HXLINE( 196)						_hx_tmp11 = false;
            					}
HXDLIN( 196)					if (_hx_tmp11) {
HXLINE( 196)						 ::openfl::display::Bitmap bitmap1 = shape->_hx___cacheBitmap;
...
HXDLIN( 192)							::Array< ::Dynamic> _g11 = displayObjectContainer->_hx___children;
HXDLIN( 192)							while((_g2 < _g11->length)){
HXLINE( 192)								 ::openfl::display::DisplayObject child1 = _g11->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
