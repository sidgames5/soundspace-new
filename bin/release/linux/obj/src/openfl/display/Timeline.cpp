...
bool Timeline_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x55dd04ef;
}
...
HXDLIN(  79)					_g = (_g + 1);
HXLINE(  81)					 ::openfl::display::Timeline _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  81)					_hx_tmp1->_hx___totalFrames = (_hx_tmp1->_hx___totalFrames + scene->numFrames);
HXLINE(  82)					 ::openfl::display::Timeline _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  82)					_hx_tmp2->_hx___framesLoaded = (_hx_tmp2->_hx___framesLoaded + scene->numFrames);
...
HXLINE(  93)			_hx_tmp3 = (this->scripts->length > 0);
            		}
            		else {
...
HXLINE(  96)			{
HXLINE(  96)				int _g2 = 0;
HXDLIN(  96)				::Array< ::Dynamic> _g11 = this->scripts;
HXDLIN(  96)				while((_g2 < _g11->length)){
HXLINE(  96)					 ::openfl::display::FrameScript script = _g11->__get(_g2).StaticCast<  ::openfl::display::FrameScript >();
HXDLIN(  96)					_g2 = (_g2 + 1);
...
HXDLIN( 262)		if (::Std_obj::is(frame,hx::ClassOf< int >())) {
HXLINE( 264)			return ( (int)(frame) );
            		}
            		else {
HXLINE( 266)			if (::Std_obj::is(frame,hx::ClassOf< ::String >())) {
...
HXLINE( 278)				HX_STACK_DO_THROW( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,((HX_("Error #2109: Frame label ",f8,f0,5a,8a) + label) + HX_(" not found in scene.",b2,87,08,ff))));
            			}
            			else {
HXLINE( 282)				HX_STACK_DO_THROW((HX_("Invalid type for frame ",e7,83,86,d5) + ::Type_obj::getClassName(frame)));
            			}
            		}
HXLINE( 262)		return 0;
            	}
