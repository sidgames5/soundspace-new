...
bool Context3DDisplayObjectContainer_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x66990596;
}
...
HXLINE(  38)				int _g2 = 0;
HXDLIN(  38)				::Array< ::Dynamic> _g11 = displayObjectContainer->_hx___children;
HXDLIN(  38)				while((_g2 < _g11->length)){
HXLINE(  38)					 ::openfl::display::DisplayObject child1 = _g11->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  38)					_g2 = (_g2 + 1);
