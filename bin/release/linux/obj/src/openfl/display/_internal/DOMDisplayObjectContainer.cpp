...
bool DOMDisplayObjectContainer_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x07726cb8;
}
...
HXLINE(  37)			int _g2 = 0;
HXDLIN(  37)			::Array< ::Dynamic> _g11 = displayObjectContainer->_hx___children;
HXDLIN(  37)			while((_g2 < _g11->length)){
HXLINE(  37)				 ::openfl::display::DisplayObject child1 = _g11->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  37)				_g2 = (_g2 + 1);
...
HXLINE(  56)		{
HXLINE(  56)			{
HXLINE(  56)				 ::Dynamic orphan2 = displayObjectContainer->_hx___removedChildren->iterator();
HXDLIN(  56)				while(( (bool)(orphan2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  56)					 ::openfl::display::DisplayObject orphan3 = ( ( ::openfl::display::DisplayObject)(orphan2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXDLIN(  56)					if (hx::IsNull( orphan3->stage )) {
HXLINE(  56)						orphan3->_hx___cleanup();
            					}
            				}
            			}
