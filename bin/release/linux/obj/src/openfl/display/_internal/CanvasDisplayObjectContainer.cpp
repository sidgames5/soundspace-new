...
bool CanvasDisplayObjectContainer_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x4456a946;
}
...
HXLINE(  35)			int _g2 = 0;
HXDLIN(  35)			::Array< ::Dynamic> _g11 = displayObjectContainer->_hx___children;
HXDLIN(  35)			while((_g2 < _g11->length)){
HXLINE(  35)				 ::openfl::display::DisplayObject child1 = _g11->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  35)				_g2 = (_g2 + 1);
