...
bool CairoShape_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x16f30e83;
}
...
HXLINE( 114)						_hx_tmp5 = (centerHeight != 0);
            					}
            					else {
...
HXLINE( 129)							_hx_tmp6 = (centerHeight != 0);
            						}
            						else {
...
HXLINE( 137)							bool _hx_tmp7;
HXDLIN( 137)							if ((centerHeight == 0)) {
HXLINE( 137)								_hx_tmp7 = (centerWidth != 0);
            							}
            							else {
HXLINE( 137)								_hx_tmp7 = false;
            							}
HXDLIN( 137)							if (_hx_tmp7) {
...
HXLINE( 152)					 ::Dynamic _hx_tmp8 = graphics->_hx___cairo->get_target();
HXDLIN( 152)					cairo->setSourceSurface(_hx_tmp8,( (Float)(0) ),( (Float)(0) ));
...
HXDLIN( 172)					_hx_tmp2 = hx::IsNotNull( bitmap->_hx___bitmapData );
            				}
            				else {
HXDLIN( 172)					_hx_tmp2 = false;
            				}
HXDLIN( 172)				if (_hx_tmp2) {
HXDLIN( 172)					_hx_tmp1 = bitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
...
HXDLIN( 172)							_hx_tmp4 = bitmap->smoothing;
            						}
            						else {
HXDLIN( 172)							_hx_tmp4 = false;
            						}
HXDLIN( 172)						if (_hx_tmp4) {
HXDLIN( 172)							_hx_tmp3 = 1;
            						}
            						else {
HXDLIN( 172)							_hx_tmp3 = 3;
            						}
HXDLIN( 172)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp3);
