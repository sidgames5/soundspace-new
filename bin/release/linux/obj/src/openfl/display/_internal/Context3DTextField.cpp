...
bool Context3DTextField_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7acf0f57;
}
...
HXLINE(  38)				_hx_tmp1 = hx::IsNull( textField->_hx___graphics );
            			}
            			else {
...
HXLINE(  38)					_hx_tmp2 = (textField->_hx___worldAlpha <= 0);
            				}
            				else {
...
HXLINE(  38)						_hx_tmp5 = !(textField->_hx___isCacheBitmapRender);
            					}
            					else {
HXLINE(  38)						_hx_tmp5 = false;
            					}
HXDLIN(  38)					if (_hx_tmp5) {
HXLINE(  38)						_hx_tmp4 = (textField->get_width() > 0);
            					}
            					else {
HXLINE(  38)						_hx_tmp4 = false;
            					}
HXDLIN(  38)					if (_hx_tmp4) {
HXLINE(  38)						_hx_tmp3 = (textField->get_height() > 0);
            					}
            					else {
...
HXDLIN(  38)						Float _hx_tmp6 = textField->get_width();
HXDLIN(  38)						rect->setTo(( (Float)(0) ),( (Float)(0) ),_hx_tmp6,textField->get_height());
