...
bool CairoDisplayObjectContainer_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x1c2d24be;
}
...
HXLINE(  36)			int _g2 = 0;
HXDLIN(  36)			::Array< ::Dynamic> _g11 = displayObjectContainer->_hx___children;
HXDLIN(  36)			while((_g2 < _g11->length)){
HXLINE(  36)				 ::openfl::display::DisplayObject child1 = _g11->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  36)				_g2 = (_g2 + 1);
