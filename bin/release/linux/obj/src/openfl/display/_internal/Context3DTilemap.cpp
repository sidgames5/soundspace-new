...
HXDLIN( 126)			while((_g1 < tiles->length)){
HXLINE( 126)				 ::openfl::display::Tile tile2 = tiles->__get(_g1).StaticCast<  ::openfl::display::Tile >();
HXDLIN( 126)				_g1 = (_g1 + 1);
HXLINE( 128)				Float _hx_tmp1 = -(tile2->get_originX());
HXDLIN( 128)				tileTransform->setTo(( (Float)(1) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ),_hx_tmp1,-(tile2->get_originY()));
HXLINE( 129)				tileTransform->concat(tile2->get_matrix());
...
HXLINE( 138)				if (hx::IsNotNull( tile2->get_tileset() )) {
HXLINE( 138)					tileset = tile2->get_tileset();
            				}
            				else {
HXLINE( 138)					tileset = defaultTileset;
            				}
HXLINE( 140)				alpha = (tile2->get_alpha() * worldAlpha);
HXLINE( 141)				visible = tile2->get_visible();
HXLINE( 142)				tile2->_hx___dirty = false;
...
HXLINE( 148)					if (hx::IsNotNull( tile2->get_colorTransform() )) {
HXLINE( 150)						if (hx::IsNull( defaultColorTransform )) {
HXLINE( 152)							colorTransform = tile2->get_colorTransform();
            						}
            						else {
...
HXDLIN( 162)							colorTransform->redMultiplier = (defaultColorTransform1 * tile2->get_colorTransform()->redMultiplier);
HXLINE( 163)							Float defaultColorTransform2 = defaultColorTransform->greenMultiplier;
HXDLIN( 163)							colorTransform->greenMultiplier = (defaultColorTransform2 * tile2->get_colorTransform()->greenMultiplier);
HXLINE( 164)							Float defaultColorTransform3 = defaultColorTransform->blueMultiplier;
HXDLIN( 164)							colorTransform->blueMultiplier = (defaultColorTransform3 * tile2->get_colorTransform()->blueMultiplier);
HXLINE( 165)							Float defaultColorTransform4 = defaultColorTransform->alphaMultiplier;
HXDLIN( 165)							colorTransform->alphaMultiplier = (defaultColorTransform4 * tile2->get_colorTransform()->alphaMultiplier);
HXLINE( 166)							Float defaultColorTransform5 = defaultColorTransform->redOffset;
HXDLIN( 166)							colorTransform->redOffset = (defaultColorTransform5 + tile2->get_colorTransform()->redOffset);
HXLINE( 167)							Float defaultColorTransform6 = defaultColorTransform->greenOffset;
HXDLIN( 167)							colorTransform->greenOffset = (defaultColorTransform6 + tile2->get_colorTransform()->greenOffset);
HXLINE( 168)							Float defaultColorTransform7 = defaultColorTransform->blueOffset;
HXDLIN( 168)							colorTransform->blueOffset = (defaultColorTransform7 + tile2->get_colorTransform()->blueOffset);
HXLINE( 169)							Float defaultColorTransform8 = defaultColorTransform->alphaOffset;
HXDLIN( 169)							colorTransform->alphaOffset = (defaultColorTransform8 + tile2->get_colorTransform()->alphaOffset);
            						}
            					}
            					else {
...
HXLINE( 180)				if ((tile2->__length > 0)) {
HXLINE( 182)					::openfl::display::_internal::Context3DTilemap_obj::buildBufferTileContainer(tilemap,( ( ::openfl::display::TileContainer)(tile2) ),renderer,tileTransform,tileset,alphaEnabled,alpha,colorTransformEnabled,colorTransform,cacheBitmapData,rect,matrix,false);
            				}
            				else {
HXLINE( 187)					if (hx::IsNull( tileset )) {
HXLINE( 187)						continue;
            					}
HXLINE( 189)					id = tile2->get_id();
HXLINE( 191)					bitmapData = tileset->_hx___bitmapData;
HXLINE( 192)					if (hx::IsNull( bitmapData )) {
HXLINE( 192)						continue;
            					}
HXLINE( 194)					if ((id == -1)) {
HXLINE( 196)						tileRect = tile2->_hx___rect;
...
HXDLIN( 279)							while((_g3 < 4)){
HXLINE( 279)								_g3 = (_g3 + 1);
HXDLIN( 279)								int i1 = (_g3 - 1);
HXLINE( 281)								{
