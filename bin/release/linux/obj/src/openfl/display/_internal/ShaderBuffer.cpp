...
bool ShaderBuffer_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x3434098f;
}
...
HXDLIN( 199)							_this1->buffer = this3;
...
HXDLIN( 199)									 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 199)									_this2->buffer = this4;
...
HXDLIN( 203)					 ::lime::utils::ArrayBufferView this5;
HXDLIN( 203)					if (hx::IsNotNull( elements1 )) {
HXLINE( 203)						this5 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements1,8);
            					}
            					else {
...
HXDLIN( 203)							 ::haxe::io::Bytes this6 = ::haxe::io::Bytes_obj::alloc(_this4->byteLength);
HXDLIN( 203)							_this4->buffer = this6;
HXDLIN( 203)							_this4->copyFromArray(array2,null());
HXDLIN( 203)							this5 = _this4;
            						}
            						else {
...
HXDLIN( 203)								 ::haxe::io::Bytes this7 = ::haxe::io::Bytes_obj::alloc(_this5->byteLength);
HXDLIN( 203)								_this5->buffer = this7;
HXDLIN( 203)								_this5->copyFromArray(array3,null());
HXDLIN( 203)								this5 = _this5;
            							}
            							else {
...
HXDLIN( 203)										 ::haxe::io::Bytes this8 = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN( 203)										_this6->buffer = this8;
...
HXDLIN( 203)					 ::lime::utils::ArrayBufferView data = this5;
HXLINE( 204)					{
...
HXLINE( 227)							{
HXLINE( 227)								 ::lime::utils::ArrayBufferView this9 = this->paramData;
...
HXDLIN( 227)								 ::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + (paramPosition * 4)),val);
            							}
...
HXLINE( 238)								{
HXLINE( 238)									 ::lime::utils::ArrayBufferView this10 = this->paramData;
HXDLIN( 238)									Float val1 = floatParam->value->__get(j1);
HXDLIN( 238)									 ::__hxcpp_memory_set_float(this10->buffer->b,(this10->byteOffset + (paramPosition * 4)),val1);
            								}
...
HXLINE( 249)								{
HXLINE( 249)									 ::lime::utils::ArrayBufferView this11 = this->paramData;
HXDLIN( 249)									Float val2 = ( (Float)(intParam->value->__get(j2)) );
HXDLIN( 249)									 ::__hxcpp_memory_set_float(this11->buffer->b,(this11->byteOffset + (paramPosition * 4)),val2);
            								}
