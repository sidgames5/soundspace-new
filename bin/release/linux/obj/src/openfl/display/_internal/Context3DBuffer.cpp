...
bool Context3DBuffer_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x398bfa52;
}
...
HXDLIN( 122)						_this1->buffer = this3;
...
HXDLIN( 122)								 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 122)								_this2->buffer = this4;
...
HXDLIN( 127)				 ::lime::utils::ArrayBufferView this5;
HXDLIN( 127)				if (hx::IsNotNull( vertexLength )) {
HXLINE( 127)					this5 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,vertexLength,8);
            				}
            				else {
...
HXDLIN( 127)						 ::haxe::io::Bytes this6 = ::haxe::io::Bytes_obj::alloc(_this4->byteLength);
HXDLIN( 127)						_this4->buffer = this6;
HXDLIN( 127)						_this4->copyFromArray(array2,null());
HXDLIN( 127)						this5 = _this4;
            					}
            					else {
...
HXDLIN( 127)							 ::haxe::io::Bytes this7 = ::haxe::io::Bytes_obj::alloc(_this5->byteLength);
HXDLIN( 127)							_this5->buffer = this7;
HXDLIN( 127)							_this5->copyFromArray(array3,null());
HXDLIN( 127)							this5 = _this5;
            						}
            						else {
...
HXDLIN( 127)									 ::haxe::io::Bytes this8 = ::haxe::io::Bytes_obj::alloc(cloneLength1);
HXDLIN( 127)									_this6->buffer = this8;
...
HXDLIN( 127)				this->vertexBufferData = this5;
HXLINE( 128)				{
