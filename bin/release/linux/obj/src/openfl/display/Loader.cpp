...
HXLINE( 413)				 ::openfl::display::Loader _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 413)				_hx_tmp1->_hx___path = (_hx_tmp1->_hx___path + HX_("/library.json",2a,a7,07,47));
HXLINE( 415)				if ((queryIndex > -1)) {
HXLINE( 417)					::String _hx_tmp2 = this->_hx___path;
HXDLIN( 417)					request->url = (_hx_tmp2 + request->url.substring(queryIndex,null()));
            				}
            				else {
...
HXLINE( 431)			::String _hx_tmp3;
HXDLIN( 431)			::String _hx_switch_0 = extension;
            			if (  (_hx_switch_0==HX_("gif",04,84,4e,00)) ){
HXLINE( 431)				_hx_tmp3 = HX_("image/gif",10,f4,ba,16);
HXDLIN( 431)				goto _hx_goto_5;
            			}
            			if (  (_hx_switch_0==HX_("jpeg",a8,f2,65,46)) ||  (_hx_switch_0==HX_("jpg",e1,d0,50,00)) ){
HXLINE( 431)				_hx_tmp3 = HX_("image/jpeg",1c,8d,db,ce);
HXDLIN( 431)				goto _hx_goto_5;
            			}
            			if (  (_hx_switch_0==HX_("js",c9,5c,00,00)) ){
HXLINE( 431)				_hx_tmp3 = HX_("application/javascript",cc,7a,f4,a7);
HXDLIN( 431)				goto _hx_goto_5;
            			}
            			if (  (_hx_switch_0==HX_("json",28,42,68,46)) ){
HXLINE( 431)				_hx_tmp3 = HX_("application/json",87,d8,7f,4e);
HXDLIN( 431)				goto _hx_goto_5;
            			}
            			if (  (_hx_switch_0==HX_("png",a9,5c,55,00)) ){
HXLINE( 431)				_hx_tmp3 = HX_("image/png",b5,cc,c1,16);
HXDLIN( 431)				goto _hx_goto_5;
            			}
            			if (  (_hx_switch_0==HX_("swf",42,ab,57,00)) ){
HXLINE( 431)				_hx_tmp3 = HX_("application/x-shockwave-flash",ea,f3,47,4a);
HXDLIN( 431)				goto _hx_goto_5;
            			}
            			/* default */{
HXLINE( 431)				_hx_tmp3 = HX_("application/x-www-form-urlencoded",9e,61,91,fa);
            			}
            			_hx_goto_5:;
HXDLIN( 431)			this->contentLoaderInfo->contentType = _hx_tmp3;
            		}
            		else {
...
HXLINE( 465)		bool _hx_tmp4;
HXDLIN( 465)		bool _hx_tmp5;
HXDLIN( 465)		if ((this->contentLoaderInfo->contentType.indexOf(HX_("/json",d7,85,3d,56),null()) <= -1)) {
HXLINE( 465)			_hx_tmp5 = (this->contentLoaderInfo->contentType.indexOf(HX_("/javascript",1c,04,67,9b),null()) > -1);
            		}
            		else {
HXLINE( 465)			_hx_tmp5 = true;
            		}
HXDLIN( 465)		if (!(_hx_tmp5)) {
HXLINE( 465)			_hx_tmp4 = (this->contentLoaderInfo->contentType.indexOf(HX_("/ecmascript",ac,7b,0f,7d),null()) > -1);
            		}
            		else {
...
HXLINE( 577)			HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("Error #2069: The Loader class does not implement this method.",68,cb,24,3e),2069));
            		}
...
HXDLIN( 584)		HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("Error #2069: The Loader class does not implement this method.",68,cb,24,3e),2069));
...
HXDLIN( 590)		HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("Error #2069: The Loader class does not implement this method.",68,cb,24,3e),2069));
            	}
...
HXLINE( 780)			if (::Std_obj::is(library,hx::ClassOf< ::openfl::utils::AssetLibrary >())) {
...
HXLINE( 787)						_hx_tmp1 = !(::openfl::utils::Assets_obj::hasLibrary(manifest->name));
            					}
            					else {
...
HXLINE( 793)					int _hx_tmp2 = ::Std_obj::_hx_int(clip->get_width());
HXDLIN( 793)					int _hx_tmp3 = ::Std_obj::_hx_int(clip->get_height());
HXDLIN( 793)					_gthis->_hx___setContent(clip,_hx_tmp2,_hx_tmp3);
HXLINE( 795)					 ::openfl::display::LoaderInfo _gthis1 = _gthis->contentLoaderInfo;
HXDLIN( 795)					_gthis1->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null()));
            				}
...
HXLINE( 804)					_hx_tmp4 = (this->contentLoaderInfo->contentType.indexOf(HX_("/ecmascript",ac,7b,0f,7d),null()) > -1);
            				}
            				else {
HXLINE( 804)					_hx_tmp4 = true;
            				}
            			}
            			else {
...
HXLINE( 817)				 ::openfl::display::LoaderInfo _hx_tmp5 = this->contentLoaderInfo;
HXDLIN( 817)				_hx_tmp5->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null()));
            			}
            			else {
