...
HXLINE( 453)					_hx_tmp1 = hx::IsEq( this->stage->get_focus(),child );
            				}
            				else {
...
HXLINE( 458)				 ::openfl::events::Event event1 =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("removedFromStage",34,21,76,ba),false,false);
HXLINE( 459)				child->_hx___dispatchWithCapture(event1);
HXLINE( 460)				child->_hx___dispatchChildren(event1);
...
HXLINE( 534)				HX_STACK_DO_THROW( ::openfl::errors::RangeError_obj::__alloc( HX_CTX ,HX_("The supplied index is out of bounds.",17,96,1b,51)));
            			}
            		}
