...
HXDLIN(  94)			int _hx_tmp1 = ::Std_obj::_hx_int(transform->tx);
HXDLIN(  94)			context1(transform1,transform2,transform3,transform4,_hx_tmp1,::Std_obj::_hx_int(transform->ty));
            		}
            		else {
...
HXLINE( 118)					_hx_tmp1 = this->_hx___stage->_hx___clearBeforeRender;
            				}
            				else {
