...
HXLINE( 266)				_hx_tmp5 = hx::IsNotNull( this->_hx___graphics );
            			}
            			else {
HXLINE( 266)				_hx_tmp5 = false;
            			}
HXDLIN( 266)			if (_hx_tmp5) {
HXLINE( 266)				 ::openfl::display::Graphics _hx_tmp6 = this->_hx___graphics;
HXDLIN( 266)				_hx_tmp4 = _hx_tmp6->_hx___hitTest(x,y,shapeFlag,this->_hx___getRenderTransform());
            			}
            			else {
...
HXLINE( 268)						_hx_tmp7 = this->mouseEnabled;
            					}
            					else {
