...
HXLINE( 395)				 ::openfl::display::ShaderParameter_Float parameter1 = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 395)				_g4 = (_g4 + 1);
HXLINE( 397)				parameter1->_hx___disableGL(this->_hx___context);
            			}
            		}
HXLINE( 400)		{
...
HXLINE( 400)				 ::openfl::display::ShaderParameter_Int parameter2 = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXDLIN( 400)				_g6 = (_g6 + 1);
HXLINE( 402)				parameter2->_hx___disableGL(this->_hx___context);
            			}
            		}
...
HXLINE( 538)						 ::openfl::display::ShaderParameter_Float parameter1 = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 538)						_g4 = (_g4 + 1);
HXLINE( 540)						if (parameter1->_hx___isUniform) {
HXLINE( 542)							parameter1->index = gl->getUniformLocation(this->glProgram,parameter1->name);
            						}
            						else {
HXLINE( 546)							parameter1->index = gl->getAttribLocation(this->glProgram,parameter1->name);
            						}
            					}
            				}
HXLINE( 550)				{
...
HXLINE( 550)						 ::openfl::display::ShaderParameter_Int parameter2 = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXDLIN( 550)						_g6 = (_g6 + 1);
HXLINE( 552)						if (parameter2->_hx___isUniform) {
HXLINE( 554)							parameter2->index = gl->getUniformLocation(this->glProgram,parameter2->name);
            						}
            						else {
HXLINE( 558)							parameter2->index = gl->getAttribLocation(this->glProgram,parameter2->name);
            						}
            					}
            				}
            			}
...
HXLINE( 676)						 ::openfl::display::ShaderParameter_Int parameter1 =  ::openfl::display::ShaderParameter_Int_obj::__alloc( HX_CTX );
HXLINE( 677)						parameter1->set_name(name);
HXLINE( 678)						parameter1->type = parameterType;
HXLINE( 679)						parameter1->_hx___arrayLength = arrayLength;
HXLINE( 680)						parameter1->_hx___isInt = true;
HXLINE( 681)						parameter1->_hx___isUniform = isUniform;
HXLINE( 682)						parameter1->__length = length;
HXLINE( 683)						this->_hx___paramInt->push(parameter1);
HXLINE( 684)						::Reflect_obj::setField(this->_hx___data,name,parameter1);
HXLINE( 685)						if (this->_hx___isGenerated) {
HXLINE( 685)							::Reflect_obj::setField(hx::ObjectPtr<OBJ_>(this),name,parameter1);
            						}
HXLINE( 675)						goto _hx_goto_29;
            					}
            					/* default */{
HXLINE( 688)						 ::openfl::display::ShaderParameter_Float parameter2 =  ::openfl::display::ShaderParameter_Float_obj::__alloc( HX_CTX );
HXLINE( 689)						parameter2->set_name(name);
HXLINE( 690)						parameter2->type = parameterType;
HXLINE( 691)						parameter2->_hx___arrayLength = arrayLength;
...
HXLINE( 693)										 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 693)										::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),hx::paccDynamic)) );
HXDLIN( 693)										_this1->byteOffset = 0;
HXDLIN( 693)										_this1->length = array1->get_length();
HXDLIN( 693)										_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 693)										 ::haxe::io::Bytes this3 = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 693)										_this1->buffer = this3;
HXDLIN( 693)										_this1->copyFromArray(array1,null());
HXDLIN( 693)										this1 = _this1;
            									}
            									else {
HXLINE( 693)										if (hx::IsNotNull( view )) {
HXLINE( 693)											 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXDLIN( 693)											int elementSize = _this2->bytesPerElement;
HXDLIN( 693)											if ((view->type == _this2->type)) {
HXLINE( 693)												int srcLength1 = srcData->length;
HXDLIN( 693)												int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 693)												 ::haxe::io::Bytes this4 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 693)												_this2->buffer = this4;
HXDLIN( 693)												_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            											}
            											else {
HXLINE( 693)												HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            											}
HXDLIN( 693)											_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 693)											_this2->byteOffset = 0;
HXDLIN( 693)											_this2->length = srcLength;
HXDLIN( 693)											this1 = _this2;
            										}
            										else {
HXLINE( 693)											if (hx::IsNotNull( buffer )) {
HXLINE( 693)												 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 693)												int in_byteOffset = 0;
HXDLIN( 693)												if ((in_byteOffset < 0)) {
HXLINE( 693)													HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            												}
HXDLIN( 693)												if ((hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 693)													HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            												}
HXDLIN( 693)												int bufferByteLength = buffer->length;
HXDLIN( 693)												int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 693)													if ((hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 693)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
...
HXLINE( 693)													newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 693)													int newRange = (in_byteOffset + newByteLength);
HXDLIN( 693)													if ((newRange > bufferByteLength)) {
HXLINE( 693)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
            												}
HXDLIN( 693)												_this3->buffer = buffer;
HXDLIN( 693)												_this3->byteOffset = in_byteOffset;
HXDLIN( 693)												_this3->byteLength = newByteLength;
HXDLIN( 693)												_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 693)												this1 = _this3;
            											}
            											else {
HXLINE( 693)												HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            											}
            										}
            									}
            								}
            							}
HXDLIN( 693)							parameter2->_hx___uniformMatrix = this1;
            						}
HXLINE( 695)						parameter2->_hx___isFloat = true;
HXLINE( 696)						parameter2->_hx___isUniform = isUniform;
HXLINE( 697)						parameter2->__length = length;
HXLINE( 698)						this->_hx___paramFloat->push(parameter2);
...
HXLINE( 715)						::Reflect_obj::setField(this->_hx___data,name,parameter2);
HXLINE( 716)						if (this->_hx___isGenerated) {
HXLINE( 716)							::Reflect_obj::setField(hx::ObjectPtr<OBJ_>(this),name,parameter2);
            						}
            					}
            					_hx_goto_29:;
            				}
...
HXLINE( 756)				 ::openfl::display::ShaderParameter_Float parameter1 = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 756)				_g4 = (_g4 + 1);
HXLINE( 758)				parameter1->_hx___updateGL(this->_hx___context,null());
            			}
            		}
HXLINE( 761)		{
...
HXLINE( 761)				 ::openfl::display::ShaderParameter_Int parameter2 = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXDLIN( 761)				_g6 = (_g6 + 1);
HXLINE( 763)				parameter2->_hx___updateGL(this->_hx___context,null());
            			}
            		}
            	}
...
HXDLIN( 821)				int i1 = (_g2 - 1);
HXLINE( 823)				hasOverride = false;
HXLINE( 825)				if ((i1 < boolCount)) {
HXLINE( 827)					boolRef = shaderBuffer->paramRefs_Bool->__get(boolIndex).StaticCast<  ::openfl::display::ShaderParameter_Bool >();
HXLINE( 829)					{
HXLINE( 829)						int _g21 = 0;
HXDLIN( 829)						int _g31 = shaderBuffer->overrideBoolCount;
HXDLIN( 829)						while((_g21 < _g31)){
HXLINE( 829)							_g21 = (_g21 + 1);
HXDLIN( 829)							int j = (_g21 - 1);
...
HXLINE( 845)						boolRef->_hx___updateGLFromBuffer(this->_hx___context,paramData,shaderBuffer->paramPositions->__get(i1),shaderBuffer->paramLengths->__get(i1),bufferOffset);
            					}
HXLINE( 848)					boolIndex = (boolIndex + 1);
            				}
            				else {
HXLINE( 850)					if ((i1 < (boolCount + floatCount))) {
HXLINE( 852)						floatRef = shaderBuffer->paramRefs_Float->__get(floatIndex).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXLINE( 854)						{
HXLINE( 854)							int _g22 = 0;
HXDLIN( 854)							int _g32 = shaderBuffer->overrideFloatCount;
HXDLIN( 854)							while((_g22 < _g32)){
HXLINE( 854)								_g22 = (_g22 + 1);
HXDLIN( 854)								int j1 = (_g22 - 1);
HXLINE( 856)								if ((floatRef->name == shaderBuffer->overrideFloatNames->__get(j1))) {
HXLINE( 858)									overrideFloatValue = shaderBuffer->overrideFloatValues->__get(j1).StaticCast< ::Array< Float > >();
...
HXLINE( 870)							floatRef->_hx___updateGLFromBuffer(this->_hx___context,paramData,shaderBuffer->paramPositions->__get(i1),shaderBuffer->paramLengths->__get(i1),bufferOffset);
            						}
...
HXLINE( 879)						{
HXLINE( 879)							int _g23 = 0;
HXDLIN( 879)							int _g33 = shaderBuffer->overrideIntCount;
HXDLIN( 879)							while((_g23 < _g33)){
HXLINE( 879)								_g23 = (_g23 + 1);
HXDLIN( 879)								int j2 = (_g23 - 1);
HXLINE( 881)								if ((intRef->name == shaderBuffer->overrideIntNames->__get(j2))) {
HXLINE( 883)									overrideIntValue = ::cpp::VirtualArray( shaderBuffer->overrideIntValues->__get(j2));
...
HXLINE( 895)							intRef->_hx___updateGLFromBuffer(this->_hx___context,paramData,shaderBuffer->paramPositions->__get(i1),shaderBuffer->paramLengths->__get(i1),bufferOffset);
            						}
