...
HXLINE(1120)		if (::Std_obj::is(event,hx::ClassOf< ::openfl::events::MouseEvent >())) {
...
HXLINE(1126)			if (::Std_obj::is(event,hx::ClassOf< ::openfl::events::TouchEvent >())) {
...
HXLINE(2271)			 ::openfl::geom::ColorTransform _hx_tmp2 = this->_hx___objectTransform->_hx___colorTransform;
HXDLIN(2271)			_hx_tmp2->_hx___copyFrom(value->get_colorTransform());
