...
HXLINE( 274)					_hx_tmp3 = hx::IsEq( stack->__get((stack->length - 1)).StaticCast<  ::openfl::display::DisplayObject >(),stack->__get((stack->length - 2)).StaticCast<  ::openfl::display::DisplayObject >() );
            				}
            				else {
...
HXDLIN( 383)			 ::openfl::display::DisplayObject _hx_tmp3 = this->_hx___hitTestState;
HXDLIN( 383)			if (hx::IsNotEq( _hx_tmp3,this->get_downState() )) {
HXLINE( 383)				 ::openfl::display::DisplayObject _hx_tmp4 = this->_hx___hitTestState;
HXDLIN( 383)				_hx_tmp2 = hx::IsNotEq( _hx_tmp4,this->get_upState() );
            			}
            			else {
HXLINE( 383)				_hx_tmp2 = false;
            			}
HXDLIN( 383)			if (_hx_tmp2) {
HXLINE( 383)				 ::openfl::display::DisplayObject _hx_tmp5 = this->_hx___hitTestState;
HXDLIN( 383)				_hx_tmp1 = hx::IsNotEq( _hx_tmp5,this->get_overState() );
            			}
            			else {
...
HXLINE( 451)			_hx_tmp2 = hx::IsNotNull( value->parent );
            		}
            		else {
