...
HXLINE( 364)				if (::Std_obj::is(request->data,hx::ClassOf< ::haxe::io::Bytes >())) {
...
HXDLIN( 378)			::Array< ::Dynamic> _g11 = request->requestHeaders;
HXDLIN( 378)			while((_g1 < _g11->length)){
HXLINE( 378)				 ::openfl::net::URLRequestHeader header = _g11->__get(_g1).StaticCast<  ::openfl::net::URLRequestHeader >();
HXDLIN( 378)				_g1 = (_g1 + 1);
HXLINE( 380)				::Array< ::Dynamic> _hx_tmp1 = ( (::Array< ::Dynamic>)(this->_hx___httpRequest->__Field(HX_("headers",46,52,08,63),hx::paccDynamic)) );
HXDLIN( 380)				_hx_tmp1->push( ::lime::net::HTTPRequestHeader_obj::__alloc( HX_CTX ,header->name,header->value));
            			}
            		}
...
HXLINE( 410)			 ::openfl::events::IOErrorEvent event1 =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,HX_("ioError",02,fe,41,76),null(),null(),null(),null());
HXLINE( 411)			event1->text = ::Std_obj::string(error);
HXLINE( 412)			this->dispatchEvent(event1);
            		}
            	}
