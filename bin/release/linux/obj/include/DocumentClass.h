...
class HXCPP_CLASS_ATTRIBUTES DocumentClass_obj : public  ::io::github::keystone_games::soundspace::SoundSpace_obj
{
	public:
		typedef  ::io::github::keystone_games::soundspace::SoundSpace_obj super;
