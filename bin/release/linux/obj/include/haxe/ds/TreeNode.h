...
HX_DECLARE_STACK_FRAME(_hx_pos_3b67413c38760ea6_255_new)
			...
			*(void **)__this = TreeNode_obj::_hx_vtable;
{
            	...
            	HX_STACKFRAME(&_hx_pos_3b67413c38760ea6_255_new)
HXLINE( 256)		( ( ::haxe::ds::TreeNode)(__this) )->left = l;
HXLINE( 257)		( ( ::haxe::ds::TreeNode)(__this) )->key = k;
HXLINE( 258)		( ( ::haxe::ds::TreeNode)(__this) )->value = v;
HXLINE( 259)		( ( ::haxe::ds::TreeNode)(__this) )->right = r;
HXLINE( 260)		if ((h == -1)) {
HXLINE( 261)			int _hx_tmp;
HXDLIN( 261)			 ::haxe::ds::TreeNode _this = ( ( ::haxe::ds::TreeNode)(__this) )->left;
...
HXDLIN( 261)			 ::haxe::ds::TreeNode _this1 = ( ( ::haxe::ds::TreeNode)(__this) )->right;
...
HXLINE( 261)				 ::haxe::ds::TreeNode _this2 = ( ( ::haxe::ds::TreeNode)(__this) )->left;
...
HXLINE( 261)				 ::haxe::ds::TreeNode _this3 = ( ( ::haxe::ds::TreeNode)(__this) )->right;
...
HXDLIN( 261)			( ( ::haxe::ds::TreeNode)(__this) )->_height = (_hx_tmp + 1);
            		}
            		else {
HXLINE( 263)			( ( ::haxe::ds::TreeNode)(__this) )->_height = h;
            		}
            	}
