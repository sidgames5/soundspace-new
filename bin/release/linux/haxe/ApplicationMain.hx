...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SoundSpace", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SoundSpace", null, 3840, 2160);
		#end
		#else
		create(null);
		#end
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("io.github.keystone_games.soundspace.SoundSpace")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess io.github.keystone_games.soundspace.SoundSpace.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"io.github.keystone_games.soundspace.SoundSpace\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"io.github.keystone_games.soundspace.SoundSpace\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends io.github.keystone_games.soundspace.SoundSpace {}
#else
class DocumentClass
{
